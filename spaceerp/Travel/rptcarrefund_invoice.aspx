<%@ Page Language="C#" Title="Car Refund Invoice" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptcarrefund_invoice.aspx.cs" Inherits="Travel_rptBusInvoice" %>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb hidden-print pull-right" id="tplink">
                    <li class="breadcrumb-item"><a href="tcar_booking.aspx">Home</a></li>
                    ...
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                           <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                                <th class="text-center" colspan="2">Reference No.</th>
                                  <th class="text-center" colspan="2">Trip DATE</th>
                                <th class="text-center" colspan="2">PAX NAME</th>
                                <th class="text-center" colspan="4">Descriptions</th>
                                ...
                                <ItemTemplate>
                                    <tr style="height: 40px; text-align: center; padding: 10px; border: 1px solid black">
                                        ...
                                        <td class="text-center" colspan="2"><%# Eval("sReferenceNo") %></td>
                                          <td class="text-center" colspan="2"><%# validation.TextToDate(Eval("dtTripDate").ToString()) %></td>
                                        <td class="text-center" colspan="2"><%# Eval("sPaxtName") %></td>
                                        <td class="text-center" colspan="4"><%# Eval("sDestination") %></td>
