<%@ Page Title="Train Ticket Entries" Language="C#" MasterPageFile="~/pagecontent.master" AutoEventWireup="true" CodeFile="ttrain_booking.aspx.cs" Inherits="Transcation_bus_booking" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">Train Ticket Booking </h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:Panel class="tbl" ID="tblmain" runat="server">
                                <div style=" padding: 5px;padding-top: 0px; margin-top: 5px;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            ...
                                            <asp:TextBox ID="txtTrainBookingNo" runat="server" CssClass="form-control" AutoPostBack="true" Enabled="true" OnTextChanged="txtTrainBookingNo_TextChanged"> </asp:TextBox>

                                        </div>
                                        <div class="col-md-2 col-sm-2">
                                            <label class="col-form-label" for="fullname">
                                                Invoice Date :</label>
                                            <asp:TextBox ID="txtdtTrainBooking" runat="server" CssClass="form-control datepicker" Width="90%" AutoPostBack="true" OnTextChanged="txtdtTrainBooking_TextChanged"></asp:TextBox>
                                            <AjaxToolKit:CalendarExtender ID="CalendarExtender4" runat="server" Format="dd/MM/yyyy"
                                                PopupButtonID="txtdtTrainBooking" TargetControlID="txtdtTrainBooking" PopupPosition="TopLeft" />

                                            <AjaxToolKit:MaskedEditExtender ID="MEE4" runat="server" TargetControlID="txtdtTrainBooking"
                                                Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                            <asp:RegularExpressionValidator ID="REV4" ControlToValidate="txtdtTrainBooking" ValidationGroup="A"
                                            ...
                                            <div style=" padding: 5px; margin-top: 0px;">
                                                <div class="form-group row m-b-10">
                                                    <div class="col-md-4 col-sm-6">
                                                        <label class="col-form-label" for="fullname">
                                                            PNR NO. :</label>
                                                        <asp:TextBox ID="txtPnrNo" CssClass="form-control" runat="server" Width="90%" required ValidationGroup="B">
                                                        </asp:TextBox>
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <label class="col-form-label" for="fullname">
                                                            Trian No. :</label>
                                                        <asp:TextBox ID="txtTrainNo" CssClass="form-control" runat="server" ValidationGroup="B" Width="90%">
                                                        </asp:TextBox>
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <label class="col-form-label" for="fullname">
                                                            Class :</label>
                                                        <asp:DropDownList ID="ddlClass" CssClass="form-control" runat="server" Width="90%">
                                                            <asp:ListItem Text="AC First Class" Value="AC First Class"></asp:ListItem>
                                                            <asp:ListItem Text="AC 2-Tier" Value="AC 2-Tier"></asp:ListItem>
                                                            <asp:ListItem Text="AC 3-Tier" Value="AC 3-Tier"></asp:ListItem>
                                                            <asp:ListItem Text="First Class" Value="First Class"></asp:ListItem>
                                                            <asp:ListItem Text="AC Chair Car" Value="AC Chair Car"></asp:ListItem>
                                                            <asp:ListItem Text="Sleeper" Value="Sleeper"></asp:ListItem>
                                                            <asp:ListItem Text="Second Class" Value="Second Class"></asp:ListItem>
                                                            <asp:ListItem Text="Second Sitting" Value="Second Sitting"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                ...
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-4 col-sm-4">
                                                        ...
                                                        <asp:TextBox ID="txtBoarding" CssClass="form-control" runat="server" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-4 col-sm-2">
                                                        <label class="col-form-label" for="fullname">
                                                            Travel Date :</label>
                                                        <asp:TextBox ID="txtdtTravelDate" runat="server" CssClass="datepicker form-control" Width="90%" placeholder="dd/MM/yyyy"></asp:TextBox>
                                                        <%--<AjaxToolKit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy"
                                                            PopupButtonID="txtdtTravelDate" TargetControlID="txtdtTravelDate" PopupPosition="TopLeft" />--%>
                                                        <AjaxToolKit:MaskedEditExtender ID="MaskedEditExtender1" runat="server"
                                                            TargetControlID="txtdtTravelDate" Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtdtTravelDate"
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        ...
                                                        <asp:TextBox ID="txtTicketNo" CssClass="form-control" runat="server" Width="90%"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-4 col-sm-4">
                                                        ...
                                                        <asp:DropDownList ID="ddlFromID" runat="server" Width="90%" CssClass="form-control js-example-placeholder-single">
                                                        </asp:DropDownList>
                                                    </div>
                                                    <div class="col-md-4 col-sm-2">
                                                        <label class="col-form-label" for="fullname">
                                                            To :</label>
                                                        <asp:DropDownList ID="ddlToID" runat="server" Width="90%" CssClass="form-control js-example-placeholder-single">
                                                        </asp:DropDownList>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                        ...
                                                        <asp:TextBox ID="txtPaxNos" CssClass="form-control" runat="server" Width="90%"></asp:TextBox>
                                            ...
                                            <div style=" padding: 5px; margin-top: 0px;">
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-4 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtPaxName1" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-2 col-sm-3">
                                                        ...
                                                        <asp:DropDownList ID="ddlGender1" CssClass="form-control" runat="server" Width="90%">
                                                    ...
                                                    <div class="col-md-2 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtAge1" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Status
                                                        </label>
                                                        <asp:TextBox ID="txtStaus1" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Bogie
                                                        </label>
                                                        <asp:TextBox ID="txtBogie1" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-4 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtPaxName2" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">


                                                        <asp:DropDownList ID="ddlGender2" CssClass="form-control" runat="server" Width="90%">
                                                            <asp:ListItem Value="Male" Text="Male"></asp:ListItem>
                                                            <asp:ListItem Value="Female" Text="Female"></asp:ListItem>
                                                            <asp:ListItem Value="Other" Text="Other "></asp:ListItem>
                                                        </asp:DropDownList>
                                                    ...
                                                    <div class="col-md-2 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtAge2" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtStaus2" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtBogie2" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-4 col-sm-3">
                                                        <asp:TextBox ID="txtPaxName3" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">


                                                        <asp:DropDownList ID="ddlGender3" CssClass="form-control" runat="server" Width="90%">
                                                            <asp:ListItem Value="Male" Text="Male"></asp:ListItem>
                                                            <asp:ListItem Value="Female" Text="Female"></asp:ListItem>
                                                            <asp:ListItem Value="Other" Text="Other "></asp:ListItem>
                                                        </asp:DropDownList>
                                                    ...
                                                    <div class="col-md-2 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtAge3" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtStaus3" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtBogie3" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-4 col-sm-3">
                                                        <asp:TextBox ID="txtPaxName4" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">


                                                        <asp:DropDownList ID="ddlGender4" CssClass="form-control" runat="server" Width="90%">
                                                            <asp:ListItem Value="Male" Text="Male"></asp:ListItem>
                                                            <asp:ListItem Value="Female" Text="Female"></asp:ListItem>
                                                            <asp:ListItem Value="Other" Text="Other "></asp:ListItem>
                                                        </asp:DropDownList>
                                                    ...
                                                    <div class="col-md-2 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtAge4" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtStaus4" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtBogie4" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-4 col-sm-3">
                                                        <asp:TextBox ID="txtPaxName5" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">


                                                        <asp:DropDownList ID="ddlGender5" CssClass="form-control" runat="server" Width="90%">
                                                            <asp:ListItem Value="Male" Text="Male"></asp:ListItem>
                                                            <asp:ListItem Value="Female" Text="Female"></asp:ListItem>
                                                            <asp:ListItem Value="Other" Text="Other "></asp:ListItem>
                                                        </asp:DropDownList>
                                                    ...
                                                    <div class="col-md-2 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtAge5" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtStaus5" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtBogie5" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-4 col-sm-3">
                                                        <asp:TextBox ID="txtPaxName6" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">


                                                        <asp:DropDownList ID="ddlGender6" CssClass="form-control" runat="server" Width="90%">
                                                            <asp:ListItem Value="Male" Text="Male "></asp:ListItem>
                                                            <asp:ListItem Value="Female" Text="Female"></asp:ListItem>
                                                            <asp:ListItem Value="Other" Text="Other "></asp:ListItem>
                                                        </asp:DropDownList>
                                                    ...
                                                    <div class="col-md-2 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtAge6" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtStaus6" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">

                                                        <asp:TextBox ID="txtBogie6" CssClass="form-control" runat="server" placeholder="" Width="90%"></asp:TextBox>
                                                    </div>
                                            ...
                                            <div style=" padding: 5px; margin-top: 0px;">
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-2 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Basic Fare :</label>
                                                        <asp:TextBox ID="txtclntBasicFare" CssClass="form-control" Text="0" Width="90%" runat="server" ValidationGroup="B" AutoPostBack="true" OnTextChanged="txtclntBasicFare_TextChanged"></asp:TextBox>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txtclntBasicFare"
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtBasicFare" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                    </div>
                                                    <div class="col-md-2 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            SC Type
                                                ...
                                                <div class="form-group row m-b-5">
                                                    ...
                                                    <div class="col-md-4 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtDiscount" CssClass="form-control" runat="server" Width="95%" Text="0" Placeholder="Discount   :" OnTextChanged="txtDiscount_TextChanged" AutoPostBack="true" required="" placeolder="Discount"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtDiscount"
                                                            SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Numbers" ValidationExpression="^(-)?\d+(\.\d+$)?$"
                                                            ValidationGroup="A"></asp:RegularExpressionValidator>
                                                    ...
                                                    <div class="col-md-4 col-sm-3">
                                                        ...
                                                        <asp:TextBox ID="txtOtherchrg" CssClass="form-control" runat="server" Width="95%" Text="0" Placeholder="Discount   :" OnTextChanged="txtOtherchrg_TextChanged" AutoPostBack="true" required placeolder="Discount"></asp:TextBox>
...
<br />
                            ...
                            <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
                                <div style=" padding: 10px; margin-top: 20px;">
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-2 col-sm-2" style="z-index: 99">
                                            <label class="col-form-label" for="fullname">
                                                Invoice Date :</label>
                                            <asp:TextBox ID="txtSdtBooking" runat="server" CssClass="datepicker form-control" Width="90%" placeholder="dd/MM/yyyy"></asp:TextBox>
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
                                    ...
                                    DataKeyNames="nTrainBookingID" Width="90%" AllowPaging="true" AllowSorting="True" PageSize="25"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="nTrainBookingID" Visible="false">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblInvoiceNo" runat="server" Text='<%# Eval("sTrainBookingNo") %>'></asp:Label>
                                        ...
                                        <asp:BoundField DataField="sBookType" HeaderText="Booking Type" />
