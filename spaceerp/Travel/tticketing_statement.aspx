<%@ Page Title="Tickeintng Statement" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="tticketing_statement.aspx.cs" Inherits="Travel_tticketing_statement" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlMain" runat="server">
            ...
            <div class="form-group row m-b-15">
                ...
                <div class="col-md-2 col-sm-3">
                    ...
                    <asp:DropDownList ID="ddlSBookType" runat="server" CssClass="js-example-placeholder-single form-control">
                        ...
                        <asp:ListItem Text="Refund" Value="4"></asp:ListItem>
            ...
            <div class="form-group row m-b-5">
                <div class="col-md-12 col-sm-12">
                    <asp:Button ID="btnExcel" runat="server" CssClass="btn btn-primary" Text="Export Excel" ValidationGroup="A"
                     ...
                     <a href="tticketing.aspx" class="btn btn-warning" id="btnprint">Home</a>
                </div>
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
            AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nTicketingID" HeaderStyle-BackColor="#1c3967" HeaderStyle-Font-Bold="true"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="sTicketBookingNo" HeaderText="Tax Invoice" />
                <asp:TemplateField HeaderText="DOC Date">
                    <ItemTemplate>
                        <%#validation.TextToDate(Eval("dtBooking").ToString())%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sAgentName" HeaderText="Client" />
                ...
                <asp:BoundField DataField="sTicketPNR" HeaderText="Ticket No" />
                <asp:BoundField DataField="sAirlinePnr" HeaderText="Air PNR" />
                <asp:BoundField DataField="sReferenceNo" HeaderText="Reference No" />
                <asp:BoundField DataField="sSector" HeaderText="Sector" />
                <asp:BoundField DataField="sFCarrier" HeaderText="Airline" />
                <asp:BoundField DataField="sFlightClass" HeaderText="Flight Class" />
                <asp:BoundField DataField="sTktBookFrom" HeaderText="Book From" />


                <asp:BoundField DataField="nBasicFare" HeaderText="Sup BFare" />
                <asp:BoundField DataField="nYqTax" HeaderText="Sup YQ Tax" />
                <asp:BoundField DataField="nYrTax" HeaderText="Sup YR Tax" />
                <asp:BoundField DataField="nK3Tax" HeaderText="Sup K3 Tax" />
                <asp:BoundField DataField="nOtherTax" HeaderText="SupOther Tax" />
                <asp:BoundField DataField="nAirInc" HeaderText="Sup AirInc" />
                <asp:BoundField DataField="nAirComm" HeaderText="Sup AirComm" />
                <asp:BoundField DataField="nAirplb" HeaderText="Sup AirPLB" />
                <asp:BoundField DataField="nSupSCAmount" HeaderText="Sup SC" />
                <asp:BoundField DataField="nSupTdsAmount" HeaderText="Sup TDS" />
                <asp:BoundField DataField="nSupDiscount" HeaderText="Sup Discount" />
                ...
                <asp:BoundField DataField="nClntBasicFare" HeaderText="Clnt BFare" />
                <asp:BoundField DataField="nClntYQTax" HeaderText="Clnt YQ Tax" />
                <asp:BoundField DataField="nClntYRTax" HeaderText="Clnt YR Tax" />
                <asp:BoundField DataField="nClntK3Tax" HeaderText="Clnt K3 Tax" />
                <asp:BoundField DataField="nClntOtherTax" HeaderText="Clnt OtrTax" />
                <asp:BoundField DataField="nClntAirInc" HeaderText="Clnt AirInc" />
                <asp:BoundField DataField="nClntAirCom" HeaderText="Clnt AirComm" />
                <asp:BoundField DataField="nClntAirPlb" HeaderText="Clnt AirPLB" />
                <asp:BoundField DataField="nProfitAmount" HeaderText="Clnt SC1" />
                <asp:BoundField DataField="nClientSC2Amount" HeaderText="Clnt SC2" />
                ...
                <asp:BoundField DataField="nSupTktFare" HeaderText="Tkt Cost" />
                <asp:BoundField DataField="nBuyRate" HeaderText="Sup Cost" />
                <asp:BoundField DataField="nSellingCost" HeaderText="Clnt Cost" />
