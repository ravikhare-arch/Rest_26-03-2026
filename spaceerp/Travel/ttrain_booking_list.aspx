<%@ Page Title="Train Booking" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="ttrain_booking_list.aspx.cs" Inherits="ttrain_booking_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Train Booking </h4>
        </div>
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Train Booking  </b></h4>
                    <h4>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            $(document.body).ready(function () {
                ...
                $(document.body).on("click", ".editbtn", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ttrain_booking.aspx",
                        data: datastring,
                        cache: false,
                        success: function (html) {
                            window.location.href = "../Travel/ttrain_booking.aspx?" + datastring + "";
                        }
                    });
                });
                ...
                $(document.body).on("click", "#deletebutton", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("ttrain_booking_list.aspx/DeleteVoucher") %>',
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("ttrain_booking_list.aspx/loaddata") %>',
                type: "post",
