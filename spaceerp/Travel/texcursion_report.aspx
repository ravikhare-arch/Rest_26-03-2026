<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="texcursion_report.aspx.cs" Inherits="Travel_texcursion_report" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Excursion Booking Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                        ...
                        <div style="border: 1px solid #e0e0d9; padding: 10px; margin-top: 20px;">
                            <div class="form-group row m-b-15">
                                <div class="col-md-3 col-sm-3">
                                    ...
                                    <asp:DropDownList ID="ddlExcursionBookingNo" CssClass="form-control js-example-placeholder-single" runat="server">
                                    </asp:DropDownList>
                            ...
                            <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="sExcursionBookingNo" HeaderText="ExcursionBookingNo" />
                                        <asp:TemplateField HeaderText="tExcursionBooking">
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="nAdultPaxRate" HeaderText="Adult Pax Rate" />
                                        <asp:BoundField DataField="nChildPax" HeaderText="Child Pax" />
                                        <asp:BoundField DataField="nChildPaxRate" HeaderText="Child Pax Rate" />
                                        <asp:BoundField DataField="nTotal" HeaderText="Total Amount" />
