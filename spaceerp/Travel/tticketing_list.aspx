<%@ Page Title="Air Ticketing" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tticketing_list.aspx.cs" Inherits="tticketing_list" %>
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Ticket Booking  </b></h4>
                    <h4>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridViewexcel" CssClass="table" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="sTicCompanyBuy" HeaderText="Supplier Name" />
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        window.location.href = "../Travel/tticketing.aspx?" + datastring + "";
                    }
                });
            });
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("tticketing_list.aspx/DeleteVoucher") %>',
        ...
        function loaddata() {
            ...
            var agentName = ''
            $.ajax({
                url: '<%=ResolveUrl("tticketing_list.aspx/loaddata") %>',
                type: "post",
                ...
                success: function (mainlist) {
                    ...
                    var vcount = 0;
                    agentName = mainlist.d.mpagemasterobjlist[0].AgentName
