...
public partial class Excursion_Invoice : System.Web.UI.Page
{
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblcperson.Text = dt.Rows[0][5].ToString();


            lblcompanyAdd.Text = dt.Rows[0][6].ToString();
            
            
            lblPhone.Text = dt.Rows[0][7].ToString();
            lblphone2.Text = dt.Rows[0][7].ToString();
            lblFax.Text = dt.Rows[0][9].ToString();
            lblEmail.Text = dt.Rows[0][10].ToString();
            lblemail2.Text = dt.Rows[0][10].ToString();
            lblCity.Text = dt.Rows[0][13].ToString();
