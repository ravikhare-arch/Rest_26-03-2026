...
public partial class tgroup_ticketing_list : System.Web.UI.Page
{
    static tgroup_ticketing_Class objClass = new tgroup_ticketing_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor, string AgentID)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.InvoiceNo = dt.Rows[i]["sBookingNo"].ToString();
                magentobj.InvoiceDate = validation.TextToDate(dt.Rows[i]["dtBooking"].ToString());
                magentobj.AgentName = dt.Rows[i]["sAgentName"].ToString();
                magentobj.Supplier = dt.Rows[i]["sTicCompanyBuy"].ToString();
                ...
                magentobj.TicketID = dt.Rows[i]["nTicketingID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "GroupTicket-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/GroupTicket.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("GroupTicket - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : GroupTicket "; // Heading Name               
                worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sBookingNo"].ToString();
                    worksheet.Cells["C" + (i + 7)].Value = date(getdtdata.Rows[i]["dtBooking"].ToString());
                    worksheet.Cells["D" + (i + 7)].Value = getdtdata.Rows[i]["sAgentName"].ToString();
                    worksheet.Cells["E" + (i + 7)].Value = getdtdata.Rows[i]["sTicCompanyBuy"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=GroupTicket.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        getdtdata.Columns.Remove("nTicketingID");
        getdtdata.Columns.Remove("nAgentID");
        getdtdata.Columns.Remove("sTicketType");
        getdtdata.Columns.Remove("sCode");
        ...
        Response.AddHeader("content-disposition", "attachment;filename=GroupTicket.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- GroupTicket</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns["sBookingNo"].ColumnName = "Invoice No";
        // date(getdtdata.Rows[x]["dtDate"].ToString());
        dt.Columns["dtBooking"].ColumnName = "Invoice Date";
        dt.Columns["sAgentName"].ColumnName = "Agent Name";
        dt.Columns["sTicCompanyBuy"].ColumnName = "Guest Name";
    ...
    protected void btnsendmail_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rbexcel.Checked)
            {
                ...
                var fileName = "Ticket-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
                ...
                {
                    /////  // add a new worksheet to the empty workbook
                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Ticketing - " + DateTime.Now.ToShortDateString());
                    ...
                    ///////  //Merging cells and create a center heading for out table
                    worksheet.Cells[4, 1].Value = "	Statement Name : Ticketing "; // Heading Name               
                    worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                    worksheet.Cells[4, 1, 4, 11].Style.Font.Bold = true; //Font should be bold
                    worksheet.Cells[4, 1, 4, 11].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center; // Aligmnet is center
                    worksheet.Cells[4, 1].Style.Font.Color.SetColor(System.Drawing.Color.WhiteSmoke);
                    ...
                    // // // agent name header
                    ///////  //Merging cells and create a center heading for out table
                    worksheet.Cells[5, 1].Value = "	Agency Name : '" + ddlAgentID.SelectedItem.Text + "' "; // Heading Name               
                    worksheet.Cells[5, 1, 5, 11].Merge = true; //Merge columns start and end range
                    worksheet.Cells[5, 1, 5, 11].Style.Font.Bold = true; //Font should be bold
                    worksheet.Cells[5, 1, 5, 11].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center; // Aligmnet is center
                    worksheet.Cells[5, 1].Style.Font.Color.SetColor(System.Drawing.Color.WhiteSmoke);
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            mm.Subject = "Ticket PDF";
                            mm.Body = "Ticket PDF Attachment";
    ...
    {
        Response.Redirect("tgroup_ticketing.aspx");
    }
}
