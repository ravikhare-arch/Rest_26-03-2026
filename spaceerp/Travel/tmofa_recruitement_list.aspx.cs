...
public partial class tmofa_recruitement_list : System.Web.UI.Page
{
    static tmofarecruitement_Class objClass = new tmofarecruitement_Class();
    ...
    public void Page_PreRender(object sender, EventArgs e)
    {
        ...
        viewstate = Session["tticketing"].ToString();
    }
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor, string AgentID)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                magentobj.Supplier = dt.Rows[i]["sFullName"].ToString();
                ...
                magentobj.TicketID = dt.Rows[i]["nBookingID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            var outputDir = Server.MapPath("../Temp/Recruitement.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Recruitement - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Recruitement "; // Heading Name               
                worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["E" + (i + 7)].Value = getdtdata.Rows[i]["sFullName"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Recruitement.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Recruitement.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Recruitement</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns["sFullName"].ColumnName = "Guest Name";
    ...
    protected void btnsendmail_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rbexcel.Checked)
            {
                ...
                var fileName = "Recruitement-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            mm.Subject = "Recruitement PDF";
                            mm.Body = "Recruitement PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "Recruitement.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tmofa_recruitement.aspx");
    }
}
