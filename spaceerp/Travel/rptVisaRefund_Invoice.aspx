<%@ Page Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptVisaRefund_Invoice.aspx.cs" Inherits="Travel_rptVisaInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="content" class="content" style="color: black">
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb hidden-print pull-right" id="tplink">
                    ...
                    <li class="breadcrumb-item active">Refund Invoice</li>
                </ol>
            </div>
        </div>
        <!-- begin breadcrumb -->
        ...
        <div class="invoice text-black" id="invoice" runat="server">
            ...
            <div class="invoice-header text-black">
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        ...
                        <tr style="background-color: #1c3967; color: white; height: 30px; text-align: center;">
                            ...
                            <td class="text-center">VISA TYPE</td>
                            <td class="text-center">VISA DURATION</td>
                            <td class="text-center">VISA RATE</td>
                        </tr>
                        ...
                        <tr style="border: 1px solid black; height: 40px;">
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-center font-weight-bold">Service Charge
                            </td>
                        ...
                        <tr style="border: 1px solid black; height: 40px;">
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-center font-weight-bold">SUB TOTAL
                            </td>
                            <td class="text-center font-weight-bold">
