...
public partial class tcar_booking_list : System.Web.UI.Page
{
    static tcar_booking_Class objClass = new tcar_booking_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor, string AgentID)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.InvoiceNo = dt.Rows[i]["sCarBookingNo"].ToString();
                magentobj.InvoiceDate = validation.TextToDate(dt.Rows[i]["dtCarBooking"].ToString());
                ...
                magentobj.TicketID = dt.Rows[i]["nCarBookingID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "Car-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/Car.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Car - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Car "; // Heading Name               
                worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sCarBookingNo"].ToString();
                    worksheet.Cells["C" + (i + 7)].Value = date(getdtdata.Rows[i]["dtCarBooking"].ToString());
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Car.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Car.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Car</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns["sCarBookingNo"].ColumnName = "Invoice No";
        // date(getdtdata.Rows[x]["dtDate"].ToString());
        dt.Columns["dtCarBooking"].ColumnName = "Invoice Date";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            mm.Subject = "Car PDF";
                            mm.Body = "Car PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "Car.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tcar_booking.aspx");
    }
}
