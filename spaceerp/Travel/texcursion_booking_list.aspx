<%@ Page Title="Excursion Booking" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="texcursion_booking_list.aspx.cs" Inherits="texcursion_booking_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Car Booking  </b></h4>
                    <h4>
        ...
        function pageLoad(sender, args) {
            $(document.body).ready(function () {
                ...
                $(document.body).on("click", ".editbtn", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "texcursion_booking.aspx",
                        data: datastring,
                        cache: false,
                        success: function (html) {
                            window.location.href = "../Travel/texcursion_booking.aspx?" + datastring + "";
                        }
                    });
                });
                ...
                $(document.body).on("click", "#deletebutton", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("texcursion_booking_list.aspx/DeleteVoucher") %>',
    ...
    function loaddata() {
        ...
        var Reportfor = document.getElementById("<%=ddlStReportFor.ClientID %>").value;
            ...
            $.ajax({
                url: '<%=ResolveUrl("texcursion_booking_list.aspx/loaddata") %>',
                type: "post",
