<%@ Page Title="Hotel Booking" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="thotel_list.aspx.cs" Inherits="thotel_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Hotel Booking  </b></h4>
                    <h4>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            $(document.body).ready(function () {
                ...
                $(document.body).on("click", ".editbtn", function () {
                    ...
                    $.ajax({
                        ...
                        success: function (html) {
                            window.location.href = "../Travel/thotel.aspx?" + datastring + "";
                        }
                    });
                });
                ...
                $(document.body).on("click", "#deletebutton", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("thotel_list.aspx/DeleteVoucher") %>',
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("thotel_list.aspx/loaddata") %>',
                type: "post",
