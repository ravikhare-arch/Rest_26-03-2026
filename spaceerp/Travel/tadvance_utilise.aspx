<%@ Page Title="ADVANCE PAYMENT UTILISE" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tadvance_utilise.aspx.cs" Inherits="Transcation_payment_voucher" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">ADVANCE PAYMENT UTILISE </h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                                ...
                                <div style="padding: 25px;">
                                    <div class="form-group row m-b-10">
                                         <div class="col-md-2 col-sm-3 ">
                                            ...
                                            <asp:DropDownList ID="ddlAccountType" runat="server" Width="100%" CssClass="form-control js-example-placeholder-single" AutoPostBack="true" OnSelectedIndexChanged="ddlAccountType_SelectedIndexChanged">
                                                <asp:ListItem Value="Client" Text="Client"></asp:ListItem>
                                                 <asp:ListItem Value="Supplier" Text="Supplier"></asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlAccountType" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-2 col-sm-3 ">
                                            <label class="col-form-label" for="email">Account  :</label>
                                            <asp:DropDownList ID="ddlAccount" runat="server" Width="100%" CssClass="form-control js-example-placeholder-single" AutoPostBack="true" OnSelectedIndexChanged="ddlAccount_SelectedIndexChanged">
                                            </asp:DropDownList>
                                    ...
                                    <div class="form-group row m-b-0">
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <asp:DropDownList ID="ddlPayAccount" runat="server" CssClass="form-control" AutoPostBack="True"></asp:DropDownList>
                                         ...
                                         <div class="col-md-3 col-sm-3">
                                            <label class="col-form-label">Credit Balance</label>
                                            <asp:TextBox ID="txtCreditBalance" CssClass="form-control" runat="server" Width="100%" Enabled="false"></asp:TextBox>
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <asp:CompareValidator ID="CompareValidator19" runat="server" ErrorMessage="Invalid Amount" Display="Dynamic" ControlToValidate="txtAmount" ValidationGroup="A" ControlToCompare="txtCreditBalance" Type="Double" Operator="LessThanEqual" ForeColor="Red"></asp:CompareValidator>
                                        </div>
                                ...
                                <asp:Panel CssClass="tbl" ID="tblGridM" runat="server">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <asp:GridView ID="GridView3" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Invoice Date">
                                                      ...
                                                      <asp:BoundField DataField="sMode" HeaderText="Payment Type" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Payment Value">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtPaymentValue" Text="0" runat="server" AutoPostBack="true" OnTextChanged="txtPaymentValue_TextChanged" ValidationGroup="A"></asp:TextBox>
                                                            <asp:CompareValidator ID="CompareValidator19" runat="server" ErrorMessage="Invalid Amount" Display="Dynamic" ControlToValidate="txtPaymentValue" ValidationGroup="A" ControlToCompare="txtBalance" Type="Double" Operator="LessThanEqual" ForeColor="Red"></asp:CompareValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <asp:GridView ID="GridView2" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
                                                DataKeyNames="nAdvanceUtiliseDetID" Width="100%" AllowPaging="false" AllowSorting="True" EmptyDataText="No Records to display"
                                                OnRowDataBound="GridView2_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="nAdvanceUtiliseDetID" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAdvanceUtiliseDetID" runat="server" Text='<%# Eval("nAdvanceUtiliseDetID") %>'></asp:Label>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="nAdvanceUtiliseID" Width="95%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
                                    OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="nAdvanceUtiliseID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nAdvanceUtiliseID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="sAccountType" HeaderText="Accoount Type" />
                                        <asp:BoundField DataField="sAgencyName" HeaderText="Accoount Name" />
