...
public partial class tgroupmofa_booking_list : System.Web.UI.Page
{
    static tgroupmofa_Class objClass = new tgroupmofa_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor, string AgentID)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.InvoiceNo = dt.Rows[i]["sGMofaBookingNo"].ToString();
                ...
                magentobj.TicketID = dt.Rows[i]["nGroupMofaID"].ToString();
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Group Mofa.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Group Mofa</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns["sGMofaBookingNo"].ColumnName = "Invoice No";
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            var outputDir = Server.MapPath("../Temp/GroupMofa.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("GroupMofa - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : GroupMofa "; // Heading Name               
                worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sGMofaBookingNo"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=GroupMofa.xlsx");
    ...
    {
        Response.Redirect("tgroupmofa_booking.aspx");
    }
}
