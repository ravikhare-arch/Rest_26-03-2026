...
public partial class Travel_texcursion_report : System.Web.UI.Page
{
  ...
  //  mlocation_Class objBranch = new mlocation_Class();
        ...
        try
        {
            if (!IsPostBack)
            {
               ...
               // objCompany.ddlOperation(objCompany, "Show", "", ddlCompanyID);
                ...
                objClass.ddlOperation(objClass, "Show", "", ddlExcursionBookingNo);
    ...
    protected void btngdPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Label ID = (Label)GridView1.Rows[row].Cells[0].FindControl("lblID");
            Session["eid"] = ID.Text;
            Response.Redirect("rptExcursionInvoice.aspx");
    ...
    public void getPara()
    {
        objClass.nExcursionBookingID = ddlExcursionBookingNo.SelectedValue;
        objClass.dtExcursionBooking = validation.dateToText(txtdtBooking.Text.Trim());
    ...
    {
        txtdtBooking.Text = "";
        ddlExcursionBookingNo.SelectedValue = "0";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            if (txtdtBooking.Text != "" || ddlExcursionBookingNo.SelectedValue != "0" || ddlAgentID.SelectedValue != "0" || ddlLocationID.SelectedValue != "0" )
            {
                getPara();
