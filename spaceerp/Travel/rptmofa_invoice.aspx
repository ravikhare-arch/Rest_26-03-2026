<%@ Page Language="C#" Title="Mofa Invoice" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptmofa_invoice.aspx.cs" Inherits="Travel_rptBusInvoice" %>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb hidden-print pull-right" id="tplink">
                    <li class="breadcrumb-item"><a href="tmofa_booking.aspx">Home</a></li>
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                            <th class="text-center" colspan="2">MUTAMAR NAME</th>
                            <th class="text-center">MUTAMAR NO.</th>
                            <th class="text-center">PASSPORT NO.</th>
                            <th class="text-center">ISSUE DATE</th>
                            <th class="text-center">EXPIRY DATE</th>
                            <th class="text-center">MOFA NO.</th>
                            <th class="text-center">EMBASSY</th>
                            <th class="text-center">DURATION</th>
                            <th class="text-center">VALIDITY</th>
                            <th class="text-center" colspan="2">MOFA COST</th>
                        </tr>
                        <asp:Repeater ID="rptDetails" runat="server">
                            <ItemTemplate>
                                <tr style="height: 40px; text-align: center; padding: 10px; border: 1px solid black">

                                    <td class="text-center" colspan="2"><%# Eval("sEngName") %></td>
                                    <td class="text-center"><%# Eval("sMutamarNo") %></td>
                                    <td class="text-center"><%# Eval("sPassportNo") %></td>
                                    <td class="text-center"><%# validation.TextToDate(Eval("dtIssueDate").ToString()) %></td>
                                    <td class="text-center"><%# validation.TextToDate(Eval("dtExpityDate").ToString()) %></td>
                                    <td class="text-center"><%# Eval("sMofaNo") %></td>
                                    <td class="text-center"><%# Eval("sEmbassy") %></td>
                                    <td class="text-center"><%# Eval("sDuration") %></td>
                                    <td class="text-center"><%# Eval("sVisaValiditry") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("nBuyCost") %></td>
                                </tr>
