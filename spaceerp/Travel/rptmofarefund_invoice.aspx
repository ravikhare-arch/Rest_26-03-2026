<%@ Page Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptmofarefund_invoice.aspx.cs" Inherits="Travel_rptBusInvoice" %>
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                            ...
                            <th class="text-center" colspan="2">ISSUE DATE</th>
                            <th class="text-center" colspan="2">EXPIRY DATE</th>
                            <th class="text-center" colspan="2">PASSPORT NO.</th>
                            <th class="text-center" colspan="2">AUTHORISED BY</th>
                        ...
                        <asp:Repeater ID="rptDetails" runat="server">
                            <ItemTemplate>
                                <tr style="height: 40px; text-align: center; padding: 10px; border: 1px solid black">
                                    ...
                                    <td class="text-center" colspan="2"><%# validation.TextToDate(Eval("dtIssueDate").ToString()) %></td>
                                    <td class="text-center" colspan="2"><%# validation.TextToDate(Eval("dtExpityDate").ToString()) %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sPassportNo") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sAuthority") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("nSubTot") %></td>
                                </tr>
