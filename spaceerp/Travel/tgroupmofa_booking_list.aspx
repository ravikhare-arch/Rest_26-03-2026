<%@ Page Title="Group Mofa Entries" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tgroupmofa_booking_list.aspx.cs" Inherits="tgroupmofa_booking_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Group Mofa Entries</h4>
        </div>
   ...
   <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
     ...
     <div id="griddiv" runat="server" visible="false">
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <h1 style="text-align: center">Supplier Name: Alnasa Technology</h1>
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Group Mofa Booking  </b></h4>
                    <h4>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            $(document.body).ready(function () {
                ...
                $(document.body).on("click", ".editbtn", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "tgroupmofa_booking.aspx",
                        data: datastring,
                        cache: false,
                        success: function (html) {
                            window.location.href = "../Travel/tgroupmofa_booking.aspx?" + datastring + "";
                        }
                    });
                });
                ...
                $(document.body).on("click", "#deletebutton", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("tgroupmofa_booking_list.aspx/DeleteVoucher") %>',
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("tgroupmofa_booking_list.aspx/loaddata") %>',
                type: "post",
                ...
                success: function (mainlist) {
                    ...
                    for (i = 0; i < mainlist.d.mpagemasterobjlist.length; i++) {
                        ...
                        html += '<td >' + '<a href="tvisa.aspx" class="editbtn" title="Edit"><i class="glyphicon glyphicon-edit" style="color: green" s></i></a>&nbsp;&nbsp;&nbsp;<a href="#" class="deletebtn" title="Delete" data-toggle="modal" data-target="#deleteModalCenter"><i class="glyphicon glyphicon-trash" style="color: red"></i></a>' + '</td>';
