<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="tVisa_report.aspx.cs" Inherits="Travel_tvisa_report" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Visa Booking Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                            ...
                            <div class="form-group row m-b-15">
                                <div class="col-md-3 col-sm-3">
                                    <label class="col-form-label" for="fullname">
                                        Visa Booking No. :</label>
                                    <asp:DropDownList CssClass="form-control js-example-placeholder-single" ID="ddlVisaBookingNo" runat="server">
                                    </asp:DropDownList>
                            ...
                            <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="sVisaBookingNo" HeaderText="VisaBookingNo" />
                                        <asp:TemplateField HeaderText="tBooking">
                                            <ItemTemplate>
                                                <%#validation.TextToDate(Eval("dtBooking").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="sVisaSellCompany" HeaderText="Sell Company" />
                                        <asp:BoundField DataField="nSellingRate" HeaderText="Selling Rate" />
                                        <asp:BoundField DataField="sVisaBuyCompany" HeaderText="Buy Company" />
                                        <asp:BoundField DataField="nBuyingRate" HeaderText="Buying Rate" />
