<%@ Page Title="Umrah Mofa Entries" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tmofa_booking.aspx.cs" Inherits="Transcation_mofa_booking" %>
                                    ...
                                    <div style=" padding: 5px; margin-top: 0px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-4">
                                                <label class="col-form-label" for="fullname">
                                                    Pax Name:</label>
                                                <asp:TextBox ID="txtEngName" CssClass="form-control" runat="server" ValidationGroup="B" Width="100%">
                                                </asp:TextBox>
                                            </div>
                                            <div class="col-md-2 col-sm-4">
                                                <label class="col-form-label" for="fullname">
                                                    Nationality :</label>
                                                <asp:DropDownList ID="ddlNationalityID" runat="server" CssClass="form-control js-example-placeholder-single">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-5 col-sm-12">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            Country :</label>
                                                        <asp:DropDownList ID="ddlCountry" runat="server" CssClass="form-control js-example-placeholder-single">
                                                        </asp:DropDownList>

                                                    </div>
                                                    <div class="col-md-6 col-sm-4" style="z-index: 99">
                                                        <label class="col-form-label" for="fullname">
                                                            DOB :</label>
                                                        <asp:TextBox ID="txtdtDOBDate" runat="server" CssClass="form-control datepicker" Width="100%" Placeholder="dd/MM/yyyy"></asp:TextBox>
                                                        <AjaxToolKit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy"
                                                            PopupButtonID="txtdtDOBDate" TargetControlID="txtdtDOBDate" PopupPosition="TopLeft" />
                                                        <AjaxToolKit:MaskedEditExtender ID="MaskedEditExtender1" runat="server"
                                                            TargetControlID="txtdtDOBDate" Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtdtDOBDate"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-sm-4" style="z-index: 99">
                                                        <label class="col-form-label" for="fullname">
                                                            Issue DT :</label>
                                                        <asp:TextBox ID="txtdtIssueDate" runat="server" CssClass="form-control datepicker" Width="100%" placeholder="DD/MM/YYYY"></asp:TextBox>
                                                        <%--<AjaxToolKit:CalendarExtender ID="CalendarExtender9" runat="server" Format="dd/MM/yyyy"
                                                            PopupButtonID="txtdtIssueDate" TargetControlID="txtdtIssueDate" PopupPosition="TopLeft" />--%>
                                                        <AjaxToolKit:MaskedEditExtender ID="MEE9" runat="server"
                                                            TargetControlID="txtdtIssueDate" Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                                        <asp:RegularExpressionValidator ID="REV9" ControlToValidate="txtdtIssueDate"
                                                            ValidationGroup="A" Display="Dynamic" SetFocusOnError="true" runat="server" ErrorMessage="Invalid Date"
                                                            ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d"> 
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4" style="z-index: 110">
                                                        <label class="col-form-label" for="fullname">
                                                            Expry DT</label>
                                                        <asp:TextBox ID="txtdtExpityDate" runat="server" CssClass="datepicker form-control" Width="100%" Placeholder="dd/MM/yyyy"></asp:TextBox>
                                                     <%--   <AjaxToolKit:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy"
                                                            PopupButtonID="txtdtExpityDate" TargetControlID="txtdtExpityDate" PopupPosition="TopLeft" />--%>
                                                        <AjaxToolKit:MaskedEditExtender ID="MaskedEditExtender2" runat="server"
                                                            TargetControlID="txtdtExpityDate" Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" ControlToValidate="txtdtExpityDate"
                                                            ValidationGroup="A" Display="Dynamic" SetFocusOnError="true" runat="server" ErrorMessage="Invalid Date"
                                                            ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d"> 
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                    ...
                                                    <%-- <div class="col-md-3 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Spnsor No</label>
                                                        <asp:TextBox ID="txtSpnsrNo" runat="server" ValidationGroup="B" Width="100%">
                                                        </asp:TextBox>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="row">
                                                    <div class="col-md-4 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            Visa No. :</label>
                                                        <asp:TextBox ID="txtMofaNo" CssClass="form-control" runat="server" ValidationGroup="B" Width="100%">
                                                        </asp:TextBox>
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            Duration :</label>
                                                        <asp:TextBox ID="txtDuration" CssClass="form-control" runat="server" ValidationGroup="B" Width="100%">
                                                        </asp:TextBox>
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            Visa Validity :</label>
                                                        <asp:TextBox ID="txtValidity" CssClass="form-control" runat="server" ValidationGroup="B" Width="100%">
                                                        </asp:TextBox>
                                                    ...
                                                    <%-- <div class="col-md-3 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Muhram :</label>
                                                        <asp:TextBox ID="txtMuhram" runat="server" ValidationGroup="B" Width="100%">
                                                        </asp:TextBox>
                                                    ...
                                                    <%--<div class="col-md-3 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Relation :</label>
                                                        <asp:TextBox ID="txtRelation" runat="server" ValidationGroup="B" Width="100%">
                                                        </asp:TextBox>
                                                     ...
                                                     <div class="col-md-3 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Dependnt :</label>
                                                        <asp:TextBox ID="txtDependant" runat="server" ValidationGroup="B" Width="100%">
                                                        </asp:TextBox>
                                                ...
                                                <div style=" padding: 5px; margin-top: 0px;">
                                                    <div class="form-group row m-b-5">
                                                        ...
                                                        <div class="col-md-3 col-sm-3">
                                                            ...
                                                            <asp:TextBox ID="txtclntRepeaterFee" CssClass="form-control" runat="server" Width="95%" Text="0" Placeholder="" OnTextChanged="txtclntRepeaterFee_TextChanged" AutoPostBack="true" placeolder=""></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator17" runat="server" ControlToValidate="txtclntRepeaterFee"
                                                                SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Numbers" ValidationExpression="^(-)?\d+(\.\d+$)?$"
                                                                ValidationGroup="A"></asp:RegularExpressionValidator>
                                                            <AjaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender13" runat="server"
                                                                Enabled="True" FilterMode="ValidChars" FilterType=" Custom,Numbers" TargetControlID="txtclntRepeaterFee"
                                                                ValidChars=".-">
                                                            </AjaxToolKit:FilteredTextBoxExtender>
                                                        </div>
                                                        <%-- <div class="col-md-2 col-sm-3">
                                                        ...
                                                        <div class="col-md-2 col-sm-3">
                                                            ...
                                                            <asp:DropDownList ID="ddlClntTds" runat="server" Width="100%">
                                                                <asp:ListItem Value="0" Text="Value"></asp:ListItem>
                                                                <asp:ListItem Value="1" Text="%"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                        <div class="col-md-2 col-sm-3">
                                                            ...
                                                            <asp:TextBox ID="txtClntTds" runat="server" placeholder="" Width="100%" AutoPostBack="True" OnTextChanged="txtClntTds_TextChanged"></asp:TextBox>
                                                ...
                                                <div style=" padding: 5px; margin-top: 0px;">
                                                    <div class="form-group row m-b-10">
                                                        ...
                                                        <div class="col-md-3 col-sm-3">
                                                            ...
                                                            <asp:TextBox ID="txtSupRepeaterFee" CssClass="form-control" runat="server" Width="95%" Text="0" Placeholder="   :" OnTextChanged="txtSupRepeaterFee_TextChanged" AutoPostBack="true" placeolder=""></asp:TextBox>
                                                    ...
                                                    <div class="form-group row m-b-5">
                                                        ...
                                                        <div class="col-md-3 col-sm-3">
                                                            <label class="col-form-label" for="fullname">
                                                                Discount :</label>
                                                            <asp:TextBox ID="txtSupDiscount" runat="server" CssClass="form-control" Width="100%" AutoPostBack="true" Text="0" OnTextChanged="txtSupDiscount_TextChanged"></asp:TextBox>
...
<br />
                                ...
                                <asp:Panel class="tbl table-responsive" ID="tblGridDet" runat="server" Style="margin-top: 20px;">
                                    ...
                                    <asp:GridView ID="GridView2" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
                                        DataKeyNames="nMofaBookingDetID" Width="100%" AllowPaging="false" AllowSorting="True" EmptyDataText="No Records to display"
                                        OnPageIndexChanging="GridView2_PageIndexChanging">
                                        <Columns>
                                            <asp:TemplateField HeaderText="nMofaBookingDetID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDetID" runat="server" Text='<%# Eval("nMofaBookingDetID") %>'></asp:Label>
                                                    <asp:Label ID="lblBookType" runat="server" Text='<%# Eval("sVoucherType") %>'></asp:Label>
                                                    <asp:Label ID="lblMofaBookingID" runat="server" Text='<%# Eval("nMofaBookingID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="sVoucherType" HeaderText="Type" />
                                            <asp:BoundField DataField="sEngName" HeaderText="Pax Name" />
                                            <asp:BoundField DataField="sMofaNo" HeaderText="Visa No" />
                                            <asp:BoundField DataField="sVisaCountry" HeaderText="Country" />
                                            <asp:BoundField DataField="sCountryName" HeaderText="Nationality" />
                                            <asp:BoundField DataField="sPassportNo" HeaderText="sPassportNo" />
                    ...
                    <i class="far fa-lg fa-fw m-r-10 fa-trash-alt fa-grid-del"></i> <span class="text-inverse">Delete</span>
                            ...
                            <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
                                    ...
                                    DataKeyNames="nMofaBookingID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="nMofaBookingID" Visible="false">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblInvoiceNo" runat="server" Text='<%# Eval("sMofaBookingNo") %>'></asp:Label>
                                        ...
                                        <asp:BoundField DataField="sEngName" HeaderText="Guest Name" />
                            ...
                            <asp:Panel ID="PnlPayment" runat="server">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Mofa Payment</h4>
                                    </div>
                                    <div class="row m-5">
                                        ...
                                        <div class="col-md-3 col-sm-3" style="z-index: 99">
                                            <h5>Payment Date</h5>
                                            <asp:TextBox ID="txtdtpayment" runat="server" CssClass="datepicker" Width="100%" placeholder="DD/MM/YYYY" OnTextChanged="txtdtpayment_TextChanged" AutoPostBack="true"></asp:TextBox>
