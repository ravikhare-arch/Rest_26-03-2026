...
public partial class tinsurance_booking_list : System.Web.UI.Page
{
    static tinsurance_booking_Class objClass = new tinsurance_booking_Class();
    ...
    public void Page_PreRender(object sender, EventArgs e)
    {
        ...
        //viewstate = Session["tvisa"].ToString();
    }
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor, string AgentID)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.InvoiceNo = dt.Rows[i]["sInsuranceBookingNo"].ToString();
                ...
                magentobj.Supplier = dt.Rows[i]["sPaxName"].ToString();
                ...
                magentobj.TicketID = dt.Rows[i]["nInsuranceBookingID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "Insurance-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/Insurance.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Insurance - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Insurance "; // Heading Name               
                worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sInsuranceBookingNo"].ToString();
                    ...
                    worksheet.Cells["E" + (i + 7)].Value = getdtdata.Rows[i]["sPaxName"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Insurance.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Insurance.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Insurance</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns["sInsuranceBookingNo"].ColumnName = "Invoice No";
        ...
        dt.Columns["sPaxName"].ColumnName = "Guest Name";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            mm.Subject = "Insurance PDF";
                            mm.Body = "Insurance PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "Insurance.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tinsurance_booking.aspx");
    }
