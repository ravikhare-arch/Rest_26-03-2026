<%@ Page Language="C#" Title="Mofa Recruitement Refund Invoice" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptmofa_recruitement_refundInv.aspx.cs" Inherits="Travel_rptMofaRecInvoice" %>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb hidden-print pull-right" id="tplink">
                    <li class="breadcrumb-item"><a href="tmofa_recruitement.aspx">Home</a></li>
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                            ...
                            <th class="text-center" colspan="2">VISA TYPE</th>
                            <th class="text-center" colspan="2">NO. OF ENTRY</th>
                            <th class="text-center" colspan="2">VALIDITY</th>
                            <th class="text-center" colspan="2">Refund Amount</th>
                        </tr>
                        <asp:Repeater ID="rptDetails" runat="server">
                            <ItemTemplate>
                                <tr style="height: 40px; text-align: center; padding: 10px; border: 1px solid black">

                                    <td class="text-center" colspan="2"><%# Eval("sFullName") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sPassportNo") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sVisaType") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sNoOfEntry") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sVisaValidity") %></td>
