<%@ Page Title="Ticket Invoice" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptTicketInvoice.aspx.cs" Inherits="Travel_rptTicketInvoice" %>
            ...
            <div class="invoice-header">
                <table style="margin-bottom: 30px;width:100%" >
                    <tr>
                        ...
                        <td colspan="4" class="float-left" style="width: 40%">
