<%@ Page Title="Excursion Refund Invoice" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptExcursionRefundInvoice.aspx.cs" Inherits="Travel_rptExcursionInvoice" %>
            ...
            <div class="table-responsive">
                <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                    <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                        ...
                        <td class="text-center" colspan="2">EXCURSION TYPE</td>
                        <td class="text-center">ADULT PAX</td>
                        <td class="text-right">ADULT PAX RATE</td>
                        <td class="text-center">CHILD PAX</td>
                        <td class="text-center">CHILD PAX RATE</td>
                    ...
                    <asp:Repeater ID="rptDetails" runat="server">
                        <ItemTemplate>
                            <tr style="border: 1px solid black; height: 40px;">
                                ...
                                <td class="text-center" colspan="2"><%# Eval("sExcursionReferenceNo") %></td>
                                <td class="text-center" colspan="2"><%# Eval("sGuestName") %></td>
                                <td class="text-center" colspan="2"><%# Eval("sExcursionType") %></td>
