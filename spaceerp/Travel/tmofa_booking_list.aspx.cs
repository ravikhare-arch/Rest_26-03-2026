...
public partial class tmofa_booking_list : System.Web.UI.Page
{
    static tmofabooking_Class objClass = new tmofabooking_Class();
        ...
        try
        {
            if (Reportfor != "0" && Reportfor != "")
            {
                if (Reportfor == "7")
                {
                    ...
                    objClass.nClientID = "0";
                }
                else if (Reportfor == "3")
                {
                    objClass.nClientID = AgentID;
            ...
            {
                magentobj = new list();
                magentobj.InvoiceNo = dt.Rows[i]["sMofaBookingNo"].ToString();
                magentobj.InvoiceDate = validation.TextToDate(dt.Rows[i]["dtBookingDate"].ToString());
                ...
                magentobj.TicketID = dt.Rows[i]["nMofaBookingID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        getdtdata.Columns.Remove("nMofaBookingID");
        getdtdata.Columns.Remove("nClientID");
        ...
        try
        {
            ...
            #region start code
            var fileName = "Mofa-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/Mofa.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Mofa - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Mofa "; // Heading Name               
                worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sMofaBookingNo"].ToString();
                    worksheet.Cells["C" + (i + 7)].Value = date(getdtdata.Rows[i]["dtBookingDate"].ToString());
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Mofa.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Single Mofa.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Single Mofa</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns["sMofaBookingNo"].ColumnName = "Invoice No";
        // date(getdtdata.Rows[x]["dtDate"].ToString());
        dt.Columns["dtBookingDate"].ColumnName = "Invoice Date";
    ...
    protected void btnsendmail_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rbexcel.Checked)
            {
                ...
                var fileName = "Single Mofa-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
                ...
                {
                    /////  // add a new worksheet to the empty workbook
                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Single Mofa - " + DateTime.Now.ToShortDateString());
                    ...
                    ///////  //Merging cells and create a center heading for out table
                    worksheet.Cells[4, 1].Value = "	Statement Name : Single Mofa "; // Heading Name               
                    worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                    worksheet.Cells[4, 1, 4, 11].Style.Font.Bold = true; //Font should be bold
                    worksheet.Cells[4, 1, 4, 11].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center; // Aligmnet is center
                    worksheet.Cells[4, 1].Style.Font.Color.SetColor(System.Drawing.Color.WhiteSmoke);
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            mm.Subject = "Single Mofa PDF";
                            mm.Body = "Single Mofa PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "Single Mofa.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tmofa_booking.aspx");
    }
