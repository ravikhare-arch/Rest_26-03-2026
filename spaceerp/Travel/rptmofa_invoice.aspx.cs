...
public partial class Travel_rptBusInvoice : System.Web.UI.Page
{
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //Calculation
            lblSc.Text = dt.Rows[0]["nClntScAmount"].ToString();
            lblSubTot1.Text = (double.Parse(dt.Rows[0]["nSupplierCost"].ToString()) + double.Parse(lblSc.Text)).ToString();
            ...
            lblGrandTot.Text = dt.Rows[0]["nClientCost"].ToString();
            ...
            objClassdet.FillReapter(objClassdet, rptDetails, "PrintInvdet", Request.QueryString["id"].ToString());
   ...
   VerifyRenderingInServerForm(Control control)
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        string FileName = "MI" + "_" + sDate + "_" + sTime;
    ...
    public void Send()
    {
        ...
        sFileName = "MI" + "_" + sDate + "_" + Stime3 + ".xls";
