<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpay_receipt_inv.aspx.cs" Inherits="Travel_rptInsuranceInvoice" %>
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="8">
                                    ...
                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../../Dashboard.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
