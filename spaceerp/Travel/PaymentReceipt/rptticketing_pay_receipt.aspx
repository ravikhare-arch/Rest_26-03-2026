<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptticketing_pay_receipt.aspx.cs" Inherits="Travel_rptInsuranceInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Air Ticket Payment Receipt </title>
    <meta charset="utf-8" />
                    ...
                    <div class="invoice-title" style="border: 2px solid black; border-bottom: none;">
                        <table>
                            <tr>
                                <td colspan="8">
                                    <%--<img src="logo.png" />--%>
                                    <asp:Image ID="imgComp" runat="server" AlternateText="" Width="200" Height="100" />
