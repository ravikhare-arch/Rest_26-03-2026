<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_advance_made.aspx.cs" Inherits="Travel_rptInsuranceInvoice" %>
                    ...
                    <div class="invoice-title" style="border: 2px solid black; border-bottom: none;">
                        <table>
                            <tr>
                                <td colspan="8">
                                    <%--<img src="logo.png" />--%>
                                    <asp:Image ID="imgComp" runat="server" AlternateText="" Width="200" />
                                    <h3 style="margin-left: 322px;">ADVANCE RECEIPT</h3>
                                </td>
                                <td colspan="8">

                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../tadvance_payment.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>PAYMENT FOR</strong></td>
