<%@ Page Language="C#" Title="Insurance Refund Invoice" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptinsurance_refund_invoice.aspx.cs" Inherits="Travel_rptInsuranceInvoice" %>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb hidden-print pull-right" id="tplink">
                    <li class="breadcrumb-item"><a href="tinsurance_booking.aspx">Home</a></li>
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                            <th class="text-center" colspan="2">Policy No.</th>
                            <th class="text-center" colspan="2">Name</th>
                            <th class="text-center" colspan="2">Plan</th>
                            <th class="text-center" colspan="2">sProposal</th>
                            <th class="text-center" colspan="2">From Date</th>
                        ...
                        <asp:Repeater ID="rptDetails" runat="server">
                            <ItemTemplate>
                                <tr style="height: 40px; text-align: center; padding: 10px; border: 1px solid black">
                                    ...
                                    <td class="text-center" colspan="2"><%# Eval("sPolicyNo") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sPaxName") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sPlanNo") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sProposal") %></td>
                                    <td class="text-center" colspan="2"><%# validation.TextToDate(Eval("dtTravelFromDate").ToString()) %></td>
                                    <td class="text-center"><%# validation.TextToDate(Eval("dtTravelToDate").ToString()) %></td>
                                    <td class="text-center"><%# Eval("nSubTot") %></td>
                                </tr>
