<%@ Page Title="Bus Booking" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tbus_booking.aspx.cs" Inherits="Transcation_bus_booking" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">Bus Booking </h4>
                                ...
                                <div style="padding: 5px; padding-top: 0px; margin-top: 5px;">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            ...
                                            <asp:TextBox ID="txtBusBookingNo" runat="server" CssClass="form-control" Width="100%" AutoPostBack="true" Enabled="true" OnTextChanged="txtBusBookingNo_TextChanged"> </asp:TextBox>

                                        </div>
                                        <div class="col-md-2 col-sm-2">
                                            <label class="col-form-label" for="fullname">
                                                Invoice Date :</label>
                                            <asp:TextBox ID="txtdtBusBooking" runat="server" CssClass="datepicker form-control" required AutoPostBack="true" OnTextChanged="txtdtBusBooking_TextChanged"></asp:TextBox>
                                            <%-- <AjaxToolKit:CalendarExtender ID="CalendarExtender4" runat="server" Format="dd/MM/yyyy"
                                                PopupButtonID="txtdtBusBooking" TargetControlID="txtdtBusBooking" PopupPosition="TopLeft" />--%>

                                            <AjaxToolKit:MaskedEditExtender ID="MEE4" runat="server" TargetControlID="txtdtBusBooking"
                                                Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                            <asp:RegularExpressionValidator ID="REV4" ControlToValidate="txtdtBusBooking" ValidationGroup="A"
                                    ...
                                    <div style="padding: 5px; margin-top: 0px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Ticket No :</label>
                                                <asp:TextBox ID="txtTicketNo" CssClass="form-control" runat="server" Width="100%" required ValidationGroup="B">
                                                </asp:TextBox>
                                            </div>
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Pax Name :</label>
                                                <asp:TextBox ID="txtPaxName" CssClass="form-control" runat="server" ValidationGroup="B" Width="100%">
                                                </asp:TextBox>
                                            </div>

                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">Gender </label>
                                                <asp:DropDownList ID="ddlGenderID" CssClass="form-control" runat="server" Width="100%">
                                            ...
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Age :</label>
                                                <asp:TextBox ID="txtPaxAge" CssClass="form-control" runat="server" Width="100%"></asp:TextBox>
                                            </div>
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Bus No :</label>
                                                <asp:TextBox ID="txtBusNo" CssClass="form-control" runat="server" Width="100%"></asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtBusNo" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="B"></asp:RequiredFieldValidator>
                                            </div>
                                            ...
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Coach Type :</label>
                                                <asp:TextBox ID="txtCoachType" CssClass="form-control" runat="server" Width="100%"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    From :</label>
                                                <asp:TextBox ID="txtOrigin" CssClass="form-control" runat="server" ValidationGroup="B" Width="100%">
                                                </asp:TextBox>
                                            ...
                                            <div class="col-md-3 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    To :</label>
                                                <asp:TextBox ID="txtDestination" CssClass="form-control" runat="server" ValidationGroup="B" Width="100%">
                                                </asp:TextBox>
                                            ...
                                            <div class="col-md-3 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Travel Date :</label>
                                                <asp:TextBox ID="txttTravelDate" runat="server" CssClass="datepicker form-control" Width="100%" placeholder="DD/MM/YYYY"></asp:TextBox>
                                                <AjaxToolKit:CalendarExtender ID="CalendarExtender9" runat="server" Format="dd/MM/yyyy"
                                                    PopupButtonID="txttTravelDate" TargetControlID="txttTravelDate" PopupPosition="TopLeft" />
                                                <AjaxToolKit:MaskedEditExtender ID="MEE9" runat="server"
                                                    TargetControlID="txttTravelDate" Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                                <asp:RegularExpressionValidator ID="REV9" ControlToValidate="txttTravelDate"
                                            ...
                                            <div style="padding: 5px; margin-top: 0px;">
                                                <div class="form-group row m-b-5">
                                                    <div class="col-md-2 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Basic Fare :</label>
                                                        <asp:TextBox ID="txtclntBasicFare" CssClass="form-control" Text="0" Width="100%" runat="server" ValidationGroup="B" AutoPostBack="true" OnTextChanged="txtclntBasicFare_TextChanged"></asp:TextBox>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtBasicFare" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                    </div>
                                                    <div class="col-md-3 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            SC Type
                                            ...
                                            <div style="padding: 5px; margin-top: 0px;">
                                                ...
                                                <div class="form-group row m-b-5">
                                                    ...
                                                    <div class="col-md-3 col-sm-3">
                                                        <label class="col-form-label" for="fullname">
                                                            Comm Rcvd. :</label>
                                                        <asp:TextBox ID="txtSupComm" CssClass="form-control" runat="server" Width="100%" AutoPostBack="true" Text="0" OnTextChanged="txtSupComm_TextChanged"></asp:TextBox>
...
<br />
                                ...
                                <asp:Panel class="tbl table-responsive" ID="tblGridDet" runat="server" Style="margin-top: 20px;">
                                    ...
                                    <asp:GridView ID="GridView2" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                        DataKeyNames="nBusBookingDetID" Width="100%" AllowPaging="false" AllowSorting="True" EmptyDataText="No Records to display"
                                        OnPageIndexChanging="GridView2_PageIndexChanging">
                                        <Columns>
                                            <asp:TemplateField HeaderText="nBusBookingDetID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDetID" runat="server" Text='<%# Eval("nBusBookingDetID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                           <asp:TemplateField HeaderText="nBusBookingID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblbookingID" runat="server" Text='<%# Eval("nBusBookingID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="sTicketNo" HeaderText="Ticket No" />
                                            <asp:BoundField DataField="sBusNo" HeaderText="Bus No" />
                                            <asp:BoundField DataField="sCoachType" HeaderText="Coach Type" />
                                            <asp:BoundField DataField="sOrigin" HeaderText="From" />
                                            <asp:BoundField DataField="sDestination" HeaderText="To" />
                                            <asp:TemplateField HeaderText="Travel Date">
                                                <ItemTemplate>
                                                    <%#validation.TextToDate(Eval("dtTravelDate").ToString())%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="sPaxName" HeaderText="Passenger Name" />

                                            <asp:BoundField DataField="sAge" HeaderText="Age" />
                    ...
                    <i class="far fa-lg fa-fw m-r-10 fa-trash-alt fa-grid-del"></i> <span class="text-inverse">Delete</span>
                            ...
                            <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-hover m-b-0 text-inverse" runat="server"
                                    ...
                                    DataKeyNames="nBusBookingID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25"
                                    OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="nBusBookingID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nBusBookingID") %>'></asp:Label>
                                                ...
                                                <asp:Label ID="lblInvoiceNo" runat="server" Text='<%# Eval("sBusBookingNo") %>'></asp:Label>
                                        ...
                                        <asp:BoundField DataField="sBusBookingNo" HeaderText="Invoice No." />
                            ...
                            <asp:Panel ID="PnlPayment" runat="server">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Bus Booking Payment</h4>
                                    </div>
                                    <div class="row m-5">
                                    ...
                                    <div class="row m-b-30">
                                        <div class="col-md-12 col-sm-3 text-center m-b-30">
                                            <asp:GridView ID="GridPay" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="nPaymentReceiveID" Visible="false">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblBusID" runat="server" Text='<%# Eval("nInvoiceID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
