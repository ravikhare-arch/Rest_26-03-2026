<%@ Page Title="" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="ExcursionInvoice.aspx.cs" Inherits="Excursion_Invoice" %>
        ...
        <div class="invoice-content">
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridView1" CssClass="table table-invoice" runat="server"
                    AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nExcursionBookingDetID"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="nExcursionBookingDetID" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nExcursionBookingDetID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField DataField="nAdultPax" HeaderText="No.of Adult" />
                        <asp:BoundField DataField="nAdultPaxRate" HeaderText="Rate" />
                        <asp:BoundField DataField="nChildPax" HeaderText="No.of Child" />
                        <asp:BoundField DataField="nChildPaxRate" HeaderText="Rate" />
                        <asp:BoundField DataField="nTotal" HeaderText="Amount" />
                    </Columns>
                </asp:GridView>
