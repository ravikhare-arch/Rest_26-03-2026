<%@ Page Title="Train Ticket Invoice" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rpttrain_invoice.aspx.cs" Inherits="Travel_rptTrainInvoice" %>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb hidden-print pull-right" id="tplink">
                    <li class="breadcrumb-item"><a href="ttrain_booking.aspx">Home</a></li>
