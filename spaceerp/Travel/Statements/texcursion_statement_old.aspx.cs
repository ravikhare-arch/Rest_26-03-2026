...
public partial class Travel_texcursion_statement : System.Web.UI.Page
{
    ...
    public void displayGrid()
    {
        try
        {
            if (Request.QueryString != null)
            {
                ...
                {
                    objClassDet.sGuestName = "0";
                    objClassDet.sPickupPlace = Request.QueryString["AccTitle"].ToString();
                }
   ...
   VerifyRenderingInServerForm(Control control)
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        string FileName = "ESTM" + "_" + sDate + "_" + sTime;
    ...
    public void Send()
    {
        ...
        sFileName = "ESTM" + "_" + sDate + "_" + Stime3 + ".xls";
    ...
    protected void SendPdf()
    {
        ...
        string sDate = validation.fillTextDate();
        string sTime = validation.fillTime();
        string FileName = "ETM" + "_" + sDate + "_" + sTime;
