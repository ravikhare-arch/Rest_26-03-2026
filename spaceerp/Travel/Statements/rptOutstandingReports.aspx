<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptOutstandingReports.aspx.cs" Inherits="Travel_MofaStmt" %>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>SELLING RATE</strong></td>
                                <td class="text-center"><strong>RECEIVED</strong></td>
