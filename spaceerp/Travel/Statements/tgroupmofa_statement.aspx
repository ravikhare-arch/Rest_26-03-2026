<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tgroupmofa_statement.aspx.cs" Inherits="Travel_MofaStmt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Umrah Mofa Statement</title>
    <meta charset="utf-8" />
                        ...
                        <table>
                            <tr>
                                <td colspan="8">
                                    ...
                                    <h3 style="margin-left: 322px;">GROUP MOFA STATEMENT
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                <td class="text-left"><strong>INV DATE</strong></td>
                                <td class="text-center"><strong>INV NO</strong></td>
                                <td class="text-center"><strong>GROUP NAME</strong></td>
                                <td class="text-center"><strong>QTY.</strong></td>
                                <td class="text-center"><strong>MFA RATE</strong></td>
                                <td class="text-center"><strong>TOTAL SC</strong></td>
                                <td class="text-center"><strong>RPT. QTY</strong></td>
                                <td class="text-center"><strong>RPT. FEE</strong></td>
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptInvoice" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%# Eval("nClntSCAmountTotal") %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("nRepeaterQty") %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("nClntRepeaterRate") %>
                                        </td>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                <td class="thick-line" colspan="3">GRAND TOTAL(INR)</td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotQty" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotMofaCost" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotSC" runat="server"></asp:Label></td>

                                <td class="thick-line text-center">
                                    <asp:Label ID="lblRepeaterQty" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblRepeaterRate" runat="server"></asp:Label></td>
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotRec" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotPay" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
            ...
            <div class="row" id="tblSup" runat="server">
                <div class="col-md-12">
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            <asp:Repeater ID="rptSup" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td class="text-left">
                                            <%# validation.TextToDate( Eval("dtBookingDate").ToString()) %>
                                        ...
                                        <td class="text-center">
                                            <%# Eval("nSupSCAmountTotal") %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("nRepeaterQty") %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("nSupRepeaterRate") %>
                                        </td>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                <td class="thick-line" colspan="3">GRAND TOTAL(INR)</td>
                                 <td class="thick-line text-center">
                                    <asp:Label ID="lblSupQty" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupMofaCost" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupSc" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupRptQty" runat="server"></asp:Label></td>

                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupRptRate" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupTot" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupPaid" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupBal" runat="server"></asp:Label></td>
