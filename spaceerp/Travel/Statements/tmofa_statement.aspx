<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tmofa_statement.aspx.cs" Inherits="Travel_MofaStmt" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container" id="invoice" runat="server">
                        ...
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                               ...
                               <%-- <td class="text-center"><strong>DOI</strong></td>--%>
                                ...
                                <td class="text-center"><strong>COURIER</strong></td>
                                <td class="text-center"><strong>REPEATER</strong></td>
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                 ...
                                 <td class="thick-line text-center">
                                    <asp:Label ID="lblOtrChrg" runat="server"></asp:Label>

                                </td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotCourier" runat="server"></asp:Label>

                                </td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotRepeater" runat="server"></asp:Label>
            ...
            <div class="row" id="tblSupplier" runat="server">
                <div class="col-md-12">
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                <td class="text-center"><strong>INV DATE</strong></td>
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupRepeater" runat="server"></asp:Label>

                                </td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupTot" runat="server"></asp:Label>
