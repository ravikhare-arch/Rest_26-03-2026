<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tgroupmofa_sup_statement.aspx.cs" Inherits="Travel_MofaStmt" %>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>GRAND TOT.</strong></td>
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                               ...
                               <%-- <td class="thick-line text-center">
                                    <asp:Label ID="lblTotRepeater" runat="server"></asp:Label></td>--%>
                                <td class="thick-line text-center">
