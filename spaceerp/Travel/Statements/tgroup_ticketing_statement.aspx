<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tgroup_ticketing_statement.aspx.cs" Inherits="Travel_TicketInvoice" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Group Air Ticketing Statement</title>
    <meta charset="utf-8" />
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptInvoice" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%# validation.TextToDate( Eval("dtTDate").ToString()) %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("sGroupName") %>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <%# Eval("nCLTDiscountTot") %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("niatacomTot") %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("nCLTTDSAmountTot") %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("nClientRefund") %>
                                        </td>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                <td class="thick-line" colspan="9">GRAND TOTAL(INR)</td>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>DT CNG PEN</strong></td>
                                <td class="text-center"><strong>VOID CHRG</strong></td>
                                <t<td class="text-center"><strong>DEBIT</strong></td>
                                <td class="text-center"><strong>CREDIT</strong></td>
                                <td class="text-center"><strong>BALANCE</strong></td>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <asp:Repeater ID="rptInvSup" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%# Eval("nSupDiscountTot") %>
                                        </td>
                                        <td class="text-center"> <%# Eval("niatacomTot") %></td>
                                        <td class="text-center">
                                            <%# Eval("nSupTDSAmountTot") %>
                                        </td>
                                        <td class="text-center">
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupTotTax" runat="server"></asp:Label></td>
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupTotIata" runat="server"></asp:Label>
                                </td>
                                <td class="thick-line text-center">
