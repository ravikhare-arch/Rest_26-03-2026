<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAgentOutstandingReports.aspx.cs" Inherits="Travel_MofaStmt" %>
                        ...
                        <table>
                            <tr>
                                <td colspan="8">
                                    ...
                                    <h3 style="margin-left: 322px;">Outstanding
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                              ...
                              <%--  <td class="text-center"><strong>DESCRIPTIN</strong></td>--%>
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotSell" runat="server"></asp:Label></td>
