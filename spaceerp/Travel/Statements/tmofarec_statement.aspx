<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tmofarec_statement.aspx.cs" Inherits="Travel_MofaStmt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Recruitement Statement</title>
    <meta charset="utf-8" />
        ...
        <div class="container" id="invoice" runat="server">
            ...
            <div class="row" id="tblAgent" runat="server">
                <div class="col-md-12">
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>VISA CATEGRY</strong></td>
                                <td class="text-center"><strong>PAX NAME</strong></td>
                                <td class="text-center"><strong>PASSPORT NO </strong></td>
                                <td class="text-center"><strong>SPONCER ID </strong></td>
                                <td class="text-center"><strong>VISA NO </strong></td>
                                <td class="text-center"><strong>P DOI</strong></td>
                                <td class="text-center"><strong>P DOE</strong></td>
                                <td class="text-center"><strong>VALIDATY</strong></td>
                    ...
                    <%--This is Not Reuired for Report Commented due to Noor Sir Not required--%>
