<%@ Page Title="Insurance Statement" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="tinsurance_statement_old.aspx.cs" Inherits="Travel_tinsurance_statement" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlMain" runat="server">
        <div style="border: 1px solid #e0e0d9; padding: 10px; margin-top: 20px; margin-bottom: 20px;" id="tpContent" runat="server">
            ...
            <div class="form-group row m-b-5">
                <div class="col-md-12 col-sm-12">
                    ...
                    <a href="../tinsurance_booking.aspx" class="btn btn-warning" id="btnprint">Home</a>
                </div>
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
            AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nInsuranceBookingID" HeaderStyle-BackColor="#1c3967" HeaderStyle-Font-Bold="true"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="sPlanNo" HeaderText="Plan No" />
                  <asp:BoundField DataField="sPolicyNo" HeaderText="Policy No" />
                <asp:BoundField DataField="sAssignee" HeaderText="Assignee" />
                <asp:BoundField DataField="sPassport" HeaderText="sPassport No" />
                <asp:BoundField DataField="sCArea" HeaderText="CArea" />
                <asp:BoundField DataField="sProposal" HeaderText="sProposal " />
                <asp:TemplateField HeaderText="Trave From DT">
                    <ItemTemplate>
                        <%#validation.TextToDate(Eval("dtTravelFromDate").ToString())%>
                    </ItemTemplate>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="Trave To DT">
                    <ItemTemplate>
                        <%#validation.TextToDate(Eval("dtTravelFromDate").ToString())%>
                    </ItemTemplate>
                </asp:TemplateField>
