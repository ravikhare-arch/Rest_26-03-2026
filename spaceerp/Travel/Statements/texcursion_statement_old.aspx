<%@ Page Title="Excursion Statement" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="texcursion_statement_old.aspx.cs" Inherits="Travel_texcursion_statement" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlMain" runat="server">
            ...
            <div class="form-group row m-b-5">
                <div class="col-md-12 col-sm-12">
                    <asp:Button ID="btnExcel" runat="server" CssClass="btn btn-primary" Text="Export Excel" ValidationGroup="A"
                     ...
                     <a href="../texcursion_booking.aspx" class="btn btn-warning" id="btnprint">Home</a>
                </div>
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
            AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nExcursionBookingID" HeaderStyle-BackColor="#1c3967" HeaderStyle-Font-Bold="true"
            HeaderStyle-Height="30px" HeaderStyle-ForeColor="White"
            Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25">
            <Columns>
                <asp:TemplateField HeaderText="nExcursionBookingID" Visible="false">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="sGuestName" HeaderText="Custommer Name" />
                
                <asp:BoundField DataField="sExcursionReferenceNo" HeaderText="Ref. No." />
                <asp:BoundField DataField="sExcursionType" HeaderText="Excursion Type" />
                ...
                <asp:BoundField DataField="sJobNo" HeaderText="Job No" />
                 <asp:TemplateField HeaderText="Pickup Date">
                    <ItemTemplate>
                        <%#validation.TextToDate(Eval("dtPickupDate").ToString())%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sPickupTime" HeaderText="Pickup Time" />
                <asp:BoundField DataField="sDropTime" HeaderText="Drop Time" />
                <asp:BoundField DataField="nAdultPax" HeaderText="Adult Pax" />

                 <asp:BoundField DataField="nAdultPaxRate" HeaderText="Adt Pax Rate" />
                <asp:BoundField DataField="nChildPax" HeaderText="Child Pax" />
                <asp:BoundField DataField="nChildPaxRate" HeaderText="Chd Pax Rate" />

                 <asp:BoundField DataField="nInfPax" HeaderText="Inf Pax" />
                <asp:BoundField DataField="nInfPaxRate" HeaderText="Inf Pax Rate" />
                ...
                <asp:BoundField DataField="nTotal" HeaderText="Sup Cost" />
