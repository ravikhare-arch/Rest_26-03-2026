...
public partial class Travel_tinsurance_statement : System.Web.UI.Page
{
    ...
    public void displayGrid()
    {
        try
        {
            if (Request.QueryString != null)
            {
                ...
                {
                    objClassDet.sPaxName = Request.QueryString["AccTitle"].ToString();
                    objClassDet.sAge = "0";
                }
                else
                {
               ...
               // objClassDet.sDeparture = "0";
                objClassDet.dtTravelToDate = validation.dateToText(Request.QueryString["DtStFrom"].ToString());
   ...
   VerifyRenderingInServerForm(Control control)
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        string FileName = "INSTM" + "_" + sDate + "_" + sTime;
    ...
    public void Send()
    {
        ...
        sFileName = "INSTM" + "_" + sDate + "_" + Stime3 + ".xls";
