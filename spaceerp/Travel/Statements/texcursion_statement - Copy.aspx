<%@ Page Language="C#" AutoEventWireup="true" CodeFile="texcursion_statement - Copy.aspx.cs" Inherits="Travel_HotelStmt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Excurssion Statement</title>
    <meta charset="utf-8" />
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                <td class="text-left"><strong>REF NO.</strong></td>
                                <td class="text-center"><strong>PAX NAME</strong></td>
                                <td class="text-center"><strong>EXCURSION TYPE</strong></td>
                                <td class="text-center"><strong>ADULT PAX</strong></td>
                                <td class="text-center"><strong>ADULT PAX RATE</strong></td>
                                <td class="text-center"><strong>CHILD PAX</strong></td>
                                <td class="text-center"><strong>CHILD PAX RATE</strong></td>
                                ...
                                <td class="text-center"><strong>NET RECEIVABLE</strong></td>
                                <td class="text-center"><strong>NET RECEIVED</strong></td>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>DISCOUNT</strong></td>
                                <td class="text-center"><strong>TDS</strong></td>
                                <td class="text-center"><strong>NET PAYABLE</strong></td>
                                <td class="text-center"><strong>NET PAID</strong></td>
                                <td class="text-center"><strong>NET BALANCE</strong></td>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- foreach ($order->lineItems as $line) or some such thing here -->
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupDisc" runat="server"></asp:Label></td>

                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupTotAmt" runat="server"></asp:Label>
