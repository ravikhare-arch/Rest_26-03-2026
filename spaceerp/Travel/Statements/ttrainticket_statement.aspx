<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ttrainticket_statement.aspx.cs" Inherits="Travel_InsuranceStmt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Train Ticket Statement</title>
    <meta charset="utf-8" />
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center">PNR NO.</td>
                                <td class="text-center">TRAIN NO.</td>
                                <td class="text-center">CLASS</td>
                                <td class="text-center">TRAVEL DATE</td>
                                <td class="text-center" colspan="2">BOARDING</td>
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptAgent" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td class="text-center"><%# Eval("sPaxName1") %></td>
                                        <td class="text-center"><%# Eval("sPnrNo") %></td>
                                        <td class="text-center"><%# Eval("sTrainNo") %></td>
                                        <td class="text-center"><%# Eval("sClass") %></td>
                                        <td class="text-center"><%# validation.TextToDate(Eval("dtTravelDate").ToString()) %></td>
                                        <td class="text-center" colspan="2"><%# Eval("sBoarding") %></td>
                                        <td class="text-center" colspan="2"><%# Eval("sFromStn") %></td>
                                        <td class="text-center" colspan="2"><%# Eval("sToStn") %></td>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                <td class="thick-line" colspan="11">GRAND TOTAL(INR)</td>
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotBal" runat="server"></asp:Label></td>
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptSup" runat="server">
                             ...
                             <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupTDS" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
