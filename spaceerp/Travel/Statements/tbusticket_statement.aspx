<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tbusticket_statement.aspx.cs" Inherits="Travel_HotelStmt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Bus Ticket Statement</title>
    <meta charset="utf-8" />
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptInvoice" runat="server">
                                <ItemTemplate>
                                    <tr>
                                         <td class="text-center" ><%# Eval("sPaxName") %></td>
                                        <td class="text-center"><%# Eval("sTicketNo") %></td>
                                        <td class="text-center" ><%# validation.TextToDate(Eval("dtTravelDate").ToString()) %></td>
                                        <td class="text-center" ><%# Eval("sOrigin") %></td>
                                        <td class="text-center"><%# Eval("sDestination") %></td>
