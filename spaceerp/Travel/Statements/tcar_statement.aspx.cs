...
public partial class Travel_HotelStmt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["Agentid"] != null)
        {
            ...
            objClassdet.sPaxtName = Request.QueryString["Agentid"].ToString();
            objClassdet.sAdult = "0";
            objClassdet.sChild = Request.QueryString["Loc"].ToString();
            objClassdet.sCRNo = "0";
            objClassdet.dtTripDate = validation.dateToText(Request.QueryString["DtStFrom"].ToString());
            objClassdet.sPayType = validation.dateToText(Request.QueryString["DtStTo"].ToString());
            GetAgentFormData();
        }
        else if (Request.QueryString["SupID"] != null)
        {
            ...
            tblSup.Visible = true;
            objClassdet.sReferenceNo = "0";
            objClassdet.sPaxtName = "0";
            objClassdet.sAdult = Request.QueryString["SupID"].ToString();
            objClassdet.sChild = Request.QueryString["Loc"].ToString();
            objClassdet.sCRNo = "0";
            objClassdet.dtTripDate = validation.dateToText(Request.QueryString["DtStFrom"].ToString());
            objClassdet.sPayType = validation.dateToText(Request.QueryString["DtStTo"].ToString());
