<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tcar_statement.aspx.cs" Inherits="Travel_HotelStmt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Car Booking Statement</title>
    <meta charset="utf-8" />
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center">ADULT PAX NOS</td>
                                <td class="text-center">CHILD PAX NOS</td>
                                <td class="text-center">INFANT PAX NOS</td>
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptInvoice" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td class="text-center"><%# Eval("dtCarBooking") %></td>
                                        <td class="text-center"><%# Eval("sCarBookingNo") %></td>
                                      <td class="text-center"><%# Eval("sPaxtName") %></td>
                                        <td class="text-center"><%# Eval("sReferenceNo") %></td>
                                        <td class="text-center"><%# validation.TextToDate(Eval("dtTripDate").ToString()) %></td>

                                        <td class="text-center"><%# Eval("sAdult") %></td>
                                        <td class="text-center"><%# Eval("sChild") %></td>
                                        <td class="text-center"><%# Eval("sInfant") %></td>
