<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tinsurance_statement.aspx.cs" Inherits="Travel_InsuranceStmt" %>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-left"><strong>INV NO</strong></td>
                                <td class="text-center"><strong>POLICY NO.</strong></td>
                                <td class="text-center"><strong>COUNTRY</strong></td>
                                <td class="text-center"><strong>INV TYPE</strong></td>
                                <td class="text-left"><strong>PAX NAME</strong></td>
                                <td class="text-center"><strong>PASSPORT NO.</strong></td>
                                <td class="text-center"><strong>INS ISSUE DT</strong></td>
                                <td class="text-center"><strong>EXPIRY DT</strong></td>
                                <td class="text-center"><strong>NO OF DYS</strong></td>
                                <td class="text-center"><strong>INV FEE</strong></td>
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptAgent" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%# validation.TextToDate( Eval("dtInsIssueDate").ToString()) %>
                                        </td>
                                        <td class="text-center">
                                            <%# validation.TextToDate( Eval("dtInsExpiryDate").ToString()) %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("sNoofDays") %>
                                        </td>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotRecAmt" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotPayAmt" runat="server"></asp:Label></td>
                                <td class="thick-line text-center"><asp:Label ID="lblBalance" runat="server"></asp:Label></td>
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                <td class="thick-line" colspan="10">GRAND TOTAL(INR)</td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupBasic" runat="server"></asp:Label></td>
                                <td class="thick-line">
                                ...
                                <%-- <td class="thick-line text-center">
                                    <asp:Label ID="lblSubTot" runat="server"></asp:Label></td>--%>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupDisc" runat="server"></asp:Label>
                                </td>
                                <td class="thick-line text-center">
                                ...
                                <td class="thick-line text-center"><asp:Label ID="lblSupBal" runat="server"></asp:Label></td>
