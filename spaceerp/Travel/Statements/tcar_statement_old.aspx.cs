...
public partial class Travel_tCar_statement : System.Web.UI.Page
{
    ...
    public void displayGrid()
    {
        try
        {
            if (Request.QueryString != null)
            {
                ...
                {
                    objClassDet.sPaxtName = "0";
                    objClassDet.sAdult = Request.QueryString["AccTitle"].ToString();
                }
                else if (Request.QueryString["AccType"].ToString() == "3")
                {
                    objClassDet.sPaxtName = Request.QueryString["AccTitle"].ToString();
                    objClassDet.sAdult = "0";
                }
                else
                {
   ...
   VerifyRenderingInServerForm(Control control)
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        string FileName = "CSTM" + "_" + sDate + "_" + sTime;
    ...
    public void Send()
    {
        ...
        sFileName = "CSTM" + "_" + sDate + "_" + Stime3 + ".xls";
