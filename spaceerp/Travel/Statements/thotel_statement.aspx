<%@ Page Language="C#" AutoEventWireup="true" CodeFile="thotel_statement.aspx.cs" Inherits="Travel_HotelStmt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Hotel Statement</title>
    <meta charset="utf-8" />
...
<body>
    <form id="form1" runat="server">
        <div class="container" id="invoice" runat="server">
                            ...
                            <tr>
                                <td colspan="8">
                                    ...
                                    <h3 style="margin-left: 322px;">
                                        ...
                                        BILLING STATEMENT FOR HOTEL </h3>
                                </td>
                                <td colspan="8">
            ...
            <div class="row" id="tblAgent" runat="server">
                <div class="col-md-12">
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>BOOKING REF</strong></td>
                                <td class="text-center"><strong>HOTEL NAME</strong></td>
                                <td class="text-center"><strong>PAX NAME</strong></td>
                                <%--<td class="text-center"><strong>ROOM TYPE</strong></td>--%>
                                <td class="text-center"><strong>C/IN</strong></td>
                                <td class="text-center"><strong>C/OUT</strong></td>
                                <td class="text-center"><strong>NO OF NIGT</strong></td>
                                <td class="text-center"><strong>NO OF PX</strong></td>
                                <td class="text-center"><strong>NO OF ROOMS</strong></td>
                                <td class="text-center"><strong>RATE</strong></td>
                                <%--<td class="text-center"><strong>BASIC COST</strong></td>--%>
                                <td class="text-center"><strong>M FEE</strong></td>
                                 <td class="text-center"><strong>OTR CHRGS</strong></td>
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptInvoice" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <%# Eval("sHotelBookingNo") %>
                                            <%--<asp:Label ID="lblCrrier" runat="server"></asp:Label>--%></td>

                                        <td class="text-center">
                                            <%# Eval("sReferenceNo") %>
                                            <%--<asp:Label ID="lblPaxName" runat="server"></asp:Label>--%></td>
                                        <td class="text-center">
                                            <%# Eval("sHotelName") %>
                                        ...
                                        <%-- <td class="text-center">
                                            <asp:Label ID="lblBase" runat="server" Text='<%# Eval("nBasicAmt") %>' Visible="false"></asp:Label>
                                            <%# Eval("nBasicAmt") %>
                                        </td>--%>
                                        <td class="text-center">
                                            <asp:Label ID="lblSC" runat="server" Text='<%# Eval("nProfitAmount") %>' Visible="false"></asp:Label>
                                            <%# Eval("nProfitAmount") %>
                                        </td>
                                         <td class="text-center">
                                            <%# Eval("nClntOtrChrgs") %>
                                            <asp:Label ID="lblTotTaxes" runat="server" Text='<%# Eval("nClntOtrChrgs") %>' Visible="false"></asp:Label></td>
                                        <td class="text-center">
                                            <%# Eval("nClntSGst") %>
                                            <asp:Label ID="lblClntSGst" runat="server" Text='<%# Eval("nClntSGst") %>' Visible="false"></asp:Label></td>
                                        <td class="text-center">
                                            <%# Eval("nClntCGst") %>
                                            <asp:Label ID="lblClntCGst" runat="server" Text='<%# Eval("nClntCGst") %>' Visible="false"></asp:Label></td>
                                        <td class="text-center">
                                            <%# Eval("nClntIGst") %>

                                            <td class="text-center">
                                                <%# Eval("nSellingCost") %>
                                                <asp:Label ID="lblSellingCost" runat="server" Text='<%# Eval("nSellingCost") %>' Visible="false"></asp:Label>
                                            </td>
                                            <td class="text-center">
                                                <%# Eval("nPaidAmount") %>
                                            </td>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                <td class="thick-line" colspan="10">GRAND TOTAL(INR)</td>
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblOtrChrgs" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
            ...
            <div class="row" id="tblSup" runat="server">
                <div class="col-md-12">
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                <td class="thick-line" colspan="10">GRAND TOTAL(INR)</td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupRate" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupSC" runat="server"></asp:Label></td>

                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupCGST" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupSGST" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblSupIGST" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
