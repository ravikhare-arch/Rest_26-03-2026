<%@ Page Title="Hotel Statement" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="thotel_statement_old.aspx.cs" Inherits="Travel_tvisa_statement" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlMain" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
            AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nHotelBookingID" HeaderStyle-BackColor="#1c3967" HeaderStyle-Font-Bold="true"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="sPaxName1" HeaderText="Custommer Name" />
                <asp:BoundField DataField="sGender1" HeaderText="Gender" />
                <asp:BoundField DataField="sAge1" HeaderText="Age" />
                <asp:BoundField DataField="sHotelName" HeaderText="Hotel Name" />
                <asp:BoundField DataField="sHotelRoom" HeaderText="Hotel Room" />
                ...
                <asp:BoundField DataField="sTotDay" HeaderText="Total Nights" />
                <asp:BoundField DataField="nNoOfRooms" HeaderText="No.Of Rooms" />
               
                <asp:BoundField DataField="nRate" HeaderText="Per(night)" />
                <asp:BoundField DataField="nExtraBed" HeaderText="Ext. Bed" />
                <asp:BoundField DataField="sMeal" HeaderText="Meal" />
                <asp:BoundField DataField="nBasicAmt" HeaderText="Basic Amt" />
                
                <asp:BoundField DataField="nSupSCAmount" HeaderText="Sup SC" />
                <asp:BoundField DataField="nSupTdsAmount" HeaderText="Sup TDS" />
                 <asp:BoundField DataField="nSupOtrTax" HeaderText="Sup Otr. Tax" />
                ...
                <asp:BoundField DataField="nClntOtrChrgs" HeaderText="Otr Chrg" />
