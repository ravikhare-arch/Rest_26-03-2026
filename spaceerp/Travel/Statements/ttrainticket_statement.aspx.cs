...
public partial class Travel_InsuranceStmt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (Request.QueryString["SupID"] != null)
        {
            ...
            objClassdet.sClass = Request.QueryString["SupID"].ToString();
            objClassdet.sBoarding = Request.QueryString["Loc"].ToString();
            objClassdet.sTicketNo = "0";
            objClassdet.dtTravelDate = validation.dateToText(Request.QueryString["DtStFrom"].ToString());
            objClassdet.sPaxNos = validation.dateToText(Request.QueryString["DtStTo"].ToString());
    ...
    public void GetAgentFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
         ...
         //   (rptInvoice.Controls[rptInvoice.Controls.Count - 1].Controls[0].FindControl("lblSC") as Label).Text = SCTot.ToString();
            ...
            //   (rptInvoice.Controls[rptInvoice.Controls.Count - 1].Controls[0].FindControl("lblSC") as Label).Text = SCTot.ToString();
            lblTotOtrCharge.Text = OtrCharge.ToString();
         ...
         //   (rptInvoice.Controls[rptInvoice.Controls.Count - 1].Controls[0].FindControl("lblClntSGst") as Label).Text = TotSGST.ToString();
          ...
          //  (rptInvoice.Controls[rptInvoice.Controls.Count - 1].Controls[0].FindControl("lblClntTdsAmount") as Label).Text = totalBase.ToString();
            lblTotAmt.Text = TotRecAmt.ToString();
            ...
            lblTotPaid.Text = TotPay.ToString();
    ...
    public void GetSupFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblSupTDS.Text = TotTDS.ToString();
