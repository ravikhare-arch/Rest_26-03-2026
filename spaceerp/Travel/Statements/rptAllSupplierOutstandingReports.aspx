<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptAllSupplierOutstandingReports.aspx.cs" Inherits="Travel_MofaStmt" %>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                        ...
                        <table>
                            <tr>
                                <td colspan="8">
                                    ...
                                    <h3 style="margin-left: 322px;">Supplier Outstanding Report
                    ...
                    <table style="border: 2px solid black; margin-left: 0; margin-right: 0; width: 100%">
                        <tr>
                            <td style="width: 50%; border-right: 2px solid black;" colspan="12" class="col-xs-6">
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                <td class="text-left"><strong>AGENT NAME</strong></td>
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                <td class="thick-line">GRAND TOTAL(INR)</td>
