<%@ Page Language="C#" Title="Bus Ticket Refund" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptbusrefund_invoice.aspx.cs" Inherits="Travel_rptBusInvoice" %>
    ...
    <div id="content" class="content" style="color: black">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb hidden-print pull-right" id="tplink">
                    <li class="breadcrumb-item"><a href="tbus_booking.aspx">Home</a></li>
        ...
        <div class="invoice" id="invoice" runat="server">
            ...
            <div class="invoice-content">
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                            <td class="text-center" colspan="2">TICKET NO.</td>
                            <td class="text-center" colspan="2">TICKET DATE</td>
                            <td class="text-center" colspan="2">PAX NAME</td>
                            <td class="text-center" colspan="2">FROM</td>
                            <td class="text-center" colspan="2">TO</td>
                            <td class="text-center">COACH TYPE</td>
                            <td class="text-center">FARE</td>
                        </tr>
                        <asp:Repeater ID="rptDetails" runat="server">
                            <ItemTemplate>
                                <tr style="height: 40px; text-align: center; padding: 10px; border: 1px solid black">

                                    <td class="text-center" colspan="2"><%# Eval("sTicketNo") %></td>
                                    <td class="text-center" colspan="2"><%# validation.TextToDate(Eval("dtTravelDate").ToString()) %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sPaxName") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sOrigin") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sDestination") %></td>
                                    <td class="text-center"><%# Eval("sCoachType") %></td>
                                    <td class="text-center"><%# Eval("nSupplierRefund") %></td>
                                </tr>

                            </ItemTemplate>
                        </asp:Repeater>
                        <tr style="border: 1px solid black; height: 40px;">
                            <td colspan="11" class="text-right font-weight-bold">Service Charge
                            </td>
                        ...
                        <tr style="border: 1px solid black; height: 40px;">
                            <td colspan="11" class="text-right font-weight-bold">SUB TOTAL
                            </td>
                            <td class="text-center font-weight-bold" >
                ...
                <!-- begin invoice-price -->
                <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black; text-align: center">
                ...
                <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                    <tr style="height: 80px">
                        ...
                        <td colspan="6" style="padding: 20px">
                            ...
                            <table border="1" style="width: 100%; float: right; color: black">
