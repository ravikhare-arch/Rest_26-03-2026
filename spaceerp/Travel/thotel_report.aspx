<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="thotel_report.aspx.cs" Inherits="Travel_thotel_report" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Hotel Booking Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                            ...
                            <div class="form-group row m-b-15">
                                <div class="col-md-3 col-sm-3">
                                    <label class="col-form-label" for="fullname">
                                        Hotel Booking No. :</label>
                                    <asp:DropDownList ID="ddlHotelBookingNo" runat="server" CssClass="js-example-placeholder-single form-control">
                                    </asp:DropDownList>
                            ...
                            <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="sHotelBookingNo" HeaderText="Hotel Booking No" />
                                        ...
                                        <asp:BoundField DataField="sGuestName" HeaderText="Gust Name" />
                                        ...
                                        <asp:BoundField DataField="sTotDay" HeaderText="Total Days" />
                                        <asp:BoundField DataField="nNoOfRooms" HeaderText="No. of Rooms" />
                                        <asp:BoundField DataField="nRate" HeaderText="Per Day Price" />
