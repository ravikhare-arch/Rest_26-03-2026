...
public partial class tticketing_list : System.Web.UI.Page
{
    static tticketing_Class objClass = new tticketing_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor, string AgentID)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.InvoiceNo = dt.Rows[i]["sTicketBookingNo"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            var outputDir = Server.MapPath("../Temp/Ticketing.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sTicketBookingNo"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Ticketing.xlsx");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Ticket</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns["sTicketBookingNo"].ColumnName = "Invoice No";
