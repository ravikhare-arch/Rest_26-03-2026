<%@ Page Title="Bus Booking" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tbus_booking_list.aspx.cs" Inherits="tbus_booking_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:UpdatePanel ID="up1" runat="server">
                <ContentTemplate>
                    <div class="col-md-12 ml-auto mr-auto">
                        <div class="clearfix form-group">
                            ...
                            <input type="button" id="btnsearch" class="btn btn-primary form-control" style="background-color: #004080" title="Search" value="Search" />
                            </div>
                        </div>
             ...
             <div class="col-sm-12 text-center center-block well-sm" id="divprint">
                ...
                <asp:Button ID="btnsendmail" CssClass="btn btn-primary" Style="background-color: #004080" runat="server" Text="Send Email" OnClick="btnsendmail_Click" />
                  <asp:Button ID="Button1" CssClass="btn btn-primary" Style="background-color: #004080" runat="server" Text="Reset" OnClientClick="resetcontrol();" />
                  <input type="button"  id="btnreset" class="btn btn-primary " style="background-color: #004080"  value="Reset"  />
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Bus Booking  </b></h4>
                    <h4>
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            $(document.body).ready(function () {
                ...
                $("#btnreset").on("click", function () {
                    debugger;
                    //$("#ctl00_ContentPlaceHolder1_ddlStReportFor option:selected").val('0');
                    //$("#select2-ctl00_ContentPlaceHolder1_ddlStReportFor-container").title('0');
                    //$("#ddlStReportFor")[0].selectedIndex = 0;
                    //$("#ddlStReportFor").select2('val', '0');
                    // $("#ddlStReportFor").empty();
                    //$('#ddlStReportFor').select2('val', '');
                    //$('#ddlStReportFor').attr('value', '');
                    // $("#ddlAgentID")[0].selectedIndex = 0;
                    $('#<%=ddlStReportFor.ClientID%>').value('0'); // Select the option with a value of '1'
                    //$('#ddlStReportFor').trigger('change'); // Notify any JS components that the value changed
                    //$('ddlStReportFor').val('').trigger('change');
                    $("#ctl00_ContentPlaceHolder1_txttLastPurchase").val('');
                    $("#ctl00_ContentPlaceHolder1_txttLastOrder").val('');
                    //$('#ddlStReportFor').val(null).trigger('change');
                    //alert("Hello");
                    //$('select').select2({
                ...
                $(document.body).on("click", ".editbtn", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "tbus_booking.aspx",
                        data: datastring,
                        cache: false,
                        success: function (html) {
                            window.location.href = "../Travel/tbus_booking.aspx?" + datastring + "";
                        }
                    });
                });
                ...
                $(document.body).on("click", "#deletebutton", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<%=ResolveUrl("tbus_booking_list.aspx/DeleteVoucher") %>',
        ...
        function resetcontrol() {
            alert("hello");
            //$("#form1").find('input:text', 'select').val('');
            ...
            $.ajax({
                url: '<%=ResolveUrl("tbus_booking_list.aspx/loaddata") %>',
                type: "post",
