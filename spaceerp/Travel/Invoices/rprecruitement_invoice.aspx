<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rprecruitement_invoice.aspx.cs" Inherits="Travel_rptRecInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Recruitement Invoice</title>
    <meta charset="utf-8" />
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><strong>ISSUE DATE</strong></th>
                                <th class="text-center"><strong>EXPIRY DATE</strong></th>
                                <th class="text-center"><strong>MOFA NO.</strong></th>
                                <th class="text-center"><strong>DURATION</strong></th>
                                <th class="text-center"><strong>VALIDITY</strong></th>
                                <th class="text-center"><strong>MOFA COST</strong></th>
