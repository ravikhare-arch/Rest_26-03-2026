...
public partial class TradeInventory_rptTicketInvoiceNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            objClassDet.sReference1 = Request.QueryString["id"].ToString();
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblCompGstNo.Text = dt.Rows[0]["sGSTNo"].ToString();
            //Agent Details
            ...
            //Booking Details
            lblBookingNo.Text = dt.Rows[0]["sVisaBookingNo"].ToString();
            ...
            lblSC2.Text = dt.Rows[0]["nClntSC2Amount"].ToString();
            lblCourier.Text = dt.Rows[0]["nCourierCharges"].ToString();
            lblTotOtrChrge.Text = dt.Rows[0]["nOtrChrg"].ToString();
    ...
    {
        DataTable dt = objClassDet.viewData(objClassDet, "PrintInvDet", Request.QueryString["Detid"].ToString());
        if (dt.Rows.Count > 0)
        {
            //Main Company details
            imgComp.ImageUrl = "../../Uploads/" + dt.Rows[0]["sCompanyImage"].ToString();
            ...
            lblTotFare.Text = dt.Rows[0]["nBuyingRate"].ToString();

            lblTotSC.Text = dt.Rows[0]["nProfitAmount"].ToString();
            lblSC2.Text = dt.Rows[0]["nClntSC2Amount"].ToString();
            lblCourier.Text = dt.Rows[0]["nCourierCharges"].ToString();
            lblTotOtrChrge.Text = dt.Rows[0]["nOtrChrge"].ToString();
            lblTotSGST.Text = dt.Rows[0]["nClntSGst"].ToString();
            lblTotCGST.Text = dt.Rows[0]["nClntCGst"].ToString();
            lblTotIGST.Text = dt.Rows[0]["nClntIGst"].ToString();
            lblTotDiscount.Text = dt.Rows[0]["nDiscount"].ToString();
            ...
            lblTotAmt.Text = dt.Rows[0]["nSellingRate"].ToString();
