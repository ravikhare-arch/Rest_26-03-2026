...
public partial class Travel_rptInsuranceInvoice : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] != null)
        {
            ...
            objClassDet.sChild = "0";
            objClassDet.sCRNo = "0";
            objClassDet.dtTripDate = "";
            GetFormData();
        }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //Booking Details
            lblBookingNo.Text = dt.Rows[0]["sCarBookingNo"].ToString();
            lblBookingDate.Text = validation.TextToDate(dt.Rows[0]["dtCarBooking"].ToString());
