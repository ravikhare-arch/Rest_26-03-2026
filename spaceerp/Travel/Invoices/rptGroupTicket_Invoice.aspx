<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptGroupTicket_Invoice.aspx.cs" Inherits="Travel_TicketInvoice" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Group Ticket Invoice</title>
    <meta charset="utf-8" />
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th class="text-left"><strong>Crrier</strong></th>
                                <th class="text-center"><strong>Tkt No</strong></th>
                                <th class="text-center"><strong>Pnt No</strong></th>
                                <th class="text-center"><strong>Pax Name</strong></th>
                                <th class="text-center"><strong>Sector</strong></th>
                                <%--<td class="text-center"><strong>Travel date</strong></th>--%>
                                <th class="text-center"><strong>Class</strong></th>
                                <th class="text-center"><strong>Base Fare</strong></th>
                               <%-- <td class="text-center"><strong>Quantity</strong></th>--%>
                                <th class="text-center"><strong>Taxes</strong></th>
                                <th class="text-center"><strong>Sub Tot</strong></th>
                                <th class="text-center"><strong>SC</strong></th>
                                <th class="text-center"><strong>Otr. Charges</strong></th>
