<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTicket_Invoice.aspx.cs" Inherits="Travel_TicketInvoice" %>
...
<body>
    <form id="form1" runat="server">
        <div class="pagebg" id="invoice" runat="server">
            <!-- begin invoice -->
            <div class="row nopad">
                <div class="col-md-6">
                    ...
                    <div class="invoice-company text-inverse f-w-600">
                        ...
                        <a href="../tticketing.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
            ...
            <table class="table table-invoice">
                        <thead>
                            <tr>
                                <th><strong>Crrier</strong></th>
                                <th><strong>Tkt No</strong></th>
                                <th><strong>Pax Name</strong></th>
                                <th><strong>Sector</strong></th>
                                <th><strong>Travel date</strong></th>
                                <%--<th><strong>Class</strong></th>--%> <%--commented by Noor--%>
                                <th><strong>Base Fare</strong></th>
                                <th><strong>Taxes</strong></th>
                                <th><strong>Sub Tot</strong></th>
                                <th><strong>SC</strong></th>
                                <%--<th><strong>OTR. CHRG</strong></th>--%> <%--commented by Noor--%>
                        ...
                        <tbody>
                                ...
                                <ItemTemplate>
                                    ...
                                    <br />
                                        ...
                                        <td class="text-center">
                                            ...
                                            <%--<td class="text-center">
                                                <%# Eval("nClntOtherChrgs") %>  commented by Noor
                                            </td>--%>
                                            <td class="text-center">
                                                <%# Eval("nClntSGst") %>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center" style="display: none"> <%--display none By Noor--%>
                                    <asp:Label ID="lblOtrChrg" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
