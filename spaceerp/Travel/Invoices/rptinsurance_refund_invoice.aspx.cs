...
public partial class Travel_Insurance_Invoice : System.Web.UI.Page
{
    tinsurance_refund_Class objClass = new tinsurance_refund_Class();
    ...
    {
        DataTable dt = objClass.viewData(objClass, "PrintInv", Request.QueryString["Detid"].ToString());
        if (dt.Rows.Count > 0)
        {
