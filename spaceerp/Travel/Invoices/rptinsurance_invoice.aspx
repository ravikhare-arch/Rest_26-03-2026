<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptinsurance_invoice.aspx.cs" Inherits="Travel_rptInsuranceInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Insuarance Invoice </title>
    <meta charset="utf-8" />
                 ...
                 <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <th class="text-left"><strong>PAX NAME</strong></th>
                                <th class="text-center"><strong>POLICY NO.</strong></th>
                                <th class="text-center"><strong>PLAN NO.</strong></th>
                                <th class="text-center"><strong>PASSPORT NO.</strong></th>
                                <th class="text-center"><strong>INS ISSUE DT</strong></th>
                                <th class="text-center"><strong>NO OF DYS</strong></th>
                                <th class="text-center"><strong>INS FEE</strong></th>
