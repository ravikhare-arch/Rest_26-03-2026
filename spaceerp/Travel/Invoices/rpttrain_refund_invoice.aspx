<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpttrain_refund_invoice.aspx.cs" Inherits="Travel_rptMofaInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Train Ticket Refund Invoice</title>
    <meta charset="utf-8" />
                        ...
                        <table>
                            <tr>
                                <td colspan="8">
                                    ...
                                    <h3 style="margin-left: 322px;">REFUND INVOICE</h3>
                                </td>
                                <td colspan="8">

                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../ttrain_booking.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
...
<td class="text-center">PAX NAME</td>
                                ...
                                <td class="text-right"><strong>Net Refund</strong></td>
