<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptbus_refund_invoice.aspx.cs" Inherits="Travel_rptMofaInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Bus Refund Invoice</title>
    <meta charset="utf-8" />
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="8">
                                    ...
                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../tbus_booking.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>Net Refund</strong></td>
