<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptmofa_invoice.aspx.cs" Inherits="TradeInventory_rptTicketInvoiceNew" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Mofa Invoice</title>
    <meta charset="utf-8" />
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="8">
                                    ...
                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../tmofa_booking.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                            ...
                            <tr style="border-bottom: 2px solid black;">
                              ...
                              <%--  <td class="text-center"><strong>ISSUE DATE</strong></td>--%>
                               ...
                               <%-- <td class="text-center"><strong>VALIDITY</strong></td>--%>
                                ...
                                <td class="text-center"><strong>COURIER CHRGS</strong></td>
