<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptcar_invoice.aspx.cs" Inherits="Travel_rptInsuranceInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Car Booking Invoice </title>
    <meta charset="utf-8" />
                      ...
                      <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <th class="text-center">ADULT PAX NOS</th>
                                <th class="text-center">CHILD PAX NOS</th>
                                <th class="text-center">INFANT PAX NOS</th>
