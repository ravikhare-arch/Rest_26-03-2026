<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptgroupmofa_invoice.aspx.cs" Inherits="Travel_rptGroupMofaInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Group Mofa Invoice</title>
    <meta charset="utf-8" />
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="8">
                                    ...
                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../tgroupmofa_booking.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-left"><strong>Group Name</strong></td>
                                <td class="text-center"><strong>Group Code</strong></td>
                                ...
                                <td class="text-center"><strong>VISA COST</strong></td>
                                ...
                                <td class="text-center"><strong>REPEATER QTY</strong></td>
                                <td class="text-center"><strong>REPEATER FEE</strong></td>
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotalRepeater" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
