<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptvisa_invoice.aspx.cs" Inherits="TradeInventory_rptTicketInvoiceNew" %>
        ...
        <div class="container" id="invoice" runat="server">
            <div class="row">
                ...
                <div class="col-xs-12">
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="8">
                                    ...
                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../tvisa.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                    ...
                    <table style="width: 100%; border: 2px solid black; padding: 5px;">
                        <tr>
                            <td colspan="8">
                                <h4 class="pull-left">INV NO :
                    ...
                    <table style="border: 2px solid black; margin-left: 0; margin-right: 0; border-top: none; width: 100%">
                        ...
                        <tr>
                            <td style="width: 50%; border-right: 2px solid black; text-align: left;" colspan="8" class="col-xs-6">
                                <strong>GST NO.:
                                    <asp:Label ID="lblCompGstNo" runat="server"></asp:Label></strong>
                            </td>
                            <td style="width: 50%; text-align: left; padding-left: 10px" colspan="8">
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>VISA TYPE</strong></td>
                                <td class="text-center"><strong>VISA COST</strong></td>
                                <td class="text-center"><strong>SC 1</strong></td>
                                <td class="text-center"><strong>SC 2</strong></td>
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="lblTotOtrChrge" runat="server"></asp:Label></td>
                                <td class="thick-line text-center">
