<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptexcursion_refund_invoice.aspx.cs" Inherits="Travel_rptMofaInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Excurstion Refund Invoice</title>
    <meta charset="utf-8" />
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="8">
                                    ...
                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../texcursion_booking.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
