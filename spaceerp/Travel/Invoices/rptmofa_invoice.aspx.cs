...
public partial class TradeInventory_rptTicketInvoiceNew : System.Web.UI.Page
{
        ...
        if (dt.Rows.Count > 0)
        {
          ...
          //  lblTotTax.Text = dt.Rows[0]["nTotTaxes"].ToString();
           // lblSubTot.Text = (double.Parse(lblTotFare.Text) + double.Parse(lblTotTax.Text)).ToString();
            ...
            lblCourier.Text = dt.Rows[0]["nCourierChrgs"].ToString();
    ...
    public void GetFormDataDet()
    {
        ...
        if (dt.Rows.Count > 0)
        {
          ...
          //  lblTotTds.Text = dt.Rows[0]["nClntTDSAmount"].ToString();
            ...
            //Bind Data Grid
            objClassdet.FillReapter(objClassdet, rptInvoice, "PrintInvdetSingle", Request.QueryString["Detid"].ToString());
