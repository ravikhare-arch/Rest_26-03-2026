<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptrecruitement_refund_invoice.aspx.cs" Inherits="Travel_rptMofaInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Recruitement Refund Invoice</title>
    <meta charset="utf-8" />
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="8">
                                    ...
                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="../tmofa_recruitement.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                        ...
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                              ...
                              <td class="text-left"><strong>PAX NAME</strong></td>
                                ...
                                <td class="text-center"><strong>MOFA NO.</strong></td>
                                <td class="text-center"><strong>DURATION</strong></td>
                                <td class="text-center"><strong>VALIDITY</strong></td>
                                <td class="text-center"><strong>MOFA COST</strong></td>
