<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpthotel_refund_invoice.aspx.cs" Inherits="Travel_rptMofaInvoice" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Hotel Refund Invoice</title>
    <meta charset="utf-8" />
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong> NO. OF NIGHTS</strong></td>
                                <td class="text-center"><strong> NO. OF ROOMS</strong></td>
                                <td class="text-center"><strong> PAX NOS.</strong></td>
