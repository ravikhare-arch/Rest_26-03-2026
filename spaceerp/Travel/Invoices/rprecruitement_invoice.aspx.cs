...
public partial class Travel_rptRecInvoice : System.Web.UI.Page
{
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //Bind Data Grid
            objClass.FillReapter(objClass, rptInvoice, "PrintInvDet", Request.QueryString["id"].ToString());
    ...
    {
        DataTable dt = objClassdet.viewData(objClassdet, "PrintInvSingle", Request.QueryString["Detid"].ToString());
        if (dt.Rows.Count > 0)
        {
            //Main Company details
            imgComp.ImageUrl = "../../Uploads/" + dt.Rows[0]["sCompanyImage"].ToString();
