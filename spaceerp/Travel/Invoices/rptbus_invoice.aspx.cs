...
public partial class Travel_rptInsuranceInvoice : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            objClassDet.sTicketNo = Request.QueryString["id"].ToString();
            objClassDet.sPaxName = "0";
            objClassDet.sAge = "0";
            objClassDet.sOrigin = "0";
            objClassDet.sBusNo = "0";
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //Booking Details
            lblBookingNo.Text = dt.Rows[0]["sBusBookingNo"].ToString();
            lblBookingDate.Text = validation.TextToDate(dt.Rows[0]["dtBookingDate"].ToString());


            //Total;
            object sumObject;
            sumObject = dt.Compute("Sum(nSupplierCost)",string.Empty);
            ...
            object ClientCost;
            ClientCost = dt.Compute("Sum(nClientCost)", string.Empty);
            ...
            objClassDet.FillReapter(objClassDet, rptInvoice, "ShowSearch", Request.QueryString["id"].ToString());
    ...
    public void GetFormDataDet()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblTotOtrCharge.Text = dt.Rows[0]["nClntOtrChrgs"].ToString();
            lblTotSGST.Text = dt.Rows[0]["nClntSGst"].ToString();
            lblTotCGST.Text = dt.Rows[0]["nClntCGst"].ToString();
            lblTotIGST.Text = dt.Rows[0]["nClntIGst"].ToString();
            lblTotDiscount.Text = dt.Rows[0]["nDiscount"].ToString();
