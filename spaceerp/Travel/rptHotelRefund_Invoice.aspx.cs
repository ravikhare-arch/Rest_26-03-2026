...
public partial class Travel_rptHotelInvoice : System.Web.UI.Page
{
    SendMail objsendmail = new SendMail();
    thotelrefund_Class objClass = new thotelrefund_Class();
   ...
   VerifyRenderingInServerForm(Control control)
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        string FileName = "HI" + "_" + sDate + "_" + sTime;
    ...
    public void Send()
    {
        ...
        sFileName = "HI" + "_" + sDate + "_" + Stime3 + ".xls";
