<%@ Page Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptVisaInvoice.aspx.cs" Inherits="Travel_rptVisaInvoice" %>
            ...
            <div class="invoice-content">
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        ...
                        <tr style="background-color: #1c3967; color: white; height: 30px; text-align: center;">
                            <td class="text-center" colspan="2">REFERENCE NO.</td>
                            <td class="text-center" colspan="2">CUSTOMER NAME</td>
                            <td class="text-center" colspan="2">PASSPORT NO.</td>
                            <td class="text-center" colspan="2">VISA TYPE</td>
                            <td class="text-center" colspan="2">VISA DURATION</td>
                            <td class="text-center" colspan="2">VISA RATE</td>
                        </tr>
                        ...
                        <asp:Repeater ID="rptDetails" runat="server">
                            <ItemTemplate>
                                <tr style="height: 40px; text-align: center; padding: 10px; border: 1px solid black">
                                    ...
                                    <td class="text-center" colspan="2"><%# Eval("nExpectedDuration") %></td>
                        ...
                        <tr style="border: 1px solid black; height: 40px;">
                            ...
                            <td colspan="2"></td>
                            <td colspan="2"></td>
                            <td class="text-center font-weight-bold" colspan="2">Service Charge
                            </td>
                        ...
                        <tr style="border: 1px solid black; height: 40px;">
                            ...
                            <td colspan="2"></td>
                            <td colspan="2"></td>
                            <td class="text-center font-weight-bold" colspan="2">SUB TOTAL
                            </td>
                            <td class="text-center font-weight-bold" colspan="2">
