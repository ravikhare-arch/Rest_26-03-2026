<%@ Page Title="Hotel Refund Invoice" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptHotelRefund_Invoice.aspx.cs" Inherits="Travel_rptHotelInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="content" class="content" style="color: black">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <%--<h1 class="page-header hidden-print">Invoice <small>Hotel Booking...</small></h1>--%>
        <!-- end page-header -->
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                            <td class="text-center" colspan="2">REFERENCE NO.</td>
                            <td class="text-center" colspan="2">GUEST NAME</td>
                            <td class="text-center" colspan="2">HOTEL NAME</td>
                        ...
                        <asp:Repeater ID="rptDetails" runat="server">
                            <ItemTemplate>
                                <tr style="height: 40px; text-align: center; padding: 10px; border: 1px solid black">
                                    ...
                                    <td class="text-center" colspan="2"><%# Eval("sReferenceNo") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sPaxName1") %></td>
                                    <td class="text-center" colspan="2"><%# Eval("sHotelName") %></td>
                                    <td class="text-center" colspan="4">Check In :<%# validation.TextToDate( Eval("dtCheckIn").ToString()) %> | Check Out Date:<%# validation.TextToDate( Eval("dtCheckOut").ToString()) %> |
                                         No. Roooms:   <%# Eval("nNoOfRooms") %>  | No. of Nights <%# Eval("nTotalNights") %>
                                    </td>
