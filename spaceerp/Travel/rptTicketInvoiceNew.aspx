<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTicketInvoiceNew.aspx.cs" Inherits="TradeInventory_rptTicketInvoiceNew" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ticketing Invoice</title>
    <meta charset="utf-8" />
        ...
        <div class="container" id="invoice" runat="server">
            <div class="row">
                ...
                <div class="col-xs-12">
                        ...
                        <table>
                            <tr>
                                <td colspan="8">
                                    ...
                                    <h3 style="margin-left: 322px;">TAX INVOICE</h3>
                                </td>
                                <td colspan="8">

                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="tticketing.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                    ...
                    <table  style="border: 2px solid black; margin-left: 0; margin-right: 0; border-top: none;  height: 200px;width:100%">
                        <tr>
                            ...
                            <td style="width: 50%" colspan="8" class="col-xs-6">
                                ...
                                <address>
                                    ...
                                    <asp:Label ID="lblAgntCity" runat="server"></asp:Label><br />
                        ...
                        <tr>
                            <td style="width: 50%; border-right: 2px solid black;text-align:right;padding:10px" colspan="8" class="col-xs-6">
                                <strong>GST:27BMXPA6006N1ZL</strong>
                            </td>
                            <td style="width: 50%;text-align:right;padding:10px" colspan="8">
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-left"><strong>Crrier</strong></td>
                                <td class="text-center"><strong>Tkt No</strong></td>
                                ...
                                <td class="text-center"><strong>Sub Tot</strong></td>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <%# Eval("sTicketPNR") %>
                                            <%--<asp:Label ID="lblTktNo" runat="server"></asp:Label>--%></td>
                                        <td class="text-center">
                                            <%# Eval("sCustomerName") %>
                                        ...
                                        <td>
                                            ...
                                            <%--<asp:Label ID="lblTraveDate" runat="server"></asp:Label>--%></td>
                                        <td class="text-center">
                                            <%# Eval("sFlightClass") %>
                                        ...
                                        <td class="text-center">
                                            <%# Eval("nBasicFare") %>
                                            <%--<asp:Label ID="lblFare" runat="server"></asp:Label>--%></td>
                                        <td class="text-center">
                                            <%# Eval("nTaxes") %>
                                            <%-- <asp:Label ID="lblYQ" runat="server"></asp:Label>--%>
                                            <%--  YQ<br />
                                            <asp:Label ID="lblYR" runat="server"></asp:Label>
                                            YR
                                    <br />
                                            <asp:Label ID="lblK3" runat="server"></asp:Label>
                                            K3--%>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("nSubTot") %>
                                            <%-- <asp:Label ID="lblAirComm" runat="server"></asp:Label>
                                            Air Comm<br />
                                            <asp:Label ID="lblAirPlb" runat="server"></asp:Label>
                                            Air Plb--%>
                                            <%--  <br />
                                            <asp:Label ID="lblAirInc" runat="server"></asp:Label>
                                            Air Inc</td>--%>
                                            <td class="text-center">
                                                <%# Eval("nProfitAmount") %>
                                                <%-- <asp:Label ID="lblOtrTax" runat="server"></asp:Label>--%></td>
                                            <td class="text-center">
                                                <%# Eval("nClntSGst") %>
                                                <%--<asp:Label ID="lblSc" runat="server"></asp:Label>--%></td>
                                            <td class="text-center">
                                                <%# Eval("nClntSGst") %>
