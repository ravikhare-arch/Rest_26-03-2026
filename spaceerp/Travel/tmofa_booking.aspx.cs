...
{
    tmofabooking_Class objClass = new tmofabooking_Class();
    tmofabookingdet_Class objClassDet = new tmofabookingdet_Class();
    ...
    public void displayGrid()
    {
        try
        {
            ...
            //    {
            //        DataRow[] result = dtSum.Select("nMofaBookingID =" + dtMain.Rows[i][0].ToString());
    ...
    {
        objClass.nMofaBookingID = Session["eid"].ToString();
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //}
            Response.Redirect("Invoices/rptmofa_invoice.aspx?id=" + Session["eid"].ToString());
        }
        catch (Exception ex)
        {
            valobj.showMsg(ex.Message, "FAIL", lblmsg);
    ...
    protected void btngdPrintdet_Click(object sender, EventArgs e)
    {
        ...
        if (lblType.Text == "Booking")
        {
            Response.Redirect("Invoices/rptmofa_invoice.aspx?Detid=" + ID.Text);
        }
        else
        {
    ...
    public void paraDet()
    {
        ...
        objClassDet.sEngName = validation.stringToDBString(txtEngName.Text.Trim());
        // objClassDet.sArabicName = validation.stringToDBString(txtArabicName.Text.Trim());
        ...
        objClassDet.nRepeaterFee = validation.stringToDBString(txtSupRepeaterFee.Text.Trim());
    ...
    public void clrfieldDet()
    {
        txtEngName.Text = "";
        //   txtArabicName.Text = "";
        ddlNationalityID.SelectedValue = "0";
        txtdtDOBDate.Text = "";
        txtPassportNo.Text = "";
        txtdtExpityDate.Text = "";
        //    txtPackage.Text = "";
        txtdtIssueDate.Text = "";
        //   txtMuhram.Text = "";
        //    txtRelation.Text = "";
        //      txtPrevNationality.Text = "";
        //       txtAuthority.Text = "";
    ...
    public void GetFormDataDet()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtEngName.Text = dt.Rows[0][2].ToString();
            //   txtArabicName.Text = dt.Rows[0][3].ToString();
            ddlNationalityID.SelectedValue = dt.Rows[0][4].ToString();
            txtdtDOBDate.Text = validation.TextToDate(dt.Rows[0][5].ToString());
            //txtAge.Text = dt.Rows[0][6].ToString();
            //    ddlGender.SelectedValue = dt.Rows[0][7].ToString();
            txtPassportNo.Text = dt.Rows[0][8].ToString();
            txtdtExpityDate.Text = validation.TextToDate(dt.Rows[0][9].ToString());
            //     txtPackage.Text = dt.Rows[0][10].ToString();
            txtdtIssueDate.Text = validation.TextToDate(dt.Rows[0][11].ToString());
            //     txtMuhram.Text = dt.Rows[0][12].ToString();
            //    txtRelation.Text = dt.Rows[0][13].ToString();
            //       txtPrevNationality.Text = dt.Rows[0][14].ToString();
            //       txtAuthority.Text = dt.Rows[0][15].ToString();
            //txtNationalIDNo.Text = dt.Rows[0][16].ToString();
            //txtJob.Text = dt.Rows[0][17].ToString();
            //txtAddress.Text = dt.Rows[0][18].ToString();
            //txtBirthPlace.Text = dt.Rows[0][19].ToString();
            txtBasicFare.Text = dt.Rows[0][20].ToString();
            txtclntCost.Text = dt.Rows[0][20].ToString();
            txtOtherTax.Text = dt.Rows[0][21].ToString();
            //    txtSupComm.Text = dt.Rows[0][22].ToString();

            ddlSupScType.SelectedValue = dt.Rows[0][23].ToString();

            if (ddlSupScType.SelectedValue == "1")
            {
                txtSupSc.Text = dt.Rows[0][24].ToString();
            }
            else
            {
                txtSupSc.Text = dt.Rows[0][25].ToString();
            }
            if (dt.Rows[0][26].ToString() == "1")
            {
            ...
            txtsupcgst.Text = dt.Rows[0][27].ToString();
            txtsupsgst.Text = dt.Rows[0][28].ToString();
            txtsupigst.Text = dt.Rows[0][29].ToString();

            ddlSupTds.SelectedValue = dt.Rows[0][30].ToString();
            if (ddlSupTds.SelectedValue == "1")
            {
                txtSupTds.Text = dt.Rows[0][31].ToString();
            }
            else
            {
                txtSupTds.Text = dt.Rows[0][32].ToString();
            }



            txtSupplierCost.Text = dt.Rows[0][33].ToString();
            lblBuyCost.Text = dt.Rows[0][33].ToString();

            ddlProfitType.SelectedValue = dt.Rows[0][34].ToString();
            if (ddlProfitType.SelectedValue == "1")
            {
                txtProfitAmt.Text = dt.Rows[0][35].ToString();
            }
            else
            {
                txtProfitAmt.Text = dt.Rows[0][36].ToString();
            }

            //ddlClntTds.SelectedValue = dt.Rows[0][37].ToString();
            //if (ddlClntTds.SelectedValue == "1")
            //{
            //    txtClntTds.Text = dt.Rows[0][38].ToString();
            //}
            //else
            //{
            //    txtClntTds.Text = dt.Rows[0][39].ToString();
            //}

            txtDiscount.Text = dt.Rows[0][40].ToString();
            txtRemarks.Text = dt.Rows[0][41].ToString();
            if (dt.Rows[0][42].ToString() == "1")
            {
            ...
            txtClntCgst.Text = dt.Rows[0][43].ToString();
            txtClntSgst.Text = dt.Rows[0][44].ToString();
            txtClntIgst.Text = dt.Rows[0][45].ToString();
            txtClientCost.Text = dt.Rows[0][46].ToString();
            lblSelleing.Text = dt.Rows[0][46].ToString();
            //if (ddlProfitType.SelectedValue == "1")
            //{
            //    txtProfitAmt2.Text = dt.Rows[0][47].ToString();
            //}
            //else
            //{
            //    txtProfitAmt2.Text = dt.Rows[0][48].ToString();
            //}
            txtOtherchrg.Text = dt.Rows[0][49].ToString();
            txtCourierCharge.Text = dt.Rows[0][50].ToString();

            //  txtMutamarNo.Text = dt.Rows[0][51].ToString();
            txtMofaNo.Text = dt.Rows[0][52].ToString();
            ddlCountry.SelectedValue = dt.Rows[0][53].ToString();
            //  txtDependant.Text = dt.Rows[0][54].ToString();
            //  txtSpnsrNo.Text = dt.Rows[0][55].ToString();

            txtDuration.Text = dt.Rows[0][56].ToString();
            txtValidity.Text = dt.Rows[0][57].ToString();
            ddlbookType.SelectedValue = dt.Rows[0][58].ToString();
            txtclntRepeaterFee.Text = dt.Rows[0][59].ToString();
            txtSupRepeaterFee.Text = dt.Rows[0][59].ToString();
            txtSupDiscount.Text = dt.Rows[0][60].ToString();
        }
    }
    ...
    public void displayGridDet()
    {
        try
        {
            objClassDet.sEngName = Session["eid"].ToString();
            objClassDet.sArabicName = "0";
            objClassDet.sAge = "0";
            objClassDet.sPassportNo = "0";
            objClassDet.sPackage = "0";
            objClassDet.dtExpityDate = "";
    ...
    protected void btngdEditDet_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Label MofaID = (Label)GridView2.Rows[row].Cells[0].FindControl("lblMofaBookingID");
    ...
    protected void btnUpdateDet_Click(object sender, EventArgs e)
    {
        ...
        {
            //para();
            //objClassDet.nMofaBookingID = Session["Detid"].ToString();
            //var abc = objClass.User_Operation(objClass, "edit");

            paraDet();
            objClassDet.nMofaBookingDetID = Session["Detid"].ToString();
    ...
    protected void lnkList_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("tmofa_booking_list.aspx");
    }
    ...
    protected void txtBasicFare_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlbookType.SelectedValue == "2")
            {
                string SupCost = ((double.Parse(txtBasicFare.Text) + double.Parse(txtOtherTax.Text) + double.Parse(txtSupRepeaterFee.Text) + SupSC - SupTDS - (double.Parse(txtSupDiscount.Text)) + (double.Parse(txtsupcgst.Text)) + (double.Parse(txtsupsgst.Text)) + (double.Parse(txtsupigst.Text)))).ToString();
            ...
            {
                txtSupplierCost.Text = ((double.Parse(txtBasicFare.Text) + double.Parse(txtOtherTax.Text) + double.Parse(txtSupRepeaterFee.Text) + SupSC - SupTDS - (double.Parse(txtSupDiscount.Text)) + (double.Parse(txtsupcgst.Text)) + (double.Parse(txtsupsgst.Text)) + (double.Parse(txtsupigst.Text)))).ToString();
            }

            lblBuyCost.Text = ((double.Parse(txtBasicFare.Text) + double.Parse(txtOtherTax.Text) + double.Parse(txtSupRepeaterFee.Text) + SupSC - SupTDS - (double.Parse(txtSupDiscount.Text)) - +(double.Parse(txtsupcgst.Text)) + (double.Parse(txtsupsgst.Text)) + (double.Parse(txtsupigst.Text)))).ToString();
            ...
            {
                txtClientCost.Text = ((double.Parse(lblBuyCost.Text) + ClntSC + ClntSC2 - ClntTDS + (double.Parse(txtCourierCharge.Text)) + (double.Parse(txtOtherchrg.Text)) + (double.Parse(txtClntCgst.Text)) + (double.Parse(txtClntSgst.Text)) + (double.Parse(txtClntIgst.Text)))).ToString();
            }

            lblSelleing.Text = ((double.Parse(lblBuyCost.Text) + ClntSC + ClntSC2 - ClntTDS + (double.Parse(txtOtherchrg.Text)) + (double.Parse(txtCourierCharge.Text)) + (double.Parse(txtClntCgst.Text)) + (double.Parse(txtClntSgst.Text)) + (double.Parse(txtClntIgst.Text)))).ToString();
    ...
    protected void txtclntRepeaterFee_TextChanged(object sender, EventArgs e)
    {
        txtSupRepeaterFee.Text = txtclntRepeaterFee.Text;
        txtBasicFare_TextChanged(this, e);
        txtDiscount.Focus();
    }
    protected void txtSupRepeaterFee_TextChanged(object sender, EventArgs e)
    {
        txtclntRepeaterFee.Text = txtSupRepeaterFee.Text;
        txtBasicFare_TextChanged(this, e);
        txtSupTds.Focus();
    }
    ...
    {
        objRefund.nMofaBookingDetID = Session["Detid"].ToString();
    ...
    public void RefundSave()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                objRefund.nMofaBookingDetID = dt.Rows[0][0].ToString();
    ...
    protected void btngdPay_Click(object sender, EventArgs e)
    {
        ...
        txtPayRemarks.Text = "Umrah Mofa  payment for invoice no.: " + InvNo.Text;
        DisplayPaymentGrid();
        PayVoucher_Generate();
    ...
    protected void btnPaymentHistory_Click(object sender, EventArgs e)
    {
        ...
        txtPayRemarks.Text = "Umrah Mofa payment for invoice no.: " + txtMofaBookingNo.Text;
    ...
    protected void btngdPayPrintDet_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("PaymentReceipt/rptpay_receipt_inv.aspx?Detid=" + IDDet.Text + "&sPayfor=Mofa");
        }
        catch (Exception ex)
        {
            valobj.showMsg(ex.Message, "FAIL", lblmsg);
