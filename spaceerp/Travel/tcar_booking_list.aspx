<%@ Page Title="Car Booking" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tcar_booking_list.aspx.cs" Inherits="tcar_booking_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function pageLoad(sender, args) {
            $(document.body).ready(function () {
                ...
                $(document.body).on("click", ".editbtn", function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "tcar_booking.aspx",
                        data: datastring,
                        cache: false,
                        success: function (html) {
                            window.location.href = "../Travel/tcar_booking.aspx?" + datastring + "";
                        }
                    });
                });
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("tcar_booking_list.aspx/loaddata") %>',
                type: "post",
