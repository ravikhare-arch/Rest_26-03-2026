...
{
    tbusbooking_Class objClass = new tbusbooking_Class();
    tbusbooking_det_Class objClassDet = new tbusbooking_det_Class();
    ...
    mmain_account_Class objCAccount = new mmain_account_Class();
    msupgst_Class objSupGst = new msupgst_Class();
    mclientgst_Class objClntGst = new mclientgst_Class();
    tbusrefund_Class objRefund = new tbusrefund_Class();

    tpayments_receive_Class objBusPay = new tpayments_receive_Class();
    tpayments_receivedet_Class objBusPayDet = new tpayments_receivedet_Class();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                Session["tbus_booking"] = aa;
                objCAccount.ddlOperation(objCAccount, "ddlCustomer", "", ddlAgentID);
                objBranch.ddlOperation(objBranch, "Showddl", "", ddlLocationID);
                objCAccount.ddlOperation(objCAccount, "ddlVendor", "", ddlSupplier);
                ...
                //displayGrid();
                btnVisible();
                txtdtBusBooking.Text = validation.fillDate();
                Booking_Generate();
    ...
    {
        ViewState["tbus_booking"] = Session["tbus_booking"];
    }

    public void Booking_Generate()
    {
        DataTable dt = objClass.viewData(objClass, "MaxBookNo", validation.dateToText(txtdtBusBooking.Text));
        if (dt.Rows.Count > 0)
        {
            txtBusBookingNo.Text = dt.Rows[0][0].ToString();
        }
    }
    public void para()
    {
        objClass.sBusBookingNo = validation.stringToDBString(txtBusBookingNo.Text.Trim());
        objClass.dtBookingDate = validation.dateToText(txtdtBusBooking.Text.Trim());
        ...
        objClass.nTypeID = ddlbookType.SelectedValue;

    }

    public void clrfield()
    {
        txtBusBookingNo.Text = "";
        txtdtBusBooking.Text = "";
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtBusBookingNo.Text = dt.Rows[0][1].ToString();
            txtdtBusBooking.Text = validation.TextToDate(dt.Rows[0][2].ToString());
    ...
    {
        objClass.nBusBookingID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["tbus_booking"].ToString() == ViewState["tbus_booking"].ToString())
            {
                para();
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("Invoices/rptbus_invoice.aspx?id=" + Session["eid"].ToString());
            }
            else
            {
                Response.Redirect("Invoices/rptbus_refund_invoice.aspx?id=" + Session["eid"].ToString());
            }
        }
        catch (Exception ex)
        {
    ...
    protected void btngdPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("Invoices/rptbus_invoice.aspx?id=" + ID.Text);
            }
            else
            {
                Response.Redirect("Invoices/rptbus_refund_invoice.aspx?id=" + ID.Text);
            }
    ...
    public void paraDet()
    {
        ...
        objClassDet.nBusBookingID = Session["eid"].ToString();
        ...
        objClassDet.nGenderID = ddlGenderID.SelectedValue;
        objClassDet.sAge = validation.stringToDBString(txtPaxAge.Text.Trim());
        objClassDet.sOrigin = validation.stringToDBString(txtOrigin.Text.Trim());
        objClassDet.sDestination = validation.stringToDBString(txtDestination.Text.Trim());
        objClassDet.sBusNo = validation.stringToDBString(txtBusNo.Text.Trim());
        objClassDet.dtTravelDate = validation.dateToText(txttTravelDate.Text.Trim());
        objClassDet.sCoachType = validation.stringToDBString(txtCoachType.Text.Trim());
    ...
    public void GetFormDataDet()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtTicketNo.Text = dt.Rows[0][2].ToString();
            txtPaxName.Text = dt.Rows[0][3].ToString();
            ddlGenderID.SelectedValue = dt.Rows[0][4].ToString();
            txtPaxAge.Text = dt.Rows[0][5].ToString();
            txtOrigin.Text = dt.Rows[0][6].ToString();
            txtDestination.Text = dt.Rows[0][7].ToString();
            txtBusNo.Text = dt.Rows[0][8].ToString();
            txttTravelDate.Text = validation.TextToDate(dt.Rows[0][9].ToString());
            txtCoachType.Text = dt.Rows[0][10].ToString();
    ...
    public void displayGridDet()
    {
        ...
        {
            string BusID = "";
           BusID = Session["eid"].ToString();
                
            // objClassDet.sTicketNo = Session["eid"].ToString();
            // objClassDet.FillGrid(objClassDet, GridView2, "ShowSearch", "");
            objClassDet.FillGrid(objClassDet, GridView2, "ShowSea", BusID);
        }
        catch (Exception ex)
        {
            valobj.showMsg(ex.Message, lblmsg);
    ...
    protected void btngdEditDet_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Label bookID = (Label)GridView2.Rows[row].Cells[1].FindControl("lblbookingID");
    ...
    protected void btnUpdateDet_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            paraDet();
            objClassDet.nBusBookingDetID = Session["Detid"].ToString();
    ...
    protected void lnkList_Click(object sender, EventArgs e)
    {
        ...
        //displayGrid();
        //PnlPayment.Visible = false;
        //objCAccount.ddlOperation(objCAccount, "ddlCustomer", "", ddlSClient);
        //objBranch.ddlOperation(objBranch, "Show", "", ddlSLoc);
        //objCAccount.ddlOperation(objCAccount, "ddlVendor", "", ddlSSup);
        //objClass.ddlOperation(objClass, "Show", "", ddlInvoiceNo);
        Response.Redirect("tbus_booking_list.aspx");
    }
    protected void txtdtBusBooking_TextChanged(object sender, EventArgs e)
    {
        Booking_Generate();
    }
    ...
    {
        DataTable dt = objClass.viewData(objClass, "FillDataBus", txtBusBookingNo.Text);
        if (dt.Rows.Count > 0)
        {
    ...
    {
        objRefund.nBusBookingID = Session["eid"].ToString();
    ...
    public void RefundSave()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                objRefund.nBusBookingID = dt.Rows[0][0].ToString();
    ...
    {
        objClassDet.sTicketNo = ddlInvoiceNo.SelectedValue;
        objClassDet.sPaxName = ddlSClient.SelectedValue;
        objClassDet.sAge = ddlSSup.SelectedValue;
        objClassDet.sOrigin = ddlSLoc.SelectedValue;
        objClassDet.sBusNo = ddlSBookType.SelectedValue;
    ...
    protected void btngdPay_Click(object sender, EventArgs e)
    {
        ...
        GridViewRow thisgrdR = (GridViewRow)thisbtn.Parent.Parent;
        int row = thisgrdR.RowIndex;
        Label lblBusID = (Label)GridView1.Rows[row].Cells[0].FindControl("lblID");
        Session["eid"] = lblBusID.Text;
        ...
        txtPayRemarks.Text = "Bus Ticket payment for invoice no.: " + InvNo.Text;
        DisplayPaymentGrid();
        PayVoucher_Generate();
    ...
    protected void btnPaymentHistory_Click(object sender, EventArgs e)
    {
        ...
        txtPayRemarks.Text = "Bus Ticket payment for invoice no.: " + txtBusBookingNo.Text;
        txtPayInv.Text = txtBusBookingNo.Text;
        lblInvoiceDate.Text = validation.dateToText(txtBusBookingNo.Text).ToString();
        GetBalance();
        txtdtpayment.Text = validation.fillDate();
    ...
    {
        objBusPay.sPayfor = "Bus";
        objBusPay.FillGrid(objBusPay, GridPay, "ShowPaymentsModule", Session["eid"].ToString());
    }
    public void paymentPara()
    {
        //Main Table
        //  objBusPay.nPaymentReceiveID = Session["eid"].ToString();
        objBusPay.nPaymentModeID = ddlPayVoucherType.SelectedValue;
        objBusPay.nCashAccountID = ddlPaymentAccount.SelectedValue;
        objBusPay.dtPayment = validation.dateToText(txtdtpayment.Text);
        objBusPay.sVoucherNo = txtPayVoucherNo.Text;
        objBusPay.nTotAmount = txtPayAmount.Text;
        objBusPay.nAgentID = lblAgent.Text;
        objBusPay.sRemarks = txtPayRemarks.Text;
        objBusPay.sPayfor = "Bus";

        //Detail Table
        objBusPayDet.nInvoiceID = Session["eid"].ToString();
        objBusPayDet.sInvoiceNo = txtPayInv.Text;
        objBusPayDet.dtInvoiceDate = lblInvoiceDate.Text;
        objBusPayDet.nAmount = txtPayAmount.Text; ;

        objBusPayDet.sRemarks = txtPayRemarks.Text;
    ...
    {
        DataTable dt = objBusPayDet.viewData(objBusPayDet, "GetDataTravel", Session["PayDetid"].ToString());
        if (dt.Rows.Count > 0)
        {
    ...
    protected void btnPayment_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            {
                var abc = objBusPay.User_Operation(objBusPay, "add");
                var strArr = abc.Split(',');
                if (strArr[0] == "1")
                {
                    string PayID = strArr[2].ToString();
                    Session["Payid"] = PayID;
                    objBusPayDet.nPaymentReceiveID = PayID;
                    var abc1 = objBusPayDet.User_Operation(objBusPayDet, "add");
                }
                valobj.showMsg(abc, lblmsg);
            ...
            {
                //Upodate Main Table
                objBusPay.nPaymentReceiveID = Session["Payid"].ToString();
                var abc = objBusPay.User_Operation(objBusPay, "edit");

                //Upodate Detail Table
                objBusPayDet.nPaymentReceiveDetID = Session["PayDetid"].ToString();
                objBusPayDet.nPaymentReceiveID = Session["Payid"].ToString();
                var abc1 = objBusPayDet.User_Operation(objBusPayDet, "edit");
    ...
    {
        objBusPay.nPaymentReceiveID = Session["Payid"].ToString();
        var vres = objBusPay.User_Operation(objBusPay, "DeActive");
        valobj.showMsg(vres, lblmsg);
        DisplayPaymentGrid();
        PayVoucher_Generate();
        Session["Payid"] = "";
    ...
    {
        DataTable dt = objBusPay.viewData(objBusPay, "PVN", validation.dateToText(txtdtpayment.Text));
        if (dt.Rows.Count > 0)
        {
    ...
    protected void btngdPayPrintDet_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("PaymentReceipt/rptpay_receipt_inv.aspx?Detid=" + IDDet.Text + "&sPayfor=Bus");
        }
        catch (Exception ex)
        {
            valobj.showMsg(ex.Message, "FAIL", lblmsg);
    ...
    {
        Response.Redirect("PaymentReceipt/rptpay_receipt_inv.aspx?id=" + Session["eid"].ToString() + "&sPayfor=Bus");
    }
