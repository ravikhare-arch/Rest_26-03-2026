...
public partial class tpayment_receive_list : System.Web.UI.Page
{
    static tpayments_receive_Class objClass = new tpayments_receive_Class();
    static tpayments_receivedet_Class objClassDet = new tpayments_receivedet_Class();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                //Session["tpayment_receive_list"] = aa;
    ...
    //{
        //ViewState["tpayment_receive_list"] = Session["tpayment_receive_list"];
        //viewstate = Session["tpayment_receive_list"].ToString();
   // }
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor, string AgentID)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                magentobj.PaymentReceiveID = dt.Rows[i]["nPaymentReceiveID"].ToString();
    ...
    public static string AddJournalVoucher(list list)
    {
        ...
        try
        {
           // if (HttpContext.Current.Session["tpayment_receive_list"].ToString() == viewstate)
            //{
                para(list);
                ...
                if (strArr[0] == "1")
                {
                    ...
                    //Journal Voucher Det
                   // paraDet(list);
                    objClassDet.nPaymentReceiveID = VoucherID;
    ...
    public static string DeleteVoucher(string AccountLedgerID)
    {
        ...
        try
        {
            objClass.nPaymentReceiveID = AccountLedgerID;
    ...
    public static string para(list list)
    {
        ...
        objClass.nAgentID = list.AgentID;
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "PaymentReceipt-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/PaymentReceipt.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("PaymentReceipt - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Payment Receipt "; // Heading Name               
                worksheet.Cells[4, 1, 4, 6].Merge = true; //Merge columns start and end range
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PaymentReceipt.xlsx");
    ...
    {
        Response.Redirect("tpayment_receive.aspx");
    }
