    ...
    public void GetFormData()
     {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblTotFare.Text = dt.Rows[0]["nTotBaseFare"].ToString();
            ...
            lblTotSC.Text = dt.Rows[0]["nTotSC"].ToString();
            

            lblTotSGST.Text = dt.Rows[0]["nTotSGST"].ToString();
            lblTotCGST.Text = dt.Rows[0]["nTotCGST"].ToString();
            lblTotIGST.Text = dt.Rows[0]["nTotIGST"].ToString();
            lblTotDiscount.Text = dt.Rows[0]["nTotDisCount"].ToString();
            lblTotTds.Text = dt.Rows[0]["nTotTds"].ToString();
            lblTotAmt.Text = dt.Rows[0]["nTotSellingCost"].ToString();
