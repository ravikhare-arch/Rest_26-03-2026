<%@ Page Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rpttrain_refund_invoice.aspx.cs" Inherits="Travel_rptTrainInvoice" %>
                ...
                <div class="table-responsive">
                    <table style="border: 1px; width: 99%; margin-bottom: 30px; color: black;">
                        ...
                        <tr style="background-color: #1c3967; color: white; height: 40px; text-align: center;">
                            ...
                            <th class="text-center" colspan="2">BOARDING</th>
