<%@ Page Title="Group Air Ticketing" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" Culture="en-GB"
    CodeFile="tgroup_ticketing.aspx.cs" Inherits="Transcation_ticketing" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">Group Ticket Booking Details</h4>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-3 col-sm-3">
                                                    <label class="col-form-label" for="fullname">
                                                        Ticket Type :</label>
                                                    <asp:DropDownList CssClass="form-control js-example-placeholder-single" ID="ddlTicketType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlTicketType_SelectedIndexChanged">
                                                ...
                                                <div class="col-md-3 col-sm-3">
                                                    ...
                                                    <asp:TextBox ID="txtTicketBookingNo" runat="server" Enabled="false" CssClass="form-control" Width="100%"> </asp:TextBox>
                                                ...
                                                <div class="col-md-3 col-sm-3" style="z-index: 100">
                                                    <label class="col-form-label" for="fullname">
                                                        DOC Date :</label>
                                                    <asp:TextBox ID="txtdtBooking" runat="server" CssClass="datepicker form-control" AutoCompleteType="None" AutoPostBack="true" OnTextChanged="txtdtBooking_TextChanged" Width="100%"></asp:TextBox>
                                                ...
                                                <div class="col-md-3 col-sm-3">
                                                    <label class="col-form-label" for="fullname">
                                                        Supplier Type :</label>
                                                    <asp:DropDownList Width="100%" ID="ddlsupplierType" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlsupplierType_SelectedIndexChanged">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlsupplierType" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                </div>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4 col-sm-4">
                                                    <label class="col-form-label" for="fullname">
                                                        Location  :</label>
                                                    <asp:DropDownList ID="ddlLocationID" runat="server" CssClass="form-control js-example-placeholder-single" Width="100%" AutoPostBack="true" OnTextChanged="ddlLocationID_TextChanged">
                                                    </asp:DropDownList>
                                ...
                                <asp:Panel class="tbl" ID="tblDet" runat="server">
                                    <div style=" padding: 15px;padding-top:0px;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Group Name :</label>
                                                <asp:TextBox ID="txtGroupName" CssClass="form-control" runat="server" ValidationGroup="A" Width="100%">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtGroupName" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Select Air</label>
                                                <asp:DropDownList CssClass="form-control js-example-placeholder-single" Width="100%" ID="ddlCarrierID" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCarrierID_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Ticket No. :</label>
                                                <asp:TextBox ID="txtTicketNo" CssClass="form-control" runat="server" Width="100%" AutoPostBack="true" MaxLength="14" OnTextChanged="txtTicketNo_TextChanged">
                                                </asp:TextBox>
                                            </div>
                                            <%--<div class="col-md-3 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Pax Type</label>
                                                <asp:DropDownList Width="100%" ID="ddlPaxType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlBookType_SelectedIndexChanged">
                                                    <asp:ListItem Text="Adult" Value="Adult" Selected="True"></asp:ListItem>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Ref No. :</label>
                                                <asp:TextBox ID="txtReferenceNo" CssClass="form-control" runat="server" ValidationGroup="A" Width="100%">
                                                </asp:TextBox>
                                            </div>
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Air PNR:</label>
                                                <asp:TextBox ID="txtAirPnr" CssClass="form-control" runat="server" ValidationGroup="A" Width="100%"></asp:TextBox>
                                            </div>
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Flight No:</label>
                                                <asp:TextBox ID="txtFlightNo" CssClass="form-control" runat="server" ValidationGroup="A" Width="100%"></asp:TextBox>
                                            </div>
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    CRS :</label>
                                                <asp:DropDownList ID="ddlTktBookFrom" CssClass="form-control" runat="server" Width="100%">
                                                    <asp:ListItem Text="AMDEUS" Value="AMDEUS"></asp:ListItem>
                                                    <asp:ListItem Text="GALILIO" Value="GALILIO"></asp:ListItem>
                                                    <asp:ListItem Text="SABRE" Value="SABRE"></asp:ListItem>
                                                    <asp:ListItem Text="ABACUS" Value="ABACUS"></asp:ListItem>
                                            ...
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Sector :</label>
                                                <asp:TextBox ID="txtSector" CssClass="form-control" runat="server" placeholder="BOM/DEL/BOM" ValidationGroup="A" MaxLength="19" Width="100%" AutoPostBack="true" OnTextChanged="txtSector_TextChanged"></asp:TextBox>
                                            ...
                                            <%--<div class="col-md-2 col-sm-2">
                                                <label class="col-form-label" for="fullname">
                                                    Travel Date :</label>
                                                <asp:TextBox ID="txtTravelDate" runat="server" placeholder="DD/MM/YYYY" Width="100%"> </asp:TextBox>
                                                <AjaxToolKit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy"
                                                    PopupButtonID="txtTravelDate" TargetControlID="txtTravelDate" PopupPosition="TopLeft" />

                                                <AjaxToolKit:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="txtTravelDate"
                                                    Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtTravelDate"
                                            ...
                                            <%--<div class="col-md-2 col-sm-2">
                                                <label class="col-form-label" for="fullname">
                                                    Due Date :</label>
                                                <asp:TextBox ID="txtdtDueDate" runat="server" placeholder="DD/MM/YYYY" Width="100%"></asp:TextBox>

                                                <AjaxToolKit:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy"
                                                    PopupButtonID="txtdtDueDate" TargetControlID="txtdtDueDate" PopupPosition="TopLeft" />

                                                <AjaxToolKit:MaskedEditExtender ID="MaskedEditExtender2" runat="server" TargetControlID="txtdtDueDate"
                                                    Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />


                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txtdtDueDate"
                                                    ValidationGroup="A" Display="Dynamic" SetFocusOnError="true" runat="server" ErrorMessage="Invalid Date"
                                                    ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d"> 
                                                </asp:RegularExpressionValidator>
                                            ...
                                            <div class="col-md-2 col-sm-3">
                                                <label class="col-form-label" for="fullname">
                                                    Remarks :</label>
                                                <asp:TextBox ID="txtRemarks" CssClass="form-control" runat="server" Width="100%">
                                                </asp:TextBox>
                                            </div>
                                        </div>

                                        <div class="form-group row m-t-10">
                                            <asp:Repeater ID="rptSector" runat="server">
                                                <ItemTemplate>
                                                    <div class="col-md-3 col-sm-12  p-10 text-center border">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 col-sm-12">
                                                                <asp:TextBox ID="txtSecAirR" CssClass="form-control" runat="server" Text='<%# Eval("sAirline") %>' Width="100%"></asp:TextBox>
                                                            </div>
                                                            <div class="col-md-5 col-sm-12" style="z-index: 999">
                                                                <asp:TextBox ID="txtdtTravelR" runat="server" Text='<%# validation.TextToDate(Eval("dtTDate").ToString()) %>' Width="100%" CssClass="datepicker form-control"></asp:TextBox>
                                                                <%-- <AjaxToolKit:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MM/yyyy"
                                            ...
                                            <div style=" padding: 5px;padding-top:0px;">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-3 col-sm-3">
                                                                <label class="col-form-label" for="fullname">
                                                                    B FARE</label>
                                                                <asp:Label ID="txtBasicTot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtClntBasicFare" CssClass="form-control" runat="server" Width="100%" AutoPostBack="True" OnTextChanged="txtClntBasicFare_TextChanged"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                <label class="col-form-label" for="fullname">
                                                                    Qty.</label>
                                                                <asp:TextBox ID="txtClntQty" CssClass="form-control" runat="server" Width="100%" AutoPostBack="True" Text="1" OnTextChanged="txtClntQty_TextChanged"></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator22" runat="server" ControlToValidate="txtClntQty"
                                                                    SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Numbers" ValidationExpression="^(-)?\d+(\.\d+$)?$"
                                                                    ValidationGroup="A"></asp:RegularExpressionValidator>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtClntBasicFare" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <div class="col-md-3 col-sm-3">
                                                                <label class="col-form-label" for="fullname">
                                                                    'YQ' 
                                                                </label>
                                                                <asp:Label ID="txtYQTaxTot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtClntYQTax" CssClass="form-control" runat="server" Width="100%" AutoPostBack="True" OnTextChanged="txtClntYQTax_TextChanged"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                ...
                                                                <asp:Label ID="txtYRTaxTot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtClntYRTax" CssClass="form-control" runat="server" Width="100%" AutoPostBack="True" OnTextChanged="txtClntYRTax_TextChanged"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-3 col-sm-4">
                                                                ...
                                                                <asp:Label ID="txtK3Tot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtClntK3Tax" CssClass="form-control" runat="server" Width="100%" OnTextChanged="txtClntK3Tax_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-4">
                                                                ...
                                                                <asp:Label ID="txtOtherTaxtot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtClntOtherTax" CssClass="form-control" runat="server" placeholder="OTHER TAX" OnTextChanged="txtClntOtherTax_TextChanged" AutoPostBack="true" Width="100%"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                ...
                                                                <asp:Label ID="txtAirComTot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtClntAirCom" CssClass="form-control" placeholder="IATA" runat="server" Enabled="true" Width="100%" OnTextChanged="txtClntAirCom_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                ...
                                                                <asp:Label ID="txtAirPlbTot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtClntAirPlb" CssClass="form-control" placeholder="PLB" runat="server" Enabled="true" Width="100%" OnTextChanged="txtClntAirPlb_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-2 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            TKT COST</label>
                                                        <%--<asp:Label ID="txtClntTicketFare" runat="server" Visible="false"></asp:Label>--%>
                                                        <asp:TextBox ID="txtClntTicketFare" CssClass="form-control" runat="server" Width="100%" OnTextChanged="txtProfitAmount_TextChanged" Enabled="false" AutoPostBack="true"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-2 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            SC 1:</label>
                                                        <asp:Label ID="txtProfitAmountTot" runat="server" Visible="false"></asp:Label>
                                                        <asp:TextBox ID="txtProfitAmount"  CssClass="form-control" runat="server" Width="100%" OnTextChanged="txtProfitAmount_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-2 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            SC 2 :</label>
                                                        <asp:Label ID="txtClntSc2Tot" runat="server" Visible="false"></asp:Label>
                                                        <asp:TextBox ID="txtClntSc2" CssClass="form-control" runat="server" Width="100%" OnTextChanged="txtClntSc2_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-2 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            CLNT TDS</label>
                                                        <asp:Label ID="txtClntTdsTot" runat="server" Visible="false"></asp:Label>
                                                        <asp:TextBox ID="txtClntTds" CssClass="form-control" Width="100%" runat="server" OnTextChanged="txtClntTds_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-6 col-sm-4">
                                                                <label class="col-form-label" for="fullname">
                                                                    DISCOUNT :</label>
                                                                <asp:Label ID="txtClntDiscountTot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtDiscount" CssClass="form-control" runat="server" Width="100%" OnTextChanged="txtDiscount_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-6 col-sm-3">
                                                                ...
                                                                <asp:Label ID="txtOtherchrgTot" runat="server" Visible="false"></asp:Label>
                                                                <asp:TextBox ID="txtOtherchrg" CssClass="form-control" runat="server" Width="95%" Placeholder="" OnTextChanged="txtOtherchrg_TextChanged" AutoPostBack="true" placeolder=""></asp:TextBox>
                                                            ...
                                                            <fieldset class="the-fieldset">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-4 col-sm-4">
                                                                        ...
                                                                        <asp:Label ID="txtClntCgstTot" runat="server" Visible="false"></asp:Label>
                                                                    ...
                                                                    <div class="col-md-4 col-sm-4">
                                                                        ...
                                                                        <asp:Label ID="txtClntSgstTot" runat="server" Visible="false"></asp:Label>
                                                                    ...
                                                                    <div class="col-md-4 col-sm-4">
                                                                        ...
                                                                        <asp:Label ID="txtClntIgstTot" runat="server" Visible="false"></asp:Label>
                                            ...
                                            <div style=" padding: 5px;">
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-3 col-sm-3">
                                                                <label class="col-form-label" for="fullname">
                                                                    B FARE</label>
                                                                <asp:TextBox ID="txtFareBasis" CssClass="form-control" runat="server" Width="100%" AutoPostBack="True" OnTextChanged="txtFareBasis_TextChanged"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                ...
                                                                <asp:TextBox ID="txtSupQty" CssClass="form-control" runat="server" Width="100%" AutoPostBack="True" Text="1" OnTextChanged="txtSupQty_TextChanged"></asp:TextBox>
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator30" runat="server" ControlToValidate="txtSupQty"
                                                                    SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Numbers" ValidationExpression="^(-)?\d+(\.\d+$)?$"
                                                                    ValidationGroup="A"></asp:RegularExpressionValidator>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="txtYQtax" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                                                            </div>
                                                            <div class="col-md-3 col-sm-3">
                                                                <label class="col-form-label" for="fullname">
                                                                    'YQ' 
                                                                </label>
                                                                <asp:TextBox ID="txtYQtax" CssClass="form-control" runat="server" Width="100%" AutoPostBack="True" OnTextChanged="txtYQtax_TextChanged"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                ...
                                                                <asp:TextBox ID="txtYRtax" CssClass="form-control" runat="server" Width="100%" AutoPostBack="True" OnTextChanged="txtYRtax_TextChanged"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-3 col-sm-4">
                                                                ...
                                                                <asp:TextBox ID="txtK3Tax" CssClass="form-control" runat="server" Width="100%" OnTextChanged="txtK3Tax_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-4">
                                                                ...
                                                                <asp:TextBox ID="txtOtherTax" CssClass="form-control" placeholder="OTR TAX" runat="server" OnTextChanged="txtOtherTax_TextChanged" AutoPostBack="true" Width="100%"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                ...
                                                                <asp:TextBox ID="txtAirComm" CssClass="form-control" runat="server" placeholder="IATA COM" Enabled="true" Width="100%" OnTextChanged="txtAirComm_TextChanged"></asp:TextBox>
                                                            ...
                                                            <div class="col-md-3 col-sm-3">
                                                                ...
                                                                <asp:TextBox ID="txtAirplb" CssClass="form-control" runat="server" placeholder="PLB COM" Enabled="true" Width="100%" OnTextChanged="txtAirplb_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            ...
                                                            <%--  <div class="col-md-3 col-sm-4">
                                                                ...
                                                                <asp:TextBox ID="txtOcTax" runat="server"  OnTextChanged="txtOcTax_TextChanged" AutoPostBack="true" Width="100%"></asp:TextBox>
                                                            ...
                                                            <%-- <div class="col-md-4 col-sm-6">
                                                                ...
                                                                <asp:TextBox ID="txtAirInc" runat="server" Width="100%" Enabled="true" AutoPostBack="True" OnTextChanged="txtAirInc_TextChanged1"></asp:TextBox>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-2 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            TKT COST</label>
                                                        <asp:TextBox ID="txtSupTicketFare" CssClass="form-control" runat="server" Width="100%" OnTextChanged="txtProfitAmount_TextChanged" Enabled="false" AutoPostBack="true"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-2 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            SUP SC :</label>
                                                        <asp:Label ID="txtSupScTot" runat="server" Visible="false"></asp:Label>
                                                    ...
                                                    <div class="col-md-2 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            Sup. TDS</label>
                                                        <asp:Label ID="txtSupTdsTot" runat="server" Visible="false"></asp:Label>
                                                        <asp:TextBox ID="txtSupTds" CssClass="form-control" runat="server" Width="100%" Enabled="true" AutoPostBack="True" OnTextChanged="txtSupSc_TextChanged"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-2 col-sm-4">
                                                        <label class="col-form-label" for="fullname">
                                                            DISCOUNT</label>
                                                        <asp:Label ID="txtSupDiscountTot" runat="server" Visible="false"></asp:Label>
                                                        <asp:TextBox ID="txtSupDiscount" CssClass="form-control" runat="server" Width="100%" Enabled="true" AutoPostBack="True" OnTextChanged="txtSupDiscount_TextChanged"></asp:TextBox>
                                                        ...
                                                        <fieldset class="the-fieldset">
                                                            <div class="form-group row m-b-5">
                                                                ...
                                                                <div class="col-md-4 col-sm-4">
                                                                    ...
                                                                    <asp:Label ID="txtsupcgstTot" runat="server" Visible="false"></asp:Label>
                                                                ...
                                                                <div class="col-md-4 col-sm-4">
                                                                    ...
                                                                    <asp:Label ID="txtsupsgstTot" runat="server" Visible="false"></asp:Label>
                                                                ...
                                                                <div class="col-md-4 col-sm-4">
                                                                    ...
                                                                    <asp:Label ID="txtsupigstTot" runat="server" Visible="false"></asp:Label>
                                                                    <asp:TextBox ID="txtsupigst" CssClass="form-control" runat="server" Width="95%" Enabled="false"></asp:TextBox>
                                    ...
                                    <div class="form-group row m-b-0" style="text-align: center; padding: 10px;">
                                        <div class="col-md-6 col-sm-6 text-center">
                                            ...
                                            <asp:TextBox ID="txtClientCost" runat="server" Enabled="false" Width="40%" CssClass="btn" BackColor="#003366" ForeColor="White"></asp:TextBox>
                                        ...
                                        <div class="col-md-6 col-sm-6 text-center">
                                            ...
                                            <asp:TextBox ID="txtSupplierCost" runat="server" Width="40%" Enabled="false" CssClass="btn" BackColor="#003366" ForeColor="White"></asp:TextBox>
                                            <asp:RegularExpressionValidator ID="REV34" runat="server" ControlToValidate="txtSupplierCost"
                                                SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Numbers" ValidationExpression="^(-)?\d+(\.\d+$)?$"
                                                ValidationGroup="A"></asp:RegularExpressionValidator>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="nTicketingDetID" Visible="false">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblgroupid" runat="server" Text='<%# Eval("nTicketingID") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="sGroupName" HeaderText="Group Name" />
                                                <asp:BoundField DataField="sAirlineName" HeaderText="Airline" />
                                                <asp:BoundField DataField="sAirPNR" HeaderText="PNR" />
                                ...
                                <div style=" padding: 10px; margin-top: 20px;">
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-2 col-sm-2" style="z-index: 99">
                                            <label class="col-form-label" for="fullname">
                                                Invoice Date :</label>
                                            <asp:TextBox ID="txtSdtBooking" runat="server" CssClass="datepicker form-control" placeholder="dd/MM/yyyy" Width="100%"></asp:TextBox>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="row m-5">
                                        ...
                                        <div class="col-md-3 col-sm-3" style="z-index: 99">
                                            <h5>Payment Date</h5>
                                            <asp:TextBox ID="txtdtpayment" runat="server" Width="100%" TextMode="SingleLine" CssClass="datepicker" placeholder="DD/MM/YYYY" OnTextChanged="txtdtpayment_TextChanged" AutoPostBack="true"></asp:TextBox>
