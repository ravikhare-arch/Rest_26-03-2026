...
public partial class tbus_booking_list : System.Web.UI.Page
{
    static tbusbooking_Class objClass = new tbusbooking_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor, string AgentID)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.InvoiceNo = dt.Rows[i]["sBusBookingNo"].ToString();
                ...
                magentobj.TicketID = dt.Rows[i]["nBusBookingID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        getdtdata.Columns.Remove("nBusBookingID");
        getdtdata.Columns.Remove("sBookType");
        ...
        try
        {
            ...
            #region start code
            var fileName = "Bus-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/Bus.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Bus - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Bus "; // Heading Name               
                worksheet.Cells[4, 1, 4, 11].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sBusBookingNo"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Bus.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Bus.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Bus</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns["sBusBookingNo"].ColumnName = "Invoice No";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            mm.Subject = "Bus PDF";
                            mm.Body = "Bus PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "Bus.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tbus_booking.aspx");
    }
