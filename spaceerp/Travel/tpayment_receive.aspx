<%@ Page Title="PAYMENT RECEIVE" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tpayment_receive.aspx.cs" Inherits="Transcation_payment_voucher" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">PAYMENT RECEIVE </h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                                ...
                                <div>
                                    <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-3 col-sm-3 ">
                                            ...
                                            <asp:DropDownList ID="ddlClient" runat="server" Width="100%" CssClass="form-control js-example-placeholder-single" AutoPostBack="true" OnSelectedIndexChanged="ddlClient_SelectedIndexChanged">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlClient" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                        ...
                                        <div class="col-md-3 col-sm-2" style="z-index: 99;">
                                            ...
                                            <asp:TextBox ID="txtdtPaymentVoucher" runat="server" Width="100%" CssClass="datepicker" OnTextChanged="txtdtPaymentVoucher_TextChanged" AutoPostBack="true" placeholder="DD/MM/YYYY"></asp:TextBox>
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            <asp:GridView ID="GridView3" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="nSellingRate" HeaderText="Amount" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <asp:GridView ID="GridView2" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                                DataKeyNames="nPaymentReceiveDetID" Width="100%" AllowPaging="false" AllowSorting="True" EmptyDataText="No Records to display"
                                                OnRowDataBound="GridView2_RowDataBound">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="nPaymentReceiveDetID" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPaymentDetID" runat="server" Text='<%# Eval("nPaymentReceiveDetID") %>'></asp:Label>
                                                            ...
                                                            <asp:Label ID="lblPaymentRecID" runat="server" Text='<%# Eval("nPaymentReceiveID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:BoundField DataField="nSellingRate" HeaderText="Selling Rate" />
                                                    <asp:BoundField DataField="nBalance" HeaderText="Due Amount" />
                                                     <asp:TemplateField HeaderText="Payment Value" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtBalance" Text='<%# Eval("nBalance") %>' runat="server"></asp:TextBox>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="nPaymentReceiveID" Width="95%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
                                    OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="nPaymentReceiveID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nPaymentReceiveID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="sAgencyName" HeaderText="Agent Name" />
