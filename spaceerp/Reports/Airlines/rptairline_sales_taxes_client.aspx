<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptairline_sales_taxes_client.aspx.cs" Inherits="Travel_TicketInvoice" %>
                            ...
                            <tr>
                                <td colspan="8">
                                    ...
                                    <h3 style="margin-left: 322px;">
                                        ...
                                        AIRLINE TAXES OF  <asp:Label ID="lblVType" runat="server"></asp:Label></h3>
                                </td>
                                <td colspan="8">
