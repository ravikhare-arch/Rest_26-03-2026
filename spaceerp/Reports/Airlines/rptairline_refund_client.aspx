<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptairline_refund_client.aspx.cs" Inherits="Travel_TicketInvoice" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Airline Refund Report</title>
    <meta charset="utf-8" />
...
<body>
 ...
 AIRLINE REFUND OF  <asp:Label ID="lblVType" runat="server"></asp:Label></h3>
                                </td>
                                <td colspan="8" style="text-align: right;">

                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="tairline_reports.aspx?ReportFor=AirlineRefund" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>AIRLINE</strong></td>
                        ...
                        <tbody>
                            ...
                            <tr style="border: 2px solid black;background-color:lightgray; font-weight: bold">
                                <td class="thick-line" colspan="2">GRAND TOTAL(INR)</td>
                                <td class="thick-line text-center">
