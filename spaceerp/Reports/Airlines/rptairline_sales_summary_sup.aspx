<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptairline_sales_summary_sup.aspx.cs" Inherits="Travel_TicketInvoice" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Airline Summary</title>
    <meta charset="utf-8" />
                                ...
                                <td colspan="8">
                                    ...
                                    <h3 style="margin-left: 322px;">
                                       <h3 style="margin-left: 322px;">
                                        ...
                                        AIRLINE SALES SUMMARY OF  <asp:Label ID="lblVType" runat="server"></asp:Label></h3></h3>
                                </td>
                                <td colspan="8">

                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="tairline_reports.aspx?ReportFor=AirlineSummery" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
