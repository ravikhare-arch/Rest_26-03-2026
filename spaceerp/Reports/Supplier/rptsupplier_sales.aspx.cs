...
public partial class Travel_TicketInvoice : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            objClassdet.sAirPNR = Request.QueryString["AccountID"].ToString();
    ...
    public void GetSupFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            double OtrTax = dt.Select().Sum(p => Convert.ToDouble(p["nSupOtrCharges"]));
            ...
            double TotRefunds = dt.Select().Sum(p => Convert.ToDouble(p["nSupplierRefund"]));
