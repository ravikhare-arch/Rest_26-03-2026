<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsupplier_sales.aspx.cs" Inherits="Travel_TicketInvoice" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Supplier Sales Statement</title>
    <meta charset="utf-8" />
...
<body>
 ...
 SALES REPORT OF <asp:Label ID="lblVType" runat="server"></asp:Label></h3>
                                </td>
                                <td colspan="8">

                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="Customer_Sales.aspx?ReportFor=AirlineSales" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr style="border-bottom: 2px solid black;">
                                ...
                                <td class="text-center"><strong>SALES TYPE</strong></td>
                                <td class="text-center"><strong>BASE FARE</strong></td>
                            
                                <td class="text-center"><strong>SC</strong></td>
                                <td class="text-center"><strong>DISC  %</strong></td>
                                <td class="text-center"><strong>TDS</strong></td>
                                <td class="text-center"><strong>OTR CHRG</strong></td>
                                <td class="text-center"><strong>SGST</strong></td>
                                <td class="text-center"><strong>CGST</strong></td>
                                <td class="text-center"><strong>IGST</strong></td>
                        ...
                        <tbody>
                            ...
                            <asp:Repeater ID="rptInvSup" runat="server">
                                <ItemTemplate>
                                    <tr>
                                       <td class="text-left">
                                            <%# validation.TextToDate( Eval("sInvoiceDate").ToString()) %>
                                        </td>
                                        <td class="text-center">
                                            <%# Eval("sInvoice") %>
                                        </td>
                            ...
                            <tr style="border: 2px solid black; font-weight: bold">
                                ...
                                <td class="thick-line text-center">
                                    <asp:Label ID="TotRefund" runat="server"></asp:Label>
                                </td>
