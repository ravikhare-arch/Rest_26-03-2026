<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptclient_sales.aspx.cs" Inherits="Travel_TicketInvoice" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cleint Sales Statement</title>
    <meta charset="utf-8" />
...
<body>
 ...
 SALES REPORT OF <asp:Label ID="lblVType" runat="server"></asp:Label></h3>
                                ...
                                <td colspan="8">
                                    ...
                                    <span style="float: right; margin-left: 45px" id="hidePrint" runat="server"><a href="Customer_Sales.aspx" class="btn btn-sm btn-default m-b-10 p-l-5" id="btnhome"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i>Home</a>
