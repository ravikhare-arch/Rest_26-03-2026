<%@ Page Title="" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="Customer_Sales.aspx.cs" Inherits="Reports_Customers_Customer_Sales" %>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        <div class="panel-heading-btn pull-left">
                            <asp:RadioButtonList ID="optReport" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" cssclass="text-white">
                        ...
                        <h4 class="panel-title text-center">Customer Sales Reports</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                                        ...
                                        <div class="form-group row m-b-15">
                                            <div class="col-md-3 col-sm-3">
                                                ...
                                                <asp:DropDownList ID="ddlReportFor" runat="server" CssClass="form-control js-example-placeholder-single" AutoPostBack="true" OnSelectedIndexChanged="ddlReportFor_SelectedIndexChanged">
                                                    ...
                                                    <asp:ListItem Text="All Client" Value="1"></asp:ListItem>
