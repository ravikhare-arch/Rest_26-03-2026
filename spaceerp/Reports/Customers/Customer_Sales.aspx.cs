...
public partial class Reports_Customers_Customer_Sales : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ObjAcc.ddlOperation(ObjAcc, "ddlAccType", "3", ddlAccountTitle);
    ...
    {
        Response.Redirect("rptclient_sales.aspx?AccountID=" + ddlAccountTitle.SelectedValue +  "&SalesType=" +  ddlAccType.SelectedValue+"&Branches=" +ddlBranches.SelectedValue+"&dtFrom=" + txtdtFrom.Text + "&dtTo=" + txtdtToDate.Text );
