...
public partial class tsalesdebitnote_list : System.Web.UI.Page
{
    static tsalesdebitnote_Class objClass = new tsalesdebitnote_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                magentobj.SalesDebitNoteID =dt.Rows[i]["nSalesDebitNoteID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "Sales Debit Note -" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/SalesDebitNote.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Sales Debit Note - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Sales Debit Note "; // Heading Name               
                worksheet.Cells[4, 1, 4, 6].Merge = true; //Merge columns start and end range
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SalesDebitNote.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=SalesDebitNote.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Sales Debit Note</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns.Remove("nSalesDebitNoteID");
    ...
    protected void btnsendmail_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rbexcel.Checked)
            {
                ...
                var fileName = "SalesDebitNote-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
                ...
                {
                    /////  // add a new worksheet to the empty workbook
                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("SalesDebitNote - " + DateTime.Now.ToShortDateString());
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            MailMessage mm = new MailMessage("webflyzonet@gmail.com", vto);
                            mm.Subject = "Sales Debit Note PDF";
                            mm.Body = "Sales Debit Note PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "SalesDebitNote.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tsalesdebitnote.aspx");
    }
