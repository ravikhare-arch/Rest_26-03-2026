<%@ Page Title="Purchase Return Invoice" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tpurchasereturninvoice.aspx.cs" Inherits="Transcation_tpurchasereturninvoice" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title text-center">Purchase Return Invoice</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        <div class="form-group row m-b-20">
            ...
            <div class="col-md-3 col-sm-3">
                <label class="col-form-label" for="fullname">Purchase Order No.  :</label>
