<%@ Page Title="Sales Invoice" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tsoinvoice_list.aspx.cs" Inherits="tpoinvoice_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Sales Invoice </h4>
  ...
  <div class="modal-dialog  modal-dialog-centered" role="document">
    ...
    <script type="text/javascript">
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        window.location.href = "../TradeInventory/tsoinvoice.aspx?" + datastring + "";
                    }
                });
            });
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("tsoinvoice_list.aspx/loaddata") %>',
                type: "post",
                ...
                success: function (mainlist) {
                    ...
                    for (i = 0; i < mainlist.d.mpagemasterobjlist.length; i++) {
                        ...
                        html += '<tr>';
                        html += '<td >' + vcount + '</td>';
                        html += '<td >' + mainlist.d.mpagemasterobjlist[i].SOInvoiceNo + '</td>';
                        html += '<td >' + mainlist.d.mpagemasterobjlist[i].SOInvoiceDate + '</td>';
                        ...
                        html += '<td style="display:none;" >' + mainlist.d.mpagemasterobjlist[i].SOInvoiceID + '</td>';
                        html += '</tr>';
                    }
