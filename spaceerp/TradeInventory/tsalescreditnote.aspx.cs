...
public partial class Transcation_tsalescreditnote : System.Web.UI.Page
{
    tsalescreditnote_Class objClass = new tsalescreditnote_Class();
    ...
    {
        ViewState["tsalescreditnote"] = Session["tsalescreditnote"];
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["tsalescreditnote"].ToString() == ViewState["tsalescreditnote"].ToString())
            {
                para();
    ...
    {
        Response.Redirect("tsalescreditnote_list.aspx");
    }
