<%@ Page Title="Sales Order" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tsalesorder.aspx.cs" Inherits="Transcation_salesorder" %>
                                ...
                                <ContentTemplate>
                                    <div class="form-group row m-b-0">
                                        ...
                                        <div class="col-md-3 col-sm-2">
                                            ...
                                            <asp:TextBox CssClass="form-control" ID="txtSalesOrderNo" runat="server" Width="100%" required Enabled="false"> </asp:TextBox>
                                        ...
                                        <div class="col-md-2 col-sm-2" style="z-index:100">
                                            ...
                                            <div>
                                                ...
                                                <asp:TextBox CssClass="form-control" ID="txttSalesOrder" runat="server" Width="100%" AutoPostBack="true" OnTextChanged="txttSalesOrder_TextChanged"></asp:TextBox>
                                        ...
                                        <div class="col-md-3 col-sm-2">
                                            ...
                                            <asp:DropDownList Width="100%" CssClass="form-control" ID="ddlLocation" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                                ...
                                <ContentTemplate>
                                    <div class="form-group row m-b-0">
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="ddlCustomerName" ErrorMessage="Please fill out this field." Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                        ...
                                        <div class="col-md-1 col-sm-1">
                                            ...
                                            <asp:CheckBox ID="chkAttantion" runat="server" CssClass="form-control" OnCheckedChanged="chkAttantion_CheckedChanged" AutoPostBack="true" />
                                        ...
                                        <div class="col-md-1 col-sm-1">
                                            ...
                                            <asp:CheckBox ID="chkNote" runat="server" CssClass="form-control" OnCheckedChanged="chkNote_CheckedChanged" AutoPostBack="true" />


                                        </div>
                                        <div class="col-md-2 col-sm-2">
                                            <label class="col-form-label" for="fullname">Note :</label>
                                            <asp:TextBox ID="txtNote" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <ContentTemplate>
                                        <div class="form-group row m-b-0">
                                            ...
                                            <div class="col-md-2 col-sm-2">
                                                ...
                                                <asp:DropDownList width="100%" ID="ddlUnit" CssClass="form-control"  runat="server" Enabled="False"></asp:DropDownList>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                    ...
                                    <ContentTemplate>
                                        <div class="form-group row m-b-15">
                                            ...
                                            <div class="col-md-3 col-sm-3">
                                                ...
                                                <asp:DropDownList width="100%" ID="ddlTaxType" CssClass="form-control"  Enabled="false" runat="server">
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nSalesOrderID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nSalesOrderID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nSalesOrderID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sSalesOrderNo" HeaderText="Sales Order No" />

                <asp:TemplateField HeaderText="Sales Order Date">
                    <ItemTemplate>
                        <%#validation.TextToDate(Eval("dtSalesOrder").ToString())%>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sAccountTitle" HeaderText="CustomerName" />
                ...
                <asp:BoundField DataField="sReferenceNo" HeaderText="ReferenceNo" />
