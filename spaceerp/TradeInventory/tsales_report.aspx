<%@ Page Title="" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tsales_report.aspx.cs" Inherits="Accounting_ttrailbalance" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Sales Report Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                            ...
                            <ContentTemplate>
                                <div class="form-group row m-b-15">
                                    <div class="col-md-3 col-sm-3">
                                        ...
                                        <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control js-example-placeholder-single" AutoPostBack="True" OnSelectedIndexChanged="ddlReportType_SelectedIndexChanged">
                                            <asp:ListItem Text="Select Report" Value="0"></asp:ListItem>
                                            <asp:ListItem Text=" Sales Report Detail " Value="1"></asp:ListItem>
                                            <asp:ListItem Text=" Sales Report Customer Wise " Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        ...
                                        <asp:DropDownList ID="ddlCustomer" Enabled="false" runat="server" CssClass="form-control js-example-placeholder-single">
                                        </asp:DropDownList>
                                    </div>
