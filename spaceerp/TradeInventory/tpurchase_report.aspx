<%@ Page Title="" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tpurchase_report.aspx.cs" Inherits="trading_purchase_item" %>
                        ...
                        <div class="form-group row m-b-15">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control js-example-placeholder-single">
                                    ...
                                    <asp:ListItem Text=" Purchase Report Detail " Value="1"></asp:ListItem>
                                    <asp:ListItem Text=" Purchase Report Vendor Wise " Value="2"></asp:ListItem>
                                </asp:DropDownList>
