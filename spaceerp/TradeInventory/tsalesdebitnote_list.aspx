<%@ Page Title="Sales Debit Note" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tsalesdebitnote_list.aspx.cs" Inherits="tsalesdebitnote_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Sales Debit Note</h4>
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Sales Debit Note  </b></h4>
                    <h4>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridViewexcel" CssClass="table" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="sSalesDebitNoteNo" HeaderText="Debit Note No" />
    ...
    <script type="text/javascript">                                                                                           
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        window.location.href = "../tradeinventory/tsalesdebitnote.aspx?" + datastring + "";
                    }
                });
            });
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("tsalesdebitnote_list.aspx/loaddata") %>',
                type: "post",
