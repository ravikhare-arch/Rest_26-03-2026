...
public partial class Transcation_tpurchasecreditnote : System.Web.UI.Page
{
    tpurhcasecreditnote_Class objClass  = new tpurhcasecreditnote_Class();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                Session["tpurhcasecreditnote"] = aa;
    ...
    {
        ViewState["tpurhcasecreditnote"] = Session["tpurhcasecreditnote"];
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["tpurhcasecreditnote"].ToString() == ViewState["tpurhcasecreditnote"].ToString())
            {
                para();
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            para();
            objClass.PurchaseCreditNoteID = Session["eid"].ToString();
    ...
    {
        Response.Redirect("tpurchasecreditnote_list.aspx");
    }
