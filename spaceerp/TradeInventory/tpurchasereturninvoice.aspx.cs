...
public partial class Transcation_tpurchasereturninvoice : System.Web.UI.Page
{
    tpurhcasereturninvoice_Class objClass = new tpurhcasereturninvoice_Class();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                Session["tpurchasereturninvoice"] = aa;
    ...
    {
        ViewState["tpurchasereturninvoice"] = Session["tpurchasereturninvoice"];
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["tpurchasereturninvoice"].ToString() == ViewState["tpurchasereturninvoice"].ToString())
            {
                para();
    ...
    {
        Response.Redirect("tpurchasereturninvoice_list.aspx");
    }
