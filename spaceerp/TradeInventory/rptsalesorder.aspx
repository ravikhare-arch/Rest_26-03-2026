<%@ Page Title="" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptsalesorder.aspx.cs" Inherits="Tradding_rptpo" %>
        ...
        <div class="row nopad">
            ...
            <div class="col-md-6">
                <div class="quotebg">
                    ...
                    <h1 class="centered">
                           <asp:Label ID="lblVoucherType" runat="server" Text="Sales Order"></asp:Label></h1>
                </div>
                ...
                <div>
                    <table class="table table-invoice" cellspacing="0" rules="all" border="1" style="width: 100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                   <asp:Label ID="lblDelivertDate" runat="server"></asp:Label>
                                <td>30 Days</td>
                                <td>
            ...
            <div class="invoice-content">
                ...
                <div class="table-responsive bg-white">
                    <asp:GridView ID="GridView1" CssClass="table table-invoice" runat="server"
                        AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nSalesOrderDetID"
                        Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25">
                        <Columns>
                            <asp:TemplateField HeaderText="nSalesOrderDetID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblID" runat="server" Text='<%# Eval("nSalesOrderDetID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
