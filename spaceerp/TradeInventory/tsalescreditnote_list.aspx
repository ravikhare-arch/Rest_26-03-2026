<%@ Page Title="Sales Credit Note" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tsalescreditnote_list.aspx.cs" Inherits="tsalescreditnote_list" %>
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Sales Credit Note  </b></h4>
                    <h4>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridViewexcel" CssClass="table" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="sSalesDebitNoteNo" HeaderText="Credit Note No" />
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        window.location.href = "../tradeinventory/tsalescreditnote.aspx?" + datastring + "";
                    }
                });
            });
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("tsalesdebitnote_list.aspx/DeleteVoucher") %>',
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("tsalescreditnote_list.aspx/loaddata") %>',
                type: "post",
