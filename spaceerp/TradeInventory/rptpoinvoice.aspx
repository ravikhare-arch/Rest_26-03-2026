<%@ Page Title="" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptpoinvoice.aspx.cs" Inherits="Tradding_rptpo" %>
        ...
        <div class="row nopad">
            ...
            <div class="col-md-7">
                <div class="quotebg">
                    ...
                    <h1 class="centered">                            
                    <asp:Label ID="lblVoucherType" runat="server" Text="Purchase Invoice"></asp:Label></h1>
                </div>
            ...
            <div class="invoice-content">
                ...
                <div class="table-responsive bg-white">
                   <asp:GridView ID="GridView1" CssClass="table table-invoice" runat="server"
                        AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nPoinvoiceDetID"
                        Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25">
                        <Columns>
                            <asp:TemplateField HeaderText="nPoinvoiceDetID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblID" runat="server" Text='<%# Eval("nPoinvoiceDetID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="nDicountPercent" HeaderText="Disc. %" />
                            <asp:BoundField DataField="nDiscountValue" HeaderText="Disc. Value" />
