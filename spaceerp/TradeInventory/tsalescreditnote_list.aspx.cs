...
public partial class tsalescreditnote_list : System.Web.UI.Page
{
    static tsalescreditnote_Class objClass = new tsalescreditnote_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.SalesDebitNoteNo = dt.Rows[i]["sSalesDebitNoteNo"].ToString();
                ...
                magentobj.SalesDebitNoteID =dt.Rows[i]["nSalesCreditNoteID"].ToString();
    ...
    public static string DeleteVoucher(string AccountLedgerID)
    {
        ...
        try
        {
            objClass.SalesDebitNoteID = AccountLedgerID;
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "Sales Credit Note -" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/SalesCreditNote.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Sales Credit Note - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Sales Credit Note "; // Heading Name               
                worksheet.Cells[4, 1, 4, 6].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sSalesDebitNoteNo"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SalesCreditNote.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=SalesCreditNote.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Sales Credit Note</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns.Remove("nSalesCreditNoteID");
        dt.Columns["sSalesDebitNoteNo"].ColumnName = "Debit Note No";
    ...
    protected void btnsendmail_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rbexcel.Checked)
            {
                ...
                var fileName = "SalesCreditNote-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
                ...
                {
                    /////  // add a new worksheet to the empty workbook
                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("SalesCreditNote - " + DateTime.Now.ToShortDateString());
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            MailMessage mm = new MailMessage("webflyzonet@gmail.com", vto);
                            mm.Subject = "Sales Credit Note PDF";
                            mm.Body = "Sales Credit Note PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "SalesCreditNote.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tsalescreditnote.aspx");
    }
