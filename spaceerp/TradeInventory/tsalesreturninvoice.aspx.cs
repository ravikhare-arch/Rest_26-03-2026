...
public partial class Transcation_tsalesreturninvoice : System.Web.UI.Page
{
    tsalesreturninvoice_Class objClass = new tsalesreturninvoice_Class();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                Session["tsalesreturninvoice"] = aa;
    ...
    {
        ViewState["tsalesreturninvoice"] = Session["tsalesreturninvoice"];
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["tsalesreturninvoice"].ToString() == ViewState["tsalesreturninvoice"].ToString())
            {
                para();
    ...
    {
        Response.Redirect("tsalesreturninvoice_list.aspx");
    }
