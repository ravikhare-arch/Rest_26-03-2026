<%@ Page Title="Purchase Return Invoice" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tpurchasereturninvoice_list.aspx.cs" Inherits="tpurchasereturninvoice_list" %>
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Purchase Return Invoice  </b></h4>
                    <h4>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridViewexcel" CssClass="table" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="sPurchaseReturnNo" HeaderText="Invoice No" />
    ...
    <script type="text/javascript">                                                                                           
        ...
        $(document.body).ready(function () {
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "tpurchasereturninvoice.aspx",
                    data: datastring,
                    cache: false,
                    success: function (html) {
                        window.location.href = "../tradeinventory/tpurchasereturninvoice.aspx?" + datastring + "";
                    }
                });
            });
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("tpurchasereturninvoice_list.aspx/DeleteVoucher") %>',
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("tpurchasereturninvoice_list.aspx/loaddata") %>',
                type: "post",
                ...
                success: function (mainlist) {
                    ...
                    for (i = 0; i < mainlist.d.mpagemasterobjlist.length; i++) {
                        ...
                        html += '<td >' + '<a href="tpurchasereturninvoice.aspx" class="editbtn" title="Edit"><i class="glyphicon glyphicon-edit" style="color: green" ></i></a>&nbsp;&nbsp;&nbsp;<a href="#" class="deletebtn" title="Delete" data-toggle="modal" data-target="#deleteModalCenter"><i class="glyphicon glyphicon-trash" style="color: red"></i></a>' + '</td>';
