<%@ Page Title="Sales Order Details" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tsalesorder_list.aspx.cs" Inherits="tsalesorder_list" %>
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Sales Order  </b></h4>
                    <h4>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridViewexcel" CssClass="table" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="sSalesOrderNo" HeaderText="Invoice No" />
                            ...
                            <asp:BoundField DataField="sAccountTitle" HeaderText="Customer Name" />
                             <asp:BoundField DataField="sLocationName" HeaderText="Location Name" />
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "tsalesorder.aspx",
                    data: datastring,
                    cache: false,
                    success: function (html) {
                        window.location.href = "../TradeInventory/tsalesorder.aspx?" + datastring + "";
                    }
                });
            });
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("tsalesorder_list.aspx/DeleteVoucher") %>',
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("tsalesorder_list.aspx/loaddata") %>',
                type: "post",
                data: JSON.stringify({ fromdate: fromdate, todate: todate, Reportfor: Reportfor }),
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (mainlist) {
                    var html = "<table id='tblagentlist' class='table table-striped table-bordered table-responsive' style='width:100%'><thead><td style='width:2%'>Sr No.</td><td>Sales Order No</td><td>Sales Order Date</td><td>Delivery Date</td><td>Customer Name </td><td>Location </td><td>Reference Number </td><td style='width:3%'>Edit/Delete</td><td style='display:none'>TicketID</td></tr></thead><tbody>";
                    var vcount = 0;
                    for (i = 0; i < mainlist.d.mpagemasterobjlist.length; i++) {
                        ...
                        html += '<td >' + mainlist.d.mpagemasterobjlist[i].LocationName + '</td>';
                        html += '<td >' + mainlist.d.mpagemasterobjlist[i].RefernceNumber + '</td>';
                        html += '<td >' + '<a href="tsalesorder.aspx" class="editbtn" title="Edit"><i class="glyphicon glyphicon-edit" style="color: green" ></i></a>&nbsp;&nbsp;&nbsp;<a href="#" class="deletebtn" title="Delete" data-toggle="modal" data-target="#deleteModalCenter"><i class="glyphicon glyphicon-trash" style="color: red"></i></a>' + '</td>';
