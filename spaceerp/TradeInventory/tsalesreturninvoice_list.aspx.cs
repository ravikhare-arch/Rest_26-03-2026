...
public partial class tsalesreturninvoice_list : System.Web.UI.Page
{
    static tsalesreturninvoice_Class objClass = new tsalesreturninvoice_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.SalesDebitNoteNo = dt.Rows[i]["sSalesReturnNo"].ToString();
                ...
                magentobj.SalesDebitNoteID =dt.Rows[i]["nSalesReturnInvoiceID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "Sales Return Invoice -" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/SalesReturnInvoice.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Sales Return Invoice - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Sales Return Invoice "; // Heading Name               
                worksheet.Cells[4, 1, 4, 6].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sSalesReturnNo"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SalesReturnInvoice.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=SalesReturnInvoice.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Sales Return Invoice</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns.Remove("nSalesReturnInvoiceID");
        dt.Columns["sSalesReturnNo"].ColumnName = "Debit Note No";
    ...
    {
        Response.Redirect("tsalesreturninvoice.aspx");
    }
