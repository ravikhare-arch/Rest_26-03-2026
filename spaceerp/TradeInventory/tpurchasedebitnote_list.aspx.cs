...
public partial class tpurchasedebitnote_list : System.Web.UI.Page
{
    static tpurhcasedebitnote_Class objClass = new tpurhcasedebitnote_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.SalesDebitNoteNo = dt.Rows[i]["sPurchaseDebitNoteNo"].ToString();
                ...
                magentobj.SalesDebitNoteID =dt.Rows[i]["nPurchaseDebitNoteID"].ToString();
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "Purchase Debit Note -" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/PurchaseDebitNote.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Purchase Debit Note - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Purchase Debit Note "; // Heading Name               
                worksheet.Cells[4, 1, 4, 6].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sPurchaseDebitNoteNo"].ToString();
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PurchaseDebitNote.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=PurchaseDebitNote.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Purchase Debit Note</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns.Remove("nPurchaseDebitNoteID");
        dt.Columns["sPurchaseDebitNoteNo"].ColumnName = "Debit Note No";
        ...
        try
        {
            if (rbexcel.Checked)
            {
               ...
               objClass.EndDate = validation.dateToText(txttLastOrder.Text);
                ...
                var fileName = "PurchaseDebitNote-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
                ...
                {
                    /////  // add a new worksheet to the empty workbook
                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("PurchaseDebitNote - " + DateTime.Now.ToShortDateString());
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            MailMessage mm = new MailMessage("webflyzonet@gmail.com", vto);
                            mm.Subject = "Purchase Debit Note PDF";
                            mm.Body = "Purchase Debit Note PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "PurchaseDebitNote.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tpurchasedebitnote.aspx");
    }
