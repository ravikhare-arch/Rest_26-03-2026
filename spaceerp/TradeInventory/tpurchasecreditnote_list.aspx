<%@ Page Title="Purchase Credit Note" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tpurchasecreditnote_list.aspx.cs" Inherits="tpurchasecreditnote_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Purhcase Credit Note</h4>
        ...
        <div class="invoice" id="scndgrddiv" runat="server">
            ...
            <div class="invoice-company text-inverse f-w-600">
                ...
                <div class="text-center" style="text-align: center">
                    <h4 style="font-family: Calibri;"><b>Ledger Name :- Purchase Credit Note  </b></h4>
                    <h4>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GridViewexcel" CssClass="table" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="sPurchaseCreditNoteNo" HeaderText="Debit Note No" />
    ...
    <script type="text/javascript">                                                                                           
        ...
        $(document.body).ready(function () {
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "tpurchasecreditnote.aspx",
                    data: datastring,
                    cache: false,
                    success: function (html) {
                        window.location.href = "../tradeinventory/tpurchasecreditnote.aspx?" + datastring + "";
                    }
                });
            });
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("tpurchasecreditnote_list.aspx/DeleteVoucher") %>',
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("tpurchasecreditnote_list.aspx/loaddata") %>',
                type: "post",
                ...
                success: function (mainlist) {
                    ...
                    for (i = 0; i < mainlist.d.mpagemasterobjlist.length; i++) {
                        ...
                        html += '<td >' + '<a href="tsalesdebitnote.aspx" class="editbtn" title="Edit"><i class="glyphicon glyphicon-edit" style="color: green" data-toggle="modal" data-target="#exampleModalCenter"></i></a>&nbsp;&nbsp;&nbsp;<a href="#" class="deletebtn" title="Delete" data-toggle="modal" data-target="#deleteModalCenter"><i class="glyphicon glyphicon-trash" style="color: red"></i></a>' + '</td>';
