...
public partial class tpurchasecreditnote_list : System.Web.UI.Page
{
    static tpurhcasecreditnote_Class objClass = new tpurhcasecreditnote_Class();
    ...
    public static mpagemasterlist loaddata(string fromdate, string todate, string Reportfor)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.SalesDebitNoteNo = dt.Rows[i]["sPurchaseCreditNoteNo"].ToString();
                ...
                magentobj.SalesDebitNoteID =dt.Rows[i]["nPurchaseCreditNoteID"].ToString();
    ...
    public static string DeleteVoucher(string AccountLedgerID)
    {
        ...
        try
        {
            objClass.PurchaseCreditNoteID = AccountLedgerID;
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "Purchase Credit Note -" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/PurchaseCreditNote.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Purchase Credit Note - " + DateTime.Now.ToShortDateString());
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PurchaseCreditNote.xlsx");
    ...
    protected void btnpdf_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=PurchaseCreditNote.pdf");
    ...
    protected string ExportDatatableToHtml(DataTable dt)
    {
        ...
        //}
        strHTMLBuilder.Append("<head style='background: #1abc9c;border-style: groove;' ><h1 style=' text-align: center;font-style: Latin;'>Supplier Name: Alnasa Technology</h1><p style='color: gray;text-align: center'> Report :- Purchase Credit Note</p><br><p style='color: gray;text-align: center'> Agency Name :- " + AgentName + "</p><br>");
        ...
        dt.Columns.Remove("nPurchaseCreditNoteID");
        dt.Columns["sPurchaseCreditNoteNo"].ColumnName = "Debit Note No";
    ...
    protected void btnsendmail_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (rbexcel.Checked)
            {
                ...
                var fileName = "PurchaseCreditNote-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
                ...
                {
                    /////  // add a new worksheet to the empty workbook
                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("PurchaseCreditNote - " + DateTime.Now.ToShortDateString());
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            MailMessage mm = new MailMessage("webflyzonet@gmail.com", vto);
                            mm.Subject = "Purchase Credit Note PDF";
                            mm.Body = "Purchase Credit Note PDF Attachment";
                            mm.Attachments.Add(new Attachment(new MemoryStream(bytes), "PurchaseCreditNote.pdf"));
                            mm.IsBodyHtml = true;
    ...
    {
        Response.Redirect("tpurchasecreditnote.aspx");
    }
