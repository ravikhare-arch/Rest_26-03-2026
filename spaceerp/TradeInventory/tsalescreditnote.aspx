<%@ Page Title="Sales Credit Note" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tsalescreditnote.aspx.cs" Inherits="Transcation_tsalescreditnote" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title text-center">Sales Credit Note</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                        ...
                        <div>                            
                                    <div class="form-group row m-b-0">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            ...
                                            <asp:TextBox CssClass="form-control" ID="txtgsttype" runat="server" Width="100%" required> </asp:TextBox>
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtgsttype" ErrorMessage="Please fill out this field." Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                         ...
                                         <div class="col-md-2 col-sm-3">
                                            ...
                                            <asp:RequiredFieldValidator ID="RFV3" runat="server" ControlToValidate="ddlClient" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-2 col-sm-3">
                                            <label class="col-form-label" for="fullname">
                                                Branch   * :
                                        ...
                                        <div class="col-md-2 col-sm-2" style="z-index:100">
                                            ...
                                            <div>
                                                ...
                                                <asp:TextBox CssClass="form-control" ID="tsalesdebitnotedate" runat="server" Width="100%" ></asp:TextBox>

                                                <asp:RegularExpressionValidator ID="REV4" ControlToValidate="tsalesdebitnotedate"
                                                ...
                                                <AjaxToolKit:CalendarExtender ID="CalendarExtender4" runat="server" Format="dd/MM/yyyy"
                                                    PopupButtonID="tsalesdebitnotedate" TargetControlID="tsalesdebitnotedate" PopupPosition="BottomLeft" />

                                                <AjaxToolKit:MaskedEditExtender ID="MEE4" runat="server"
                                                    TargetControlID="tsalesdebitnotedate" Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                         ...
                                         <div class="col-md-2 col-sm-2">
                                            ...
                                            <asp:TextBox CssClass="form-control" ID="treferencedate" runat="server" Width="100%"></asp:TextBox>

                                            <asp:RegularExpressionValidator ID="REV5" ControlToValidate="treferencedate"
                                                ValidationGroup="A" Display="Dynamic" SetFocusOnError="true" runat="server" ErrorMessage="Invalid Date"
                                                ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d"> 
                                            </asp:RegularExpressionValidator>

                                            <AjaxToolKit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy"
                                                PopupButtonID="treferencedate" TargetControlID="treferencedate" PopupPosition="TopLeft" />

                                            <AjaxToolKit:MaskedEditExtender ID="MEE5" runat="server"
                                                TargetControlID="treferencedate" Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                    ...
                                    <div class="form-group row m-b-0">
                                         <div class="col-md-2 col-sm-3">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlAgentID" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-2 col-sm-3">
                                      ...
                                      <div class="col-md-2 col-sm-2" style="z-index:100">
                                        ...
                                        <div class="col-md-2 col-sm-3">
                                            ...
                                            <asp:TextBox CssClass="form-control" ID="txtcurrency" runat="server" Width="100%" ></asp:TextBox>
                                      ...
                                      <div class="col-md-2 col-sm-2" style="z-index:100">
                                            ...
                                            <div>
                                                ...
                                                <AjaxToolKit:CalendarExtender ID="CalendarExtender8" runat="server" Format="dd/MM/yyyy"
                                                    PopupButtonID="txtduedate" TargetControlID="txtduedate" PopupPosition="BottomLeft" />
                                                        ...
                                                        <fieldset class="the-fieldset">
                                                           <div class="form-group row">
                                                                ...
                                                                <div class="col-md-4 col-sm-4">
                                                                    ...
                                                                    <asp:TextBox ID="txtClntCgst" CssClass="form-control" runat="server" Width="100%" Text="0" Enabled="false"></asp:TextBox>
                                                                ...
                                                                <div class="col-md-4 col-sm-4">
                                                                    ...
                                                                    <asp:TextBox ID="txtClntSgst" CssClass="form-control" runat="server" Width="100%" Text="0" Enabled="false"></asp:TextBox>
