<%@ Page Title="Company Master" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="CompanyMaster.aspx.cs" Inherits="CompanyMaster" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Company Master </h4>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="panel-body">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="form-1-3" class="col-md-4 control-label">Company Name</label>
                                                                <div class="col-md-8">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="form-1-3" class="col-md-4 control-label">Address</label>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtaddress" CssClass="form-control" runat="server"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                    <div class="form-group row">
                                                                <label for="form-1-3" class="col-md-4 control-label">City</label>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtcity" CssClass="form-control" runat="server"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                    <div class="form-group row">
                                                                <label for="form-1-3" class="col-md-4 control-label">Pin Code</label>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtpincode" CssClass="form-control" runat="server"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                    <div class="form-group row">
                                                                <label for="form-1-3" class="col-md-4 control-label">Contact No</label>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtcontactno" CssClass="form-control" runat="server"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                    <div class="form-group row">
                                                                <label for="form-1-3" class="col-md-4 control-label">GST No</label>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtgstnumber" CssClass="form-control" runat="server"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="form-1-3" class="col-md-4 control-label">Captain Name</label>
                                                                <div class="col-md-8">
                                                                    <asp:TextBox ID="txtcaptainname" CssClass="form-control" runat="server"></asp:TextBox>
                                                                </div>
    ...
    <div class="modal fade" id="deleteModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-keyboard="false">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="background: #C0C0C0">
                <div class="modal-header">
                    <h5 class="modal-title" id="delModalLongTitle" style="color: white">Company Master</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $("#btnadd").on("click", function () {
                if (validatedata()) {
                    var obj = {
                        Name: $("#ctl00_ContentPlaceHolder1_txtcompanyname").val(),
                        ...
                        GSTNo: $("#ctl00_ContentPlaceHolder1_txtgstnumber").val(),
                        CaptainName: $("#ctl00_ContentPlaceHolder1_txtcaptainname").val(),
                    }

                    $.ajax({
                        url: '<%=ResolveUrl("CompanyMaster.aspx/addPagePamster") %>',
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("CompanyMaster.aspx/DeletePageMaster") %>',
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $("#ctl00_ContentPlaceHolder1_txtcompanyname").val($(this).closest('tr').find('td:eq(1)').text());
                $("#ctl00_ContentPlaceHolder1_txtaddress").val($(this).closest('tr').find('td:eq(2)').text());
                $("#ctl00_ContentPlaceHolder1_txtcity").val($(this).closest('tr').find('td:eq(3)').text());
                $("#ctl00_ContentPlaceHolder1_txtpincode").val($(this).closest('tr').find('td:eq(4)').text());
                $("#ctl00_ContentPlaceHolder1_txtcontactno").val($(this).closest('tr').find('td:eq(5)').text());
                $("#ctl00_ContentPlaceHolder1_txtgstnumber").val($(this).closest('tr').find('td:eq(6)').text());
                $("#ctl00_ContentPlaceHolder1_txtcaptainname").val($(this).closest('tr').find('td:eq(7)').text());
            ...
            $(document.body).on("click", "#btnupdate", function () {
                var obj = {
                    ...
                    GSTNo: $("#ctl00_ContentPlaceHolder1_txtgstnumber").val(),
                    CaptainName: $("#ctl00_ContentPlaceHolder1_txtcaptainname").val(),
                    CompanyID: $("#accountledgerid").val(),
                }

                $.ajax({
                    url: '<%=ResolveUrl("CompanyMaster.aspx/UpdatePageMaster") %>',
                    data: JSON.stringify({ list: obj }),
                    type: "post",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
        ...
        function cleardata() {
            ...
            $("#ctl00_ContentPlaceHolder1_txttablename").val('')
            $("#ctl00_ContentPlaceHolder1_ddlarea").val('')
            $("#ctl00_ContentPlaceHolder1_txtcapacity").val('')
        }
        function validatedata() {
            var ledgername = document.getElementById("<%=txtcompanyname.ClientID %>").value;
        ...
        function loaddata() {
            $.ajax({
                url: '<%=ResolveUrl("CompanyMaster.aspx/loaddata") %>',
        type: "post",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        success: function (mainlist) {

            // --- DATA STORAGE LOGIC YAHAN HAI ---
            // Checking agar data properly aaya hai
            if (mainlist.d && mainlist.d.mpagemasterobjlist) {
                // Data ko pehle string mein convert kar lo taaki baar-baar JSON.stringify na likhna pade
                var companyDataString = JSON.stringify(mainlist.d.mpagemasterobjlist);

                // 1. Session Storage me save (Sirf is current tab ke liye)
                sessionStorage.setItem("CompanyListObj", companyDataString);

                // 2. Local Storage me save (Browser ke saare tabs ke liye)
                localStorage.setItem("CompanyListObj", companyDataString);

                console.log("Bhai, data dono jagah (Session aur Local) save ho gaya hai!");
            }
            // ------------------------------------

            var html = "<table id='tblagentlist' class='table table-striped table-bordered' style='width:100%'><thead><tr> <td style='width:2%'>Sr No.</td><td>Company Name</td><td>Address</td><td >City</td><td >PIN Code</td><td >Contact No</td><td >GST No</td><td >Captain Name</td><td style='width:3%'>Edit/Delete</td><td style='display:none'>Account LedgerID</td><td style='display:none'>Area ID</td></tr></thead><tbody>";
            var vcount = 0;
            for (i = 0; i < mainlist.d.mpagemasterobjlist.length; i++) {
                vcount = vcount + 1;
                html += '<tr>';
                html += '<td >' + vcount + '</td>';
                html += '<td >' + mainlist.d.mpagemasterobjlist[i].Name + '</td>';
                html += '<td >' + mainlist.d.mpagemasterobjlist[i].Address + '</td>';
                html += '<td >' + mainlist.d.mpagemasterobjlist[i].City + '</td>';
                html += '<td >' + mainlist.d.mpagemasterobjlist[i].PinCode + '</td>';
                html += '<td >' + mainlist.d.mpagemasterobjlist[i].Contactno + '</td>';
                html += '<td >' + mainlist.d.mpagemasterobjlist[i].GSTNo + '</td>';
                html += '<td >' + mainlist.d.mpagemasterobjlist[i].CaptainName + '</td>';
                ...
                html += '<td style="display:none">' + mainlist.d.mpagemasterobjlist[i].CompanyID + '</td>';
                html += '</tr>';
            }
