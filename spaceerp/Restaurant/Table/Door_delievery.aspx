...
<input type="hidden" runat="server" id="hdnApiurl" />
  <div class="col-md-12 well">
    ...
    <script src="../Agent/assets/plugins/dropdown-autocomplete/Scripts/jquery.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".spltab").click(function () {
             ...
             $.ajax({
                 type: "GET",
                 url: apiUrl+'/api/ItemGroupMasters',
                 dataType: "json", contentType: "application/json;charset=utf-8",
                 success: function (data) {
                     $.each(data, function (i) {
                         alert(data);
                         $("#Itemgroup").append(data[i].GroupName);
                     });
                 }
             });
        });
