<%@ Page Title="Item Group Master" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="ItemGroupMaster.aspx.cs" Inherits="ItemGroupMaster" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Item Group Master </h4>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Item Group Master</h5>
                                        ...
                                        <div class="col-md-12">
                                            <div class="">
                                                <div class="form-group row">
                                                    <label for="form-1-3" class="col-md-4 control-label">Group Name</label>
                                                    <div class="col-md-8">
    ...
    <div class="modal fade" id="deleteModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-keyboard="false">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="background: #C0C0C0">
                <div class="modal-header">
                    <h5 class="modal-title" id="delModalLongTitle" style="color: white">Group Master</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $("#btnadd").on("click", function () {
                if (validatedata()) {
                    var obj = {
                        MenuGroup: $("#ctl00_ContentPlaceHolder1_txtgroupname").val(),
                        
                    }

                    $.ajax({
                        url: '<%=ResolveUrl("ItemGroupMaster.aspx/addPagePamster") %>',
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("ItemGroupMaster.aspx/DeletePageMaster") %>',
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $("#ctl00_ContentPlaceHolder1_txtgroupname").val($(this).closest('tr').find('td:eq(1)').text());
            ...
            $(document.body).on("click", "#btnupdate", function () {
                var obj = {
                    MenuGroup: $("#ctl00_ContentPlaceHolder1_txtgroupname").val(),
                    MenuGroupID: $("#accountledgerid").val(),

                }

                $.ajax({
                    url: '<%=ResolveUrl("ItemGroupMaster.aspx/UpdatePageMaster") %>',
                    data: JSON.stringify({ list: obj }),
                    type: "post",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
        ...
        function cleardata() {
            ...
            $("#ctl00_ContentPlaceHolder1_txtgroupname").val('')
           
        }
        function validatedata() {
            var ledgername = document.getElementById("<%=txtgroupname.ClientID %>").value;
         ...
         function loaddata() {
             ...
             $.ajax({
                 url: '<%=ResolveUrl("ItemGroupMaster.aspx/loaddata") %>',
                type: "post",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (mainlist) {
                    var html = "<table id='tblagentlist' class='table table-striped table-bordered' style='width:100%'><thead><tr> <td style='width:2%'>Sr No.</td><td>Group Name</td><td style='width:3%'>Edit/Delete</td><td style='display:none'>Account LedgerID</td></tr></thead><tbody>";
                    var vcount = 0;
                    for (i = 0; i < mainlist.d.mpagemasterobjlist.length; i++) {
                        ...
                        html += '<tr>';
                        html += '<td >' + vcount + '</td>';
                        html += '<td >' + mainlist.d.mpagemasterobjlist[i].MenuGroup + '</td>';
                        html += '<td style="display:none" >' + mainlist.d.mpagemasterobjlist[i].MenuGroupID + '</td>';
