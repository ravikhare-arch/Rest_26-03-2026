<%@ Page Title="Area Master" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="AreaMaster.aspx.cs" Inherits="AreaMaster" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Area Master </h4>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Area Master</h5>
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group row">
                                                    <label for="form-1-3" class="col-md-4 control-label">Area Name</label>
                                                    <div class="col-md-8">
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $("#btnadd").on("click", function () {
                if (validatedata()) {
                    var obj = {
                        AreaName: $("#ctl00_ContentPlaceHolder1_txttablename").val(),
                        OrderType: $("#ctl00_ContentPlaceHolder1_ddlordertype").val(),
                    }

                    $.ajax({
                        url: '<%=ResolveUrl("AreaMaster.aspx/addPagePamster") %>',
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("AreaMaster.aspx/DeletePageMaster") %>',
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $("#ctl00_ContentPlaceHolder1_ddlordertype").val($(this).closest('tr').find('td:eq(5)').text());
            ...
            $(document.body).on("click", "#btnupdate", function () {
                var obj = {
                    AreaName: $("#ctl00_ContentPlaceHolder1_txttablename").val(),
                    OrderType: $("#ctl00_ContentPlaceHolder1_ddlordertype").val(),
                    AreaID: $("#accountledgerid").val(),

                }

                $.ajax({
                    url: '<%=ResolveUrl("AreaMaster.aspx/UpdatePageMaster") %>',
                    data: JSON.stringify({ list: obj }),
                    type: "post",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
        ...
        function validatedata() {
            var ledgername = document.getElementById("<%=txttablename.ClientID %>").value;
             var ordertype = document.getElementById("<%=ddlordertype.ClientID %>").value;
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("AreaMaster.aspx/loaddata") %>',
                 type: "post",
                 contentType: "application/json;charset=utf-8",
                 dataType: "json",
                 success: function (mainlist) {
                     var html = "<table id='tblagentlist' class='table table-striped table-bordered' style='width:100%'><thead><tr> <td style='width:2%'>Sr No.</td><td>Table Name</td><td >Order Type</td><td style='width:3%'>Edit/Delete</td><td style='display:none'>Account LedgerID</td></tr></thead><tbody>";
                     var vcount = 0;
                     for (i = 0; i < mainlist.d.mpagemasterobjlist.length; i++) {
                         ...
                         html += '<td style="display:none;" >' + mainlist.d.mpagemasterobjlist[i].OrderType + '</td>';
                         html += '</tr>';
