<%@ Page Title="module" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mmodule.aspx.cs" Inherits="Master_module" %>
 ...
 <asp:Label ID="lblmsg" runat="server"></asp:Label>
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox ID="txtModuleName" runat="server" CssClass="form-control" required></asp:TextBox>
                               <%-- <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="txtModuleName"
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox ID="txtModuleDescription" runat="server" CssClass="form-control" ></asp:TextBox>
                               <%-- <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="txtModuleDescription"
                                    ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>--%>
                            </div>
                        </div>
                         <div class="form-group row m-b-15" id="tractive" visible="false" runat="server">
                              <label class="col-md-4 col-sm-4 col-form-label" for="email">
                                Active / In-Active * :</label>
                             <div class="col-md-2 col-sm-8">
                                        <asp:RadioButtonList ID="rdbactive" runat="server" RepeatDirection="horizontal" RepeatLayout="Flow" CssClass="form-control" >
                        ...
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-8 col-sm-8">
                                ...
                                <br />
                                <asp:Panel ID="PNL" runat="server" Style="display: none; width: 200px; background-color: #348fe2;
                                    border-width: 1px; border-color: Black; border-style: solid; padding: 20px;">
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
            AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nModuleID "
            Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nModuleID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nModuleID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sModuleName" HeaderText="Module Name" />
                 <asp:BoundField DataField="sModuleDescription" HeaderText="Module Description"/>
                <asp:TemplateField HeaderText="Edit/Delete">
                    <ItemTemplate>
                        ...
                        <br />
                        <asp:Panel ID="PNL0" runat="server" Style="display: none; width: 200px; background-color: #348fe2;
                            border-width: 1px; border-color: Black; border-style: solid; padding: 20px;">
                            Are you sure you want to delete?
                            <br />
                            <br />
