<%@ Page Title="yacht" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="myacht.aspx.cs" Inherits="Master_yacht" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <asp:Label ID="lblmsg" runat="server"></asp:Label>
        ...
        <asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton>
                        ...
                        <h4 class="panel-title text-center">Add Yacht Details  </h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Yacht Name * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtYachtName" required runat="server"></asp:TextBox>

                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Dimension  :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtDimension" runat="server"></asp:TextBox>

                            </div>
                        </div>
                         <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Max Load  :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtMaxLoad" runat="server"></asp:TextBox>

                            </div>
                        </div>
                         <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Max No. of People  :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtMaxPeople" runat="server"></asp:TextBox>
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nYachtID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display" 
            OnPageIndexChanging="GridView1_PageIndexChanging" ShowHeader="true">
            <Columns>
                <asp:TemplateField HeaderText="nYachtID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nYachtID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sYachtName" HeaderText="Yacht Name" />
                <asp:BoundField DataField="sDimension" HeaderText="Dimension" />
                <asp:BoundField DataField="sMaxLoad" HeaderText="Max Load" />
                <asp:BoundField DataField="sMaxPeople" HeaderText="Max No. of People" />
