...
public partial class Master_account_category : System.Web.UI.Page
{
    maccount_category_Class objClass = new maccount_category_Class();
    ...
    {
        ViewState["maccount_category"] = Session["maccount_category"];
    }

    public void para()
    {
        objClass.sAccountCategory = validation.stringToDBString(txtAccountCategory.Text.Trim());
    }

    public void clrfield()
    {
        txtAccountCategory.Text = "";
        Session["eid"] = "";
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtAccountCategory.Text = dt.Rows[0][1].ToString();
        }
    }
    ...
    {
        objClass.nAccountCategoryId = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["maccount_category"].ToString() == ViewState["maccount_category"].ToString())
            {
                para();
