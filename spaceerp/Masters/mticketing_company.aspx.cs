...
public partial class Master_ticketing_company : System.Web.UI.Page
{
    mticketing_company_Class objClass = new mticketing_company_Class();
    ...
    {
        ViewState["mticketing_company"] = Session["mticketing_company"];
    }

    public void para()
    {
        objClass.sTCompany = validation.stringToDBString(txtCompany.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtCompany.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nTicketingCompanyID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mticketing_company"].ToString() == ViewState["mticketing_company"].ToString())
            {
                para();
