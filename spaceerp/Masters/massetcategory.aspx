<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="massetcategory.aspx.cs" Inherits="massetcategory_masters" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Assets Category</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        ...
                        <div class="form-group row m-b-15">
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email">Asset Cateory</label>
                        ...
                        <div class="form-group row m-b-15">
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email">Purchase GL</label>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email">Accu. Depr. GL</label>
                                <asp:TextBox ID="txtaccudeprgl" runat="server" CssClass="form-control" required="*"></asp:TextBox>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email">Description</label>
                                <asp:TextBox ID="txtaccudeprgldesc" runat="server" CssClass="form-control" required="*"></asp:TextBox>
                            </div>
                        </div>

                        <div class="form-group row m-b-15">
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email"> Depr. GL</label>
                                <asp:TextBox ID="txtdeprgl" runat="server" CssClass="form-control" required="*"></asp:TextBox>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email">Description</label>
                                <asp:TextBox ID="txtdeprgldesc" runat="server" CssClass="form-control" required="*"></asp:TextBox>
                            </div>
                             <div class="col-md-2 col-sm-6">
                                <label class="col-form-label" for="email"> Depreciation %</label>
                                <asp:TextBox ID="txtdepreciation" runat="server" CssClass="form-control" required="*"></asp:TextBox>
                                <asp:RegularExpressionValidator ID="REV3" runat="server" ControlToValidate="txtdepreciation"
                                ...
                                <AjaxToolKit:FilteredTextBoxExtender ID="FTBE3" runat="server"
                                    Enabled="True" FilterMode="ValidChars" FilterType=" Custom,Numbers" TargetControlID="txtdepreciation"
                                    ValidChars=".-">
                                </AjaxToolKit:FilteredTextBoxExtender>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email">Asset Code</label>
                                <asp:TextBox ID="txtassetcode" runat="server" CssClass="form-control" required="*"></asp:TextBox>
                            </div>
                        </div>
