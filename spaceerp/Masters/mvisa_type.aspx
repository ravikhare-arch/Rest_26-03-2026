<%@ Page Title="visa_type" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mvisa_type.aspx.cs" Inherits="Master_visa_type" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label ID="lblmsg" runat="server"></asp:Label>
        ...
        <asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton>
                        ...
                        <h4 class="panel-title text-center">Visa Type  Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Visa Type * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtVisaType" required runat="server"></asp:TextBox>

                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Duration * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtDuration" required runat="server"></asp:TextBox>

                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Cost * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtCost" oninput="this.value=this.value.replace(/[^0-9]/g,'');" ToolTip="Numbers Only" required runat="server"></asp:TextBox>
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nVisaTypeID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nVisaTypeID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nVisaTypeID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sVisaType" HeaderText="Visa Type" />
                <asp:BoundField DataField="sDuration" HeaderText="Visa Durarion" />
