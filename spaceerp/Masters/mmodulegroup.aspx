<%@ Page Title="Module Group" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mmodulegroup.aspx.cs" Inherits="mmodulegroup" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Create Module Group</h4>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Create Module Group</h5>
                                        ...
                                        <div class="col-md-9 ml-auto mr-auto">
                                            <div class="form-horizontal mrg-top-40 pdd-right-30 ng-pristine ng-valid">
                                                <div class="form-group row">
                                                    <label for="form-1-3" class="col-md-4 control-label text-left">Group Name</label>
                                                    <div class="col-md-8">
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $("#btnadd").on("click", function () {
                ...
                if (validatedata()) {
                    ...
                    $.ajax({
                        url: '<%=ResolveUrl("mmodulegroup.aspx/AddUser") %>',
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("mmodulegroup.aspx/DeleteUser") %>',
            ...
            $(document.body).on("click", "#inactivebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("mmodulegroup.aspx/MarkInactive") %>',
            ...
            $(document.body).on("click", "#btnupdate", function () {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("mmodulegroup.aspx/UpdateUser") %>',
                    data: JSON.stringify({ list: obj }),
                    type: "post",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("mmodulegroup.aspx/loaddata") %>',
                type: "post",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (mainlist) {
                    var html = "<table id='tblagentlist' class='table table-striped table-bordered' style='width:100%'><thead><tr> <td style='width:2%'>Sr No.</td><td>Group Name</td><td style='width:3%'>Edit/Delete</td><td style='display:none'>UserID</td></tr></thead><tbody>";
                    var vcount = 0;
                    ...
                    var table = $("#tblagentlist").DataTable({
                        ...
                        language: {
                            searchPlaceholder: "Module Group"
                        },
