<%@ Page Title="Sub Accounts" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="maccount_sub.aspx.cs" Inherits="Master_account_sub" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <asp:UpdatePanel ID="up1" runat="server">
                            <ContentTemplate>
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="email">Main Account * :</label>
                                    <div class="col-md-8 col-sm-8">
                                        <asp:DropDownList ID="ddlMAccount" runat="Server" CssClass="form-control js-example-placeholder-single" AutoPostBack="True"
                                            OnTextChanged="ddlMAccount_TextChanged" required>
                                        </asp:DropDownList>
                                ...
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="email">Family * :</label>
                                    <div class="col-md-8 col-sm-8">
                                        <asp:DropDownList ID="ddlFamily" runat="Server" required CssClass="form-control js-example-placeholder-single" Enabled="true">
                                        </asp:DropDownList>
                                ...
                                <div class="form-group row m-b-15">
                                    <label class="col-md-4 col-sm-4 col-form-label" for="email">Sub Account * :</label>
                                    <div class="col-md-8 col-sm-8">
                                        <asp:TextBox ID="txtSubAccount" runat="Server" required CssClass="form-control"></asp:TextBox>
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <asp:TextBox ID="txtCode" runat="Server" required CssClass="form-control"></asp:TextBox>
    ...
    <asp:Panel class="tbl table-responsive m-b-20" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-hover m-b-30 text-inverse" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nSubAccountID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="100" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nSubAccountID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nSubAccountID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sFamily" HeaderText="Account Family" />
                <asp:BoundField DataField="sMainAccountTitle" HeaderText="Main Account" />
                <asp:BoundField DataField="sSubAccount" HeaderText="Sub Account" />
