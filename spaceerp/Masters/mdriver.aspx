<%@ Page Title="driver" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mdriver.aspx.cs" Inherits="Master_driver" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Driver Name * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox ID="txtDriverName" runat="Server" required CssClass="form-control"></asp:TextBox>

                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Licence No. * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox ID="txtLicence" runat="Server" required CssClass="form-control"></asp:TextBox>
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Licence Valid Upto * :</label>
                            <div class="col-md-7 col-sm-7">
                                <asp:TextBox ID="txtLicenceValid" runat="Server" required CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-md-1 col-sm-1">
                                <AjaxToolKit:CalendarExtender ID="CalendarExtender4" runat="server" Format="dd/MM/yyyy"
                                    PopupButtonID="Img4" TargetControlID="txtLicenceValid" PopupPosition="TopLeft" />
                                ...
                                <AjaxToolKit:MaskedEditExtender ID="MEE4" runat="server"
                                    TargetControlID="txtLicenceValid" Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                <asp:RegularExpressionValidator ID="REV4" ControlToValidate="txtLicenceValid"
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Contact No.1 * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox ID="txtContact1" runat="Server" required CssClass="form-control"></asp:TextBox>


                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Contact No.2 :</label>
                            <div class="col-md-8 col-sm-8">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Vehicle :</label>
                            <div class="col-md-8 col-sm-8">
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nDriverID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nDriverID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nDriverID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sDriverName" HeaderText="Drive Name" />

                <asp:BoundField DataField="sDrivingLicence" HeaderText="Driving Licence No." />
                <asp:TemplateField HeaderText="Licence Valid Upto" Visible="true">
                    <ItemTemplate>
                        <asp:Label ID="lbldt" runat="server" Text='<%# Eval(validation.TextToDate("dtLicenceValid").ToString()) %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sContactNo1" HeaderText="Contact No." />
                <asp:BoundField DataField="sVehicleNo" HeaderText="Vehicle" />
