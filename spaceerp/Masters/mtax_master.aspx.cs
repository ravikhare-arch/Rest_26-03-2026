...
public partial class Master_tax_master : System.Web.UI.Page
{
    mtax_master_Class objClass = new mtax_master_Class();
    ...
    {
        ViewState["mtax_master"] = Session["mtax_master"];
    }

    public void para()
    {
        objClass.sTaxName = validation.stringToDBString(txtTaxName.Text.Trim());
      //  objClass.nTaxTypeID = ddlTaxType.SelectedValue;
        objClass.nTaxValue = txtValue.Text.Trim();
        objClass.nCGST = txtCGST.Text.Trim();
        objClass.nSGST = txtSGST.Text.Trim();
        objClass.nIGST = txtIGST.Text.Trim();
    ...
    {
        objClass.nTaxMasterID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mtax_master"].ToString() == ViewState["mtax_master"].ToString())
            {
                para();
