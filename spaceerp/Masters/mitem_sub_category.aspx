<%@ Page Title="item_sub_category" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mitem_sub_category.aspx.cs" Inherits="Master_item_sub_category" %>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Item Sub Category Details</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            ...
                            <div class="form-group row m-b-15">
                                <label class="col-md-4 col-sm-4 col-form-label" for="email">Item Category * :</label>
                                <div class="col-md-8 col-sm-8">
                                    <asp:DropDownList ID="ddlItemCategory" runat="Server" required CssClass="form-control js-example-placeholder-single"></asp:DropDownList>
                            ...
                            <div class="form-group row m-b-15">
                                <label class="col-md-4 col-sm-4 col-form-label" for="email">Sirial No. * :</label>
                                <div class="col-md-8 col-sm-8">
                                     <asp:TextBox ID="txtSerialNo" runat="Server" required CssClass="form-control"></asp:TextBox>

                                </div>
                            </div>
                            <div class="form-group row m-b-15">
                                <label class="col-md-4 col-sm-4 col-form-label" for="email">Item Sub Category * :</label>
                                <div class="col-md-8 col-sm-8">
                                     <asp:TextBox ID="txtItemSubCategory" runat="Server" required CssClass="form-control"></asp:TextBox>
...
<asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nItemSubCategoryID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nItemSubCategoryID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nItemSubCategoryID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sItemCategory" HeaderText="Item Category" />
                <asp:BoundField DataField="sSerialNo" HeaderText="Serial No." />
                <asp:BoundField DataField="sItemSubCategory" HeaderText="Item Sub Category" />
