<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="mcreditcardpos.aspx.cs" Inherits="mcreditcardpos_masters" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Credit Card POS</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email">POS Code</label>
                                <asp:TextBox ID="txtcode" runat="server" CssClass="form-control" required="*"></asp:TextBox>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="email">POS Name</label>
                         ...
                         <div class="form-group row m-b-15">
                             <div class="col-md-2 col-sm-6">
                                <label class="col-form-label" for="email">Bank Account</label>
                                <asp:DropDownList ID="ddlbankaccount" runat="server" CssClass="form-control js-example-placeholder-single"></asp:DropDownList>
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlbankaccount" ErrorMessage="Please fill out this field." Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                            </div>
                             <div class="col-md-2 col-sm-6">
                                <label class="col-form-label" for="email">Bank Account</label>
                                <asp:DropDownList ID="ddlcostcentre" runat="server" CssClass="form-control js-example-placeholder-single"></asp:DropDownList>
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlcostcentre" ErrorMessage="Please fill out this field." Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                            </div>
                          </div>
                        <div class="form-group row m-b-15">
                             <div class="col-md-2 col-sm-6">
                                <label class="col-form-label" for="email">CC Charges</label>
