...
public partial class Master_ticket_com : System.Web.UI.Page
{
    mticket_com_Class objClass = new mticket_com_Class();
    ...
    {
        ViewState["mticket_com"] = Session["mticket_com"];
    }
    ...
    public void para()
    {
        ...
        objClass.nInctValue = txtInctValue.Text.Trim();
        objClass.bStatus = "1";
    ...
    public void clrfield()
    {
        ...
        txttStartDate.Text = "";
        txttEndDate.Text = "";
        ddlCalMethodID.SelectedValue = "0";
        txtInctValue.Text = "";
        Session["eid"] = "";
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtInctValue.Text = dt.Rows[0][8].ToString();
           // ckStatus.SelectedValue = dt.Rows[0][9].ToString();
            //txtConfigID.Text = dt.Rows[0][10].ToString();
        }
    }
    ...
    {
        objClass.nticketcomId = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mticket_com"].ToString() == ViewState["mticket_com"].ToString())
            {
                para();
