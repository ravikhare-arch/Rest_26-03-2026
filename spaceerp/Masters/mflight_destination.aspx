<%@ Page Title="flight_destination" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mflight_destination.aspx.cs" Inherits="Other_flight_destination" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        <div class="panel-heading-btn pull-left"><asp:LinkButton ID="lnkAdd" runat="server" OnClick="lnkAdd_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">ADD</asp:LinkButton>
<asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton></div>
                        ...
                        <h4 class="panel-title text-center">Flight Destination Detials</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
...
<asp:Panel class="tbl" ID="tblmain" runat="server">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Flight Destination * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtFDestination" required runat="server"></asp:TextBox>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtFDCode" required runat="server"></asp:TextBox>
...
<asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nFDestinationID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nFDestinationID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nFDestinationID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sFDestination" HeaderText="Country Name" />
                <asp:BoundField DataField="sFDCode" HeaderText="Language" />
