<%@ Page Title="hotel_room" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mhotel_room.aspx.cs" Inherits="Master_hotel_room" %>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                       ...
                       <asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton></div>
                        ...
                        <h4 class="panel-title text-center">Hotel Room Category  Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
...
<asp:Panel class="tbl" ID="tblmain" runat="server">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Room Type * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtHotelRoom" required runat="server"></asp:TextBox>
...
<asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nHotelRoomID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nHotelRoomID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nHotelRoomID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sHotelRoom" HeaderText="Room Type" />
