<%@ Page Title="IATA COM" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mticket_com.aspx.cs" Inherits="Master_ticket_com" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Label ID="lblmsg" runat="server"></asp:Label>
        ...
        <asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton>
                        ...
                        <h4 class="panel-title text-center">IATA COM</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">
                            ...
                            <ContentTemplate>
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        ...
                                        <asp:DropDownList ID="ddlReceivedFromID" CssClass="form-control" Width="100%" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlReceivedFromID_SelectedIndexChanged">
                                            <asp:ListItem Text="Select Type" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="IATA BSP" Value="1"></asp:ListItem>
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        ...
                                        <asp:DropDownList ID="ddlSupplierID" runat="server" Width="100%" Enabled="false" CssClass="form-control js-example-placeholder-single"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RFV3" runat="server" ControlToValidate="ddlSupplierID" ErrorMessage="*" Display="Dynamic"
                                            SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-md-3 col-sm-4">
                                        <label class="col-form-label" for="email">Airline</label>
                                        <asp:DropDownList ID="ddlAirlineID" runat="server" Width="100%" CssClass="form-control js-example-placeholder-single"></asp:DropDownList>
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        ...
                                        <asp:DropDownList ID="ddlTicketTypeID" CssClass="form-control" runat="server" Width="100%">
                                            <asp:ListItem Text="Select Type" Value="0"></asp:ListItem>
                        ...
                        <div class="form-group row m-b-15">
                            <div class="col-md-3 col-sm-4">
                                ...
                                <asp:TextBox ID="txttStartDate" CssClass="form-control" runat="server" Width="100%" placeholder="DD/MM/YYYY"></asp:TextBox>
                            ...
                            <div class="col-md-3 col-sm-4">
                                ...
                                <asp:TextBox ID="txttEndDate" CssClass="form-control" runat="server" Width="100%" placeholder="DD/MM/YYYY"></asp:TextBox>
                            ...
                            <div class="col-md-3 col-sm-4">
                                ...
                                <asp:DropDownList ID="ddlCalMethodID" CssClass="form-control" Width="100%" runat="server">
                                    <asp:ListItem Text="% On Basic" Value="0"></asp:ListItem>
                                    <%--<asp:ListItem Text="% On Basic + All Taxes" Value="1"></asp:ListItem>--%>
                                    <asp:ListItem Text="% On Basic + YQ TAX" Value="1"></asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="col-md-3 col-sm-4">
                                ...
                                <asp:TextBox ID="txtInctValue" CssClass="form-control" Width="100%" runat="server"></asp:TextBox><asp:RegularExpressionValidator ID="REV8" runat="server"
                                    ControlToValidate="txtInctValue" SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Numbers" ValidationExpression="^(-)?\d+(\.\d+$)?$"
                                    ValidationGroup="A"></asp:RegularExpressionValidator>
                                <AjaxToolKit:FilteredTextBoxExtender ID="FTBE8" runat="server"
                                    Enabled="True" FilterMode="ValidChars" FilterType="Custom,Numbers" TargetControlID="txtInctValue" ValidChars=".-">
                                </AjaxToolKit:FilteredTextBoxExtender>
                                <asp:RequiredFieldValidator ID="RFV8" runat="server"
                                    ControlToValidate="txtInctValue" ErrorMessage="*" Display="Dynamic"
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nticketcomId " Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nticketcomId" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nticketcomId") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sRecFrom" HeaderText="Received From" />
                <asp:BoundField DataField="sFCarrier" HeaderText="Airline Name" />
                ...
                <asp:BoundField DataField="sCalMethod" HeaderText="Calculation Method" />
                <asp:BoundField DataField="nInctValue" HeaderText="INC Value (%)" />
