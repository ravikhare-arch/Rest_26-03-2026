...
public partial class Master_item_category : System.Web.UI.Page
{
    mitem_category_Class objClass = new mitem_category_Class();
    ...
    {
        ViewState["mitemcategory"] = Session["mitemcategory"];
    }

    public void para()
    {
        objClass.sItemCategory = validation.stringToDBString(txtItemCategory.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtItemCategory.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nItemCategoryID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mitemcategory"].ToString() == ViewState["mitemcategory"].ToString())
            {
                para();
    ...
    {
        Response.Redirect("mitemcategory_list.aspx");
    }
}
