...
public partial class Master_company_main : System.Web.UI.Page
{
    company_main_Class objClass = new company_main_Class();
    ...
    {
        ViewState["company_main"] = Session["company_main"];
    }

    public void para()
    {
        objClass.sCompanyName = validation.stringToDBString(txtCompanyName.Text.Trim());
        objClass.sAddress = validation.stringToDBString(txtAddress.Text.Trim());
        objClass.sPhone = validation.stringToDBString(txtPhone.Text.Trim());
        ...
        //objClass.sCompanyImage = validation.stringToDBString(txtCompanyImage);
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtWebsite.Text = dt.Rows[0][6].ToString();
           lblimagename.Text = dt.Rows[0][7].ToString();
        }
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["company_main"].ToString() == ViewState["company_main"].ToString())
            {
                para();
                objClass.sCompanyImage = valobj.AddImage(FUCompanyImage);
                //objClass.sCompanyImage = validation.stringToDBString(txtCompanyImage);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            para();
            objClass.sCompanyImage = valobj.UpdateImage(FUCompanyImage, lblimagename);
            objClass.nCompanyID = Session["eid"].ToString();
