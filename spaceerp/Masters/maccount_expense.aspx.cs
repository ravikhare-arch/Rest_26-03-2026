...
public partial class Master_account_expense : System.Web.UI.Page
{
    maccount_expense_Class objClass = new maccount_expense_Class();
    ...
    {
        ViewState["maccount_expense"] = Session["maccount_expense"];
    }

    public void para()
    {
        objClass.sAccountExpense = validation.stringToDBString(txtAccountExpense.Text.Trim());
    }

    public void clrfield()
    {
        txtAccountExpense.Text = "";
        Session["eid"] = "";
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtAccountExpense.Text = dt.Rows[0][1].ToString();
        }
    }
    ...
    {
        objClass.nAccountExpenseID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["maccount_expense"].ToString() == ViewState["maccount_expense"].ToString())
            {
                para();
