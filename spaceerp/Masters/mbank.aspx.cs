...
{
    mbank_Class objClass = new mbank_Class();
    ...
    {
        ViewState["mbank"] = Session["mbank"];
    }

    public void para()
    {
        objClass.sBankName = validation.stringToDBString(txtBankName.Text.Trim());
    }
    ...
    {
        objClass.nBankID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mbank"].ToString() == ViewState["mbank"].ToString())
            {
                para();
