...
public partial class Master_hotel_room : System.Web.UI.Page
{
    mhotel_room_Class objClass = new mhotel_room_Class();
    ...
    {
        ViewState["mhotel_room"] = Session["mhotel_room"];
    }

    public void para()
    {
        objClass.sHotelRoom = validation.stringToDBString(txtHotelRoom.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtHotelRoom.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nHotelRoomID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mhotel_room"].ToString() == ViewState["mhotel_room"].ToString())
            {
                para();
