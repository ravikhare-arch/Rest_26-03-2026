<%@ Page Title="vehicle" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mvehicle.aspx.cs" Inherits="Master_vehicle" %>
...
<asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton>
                        ...
                        <h4 class="panel-title text-center">Add Vehicle Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
...
<asp:Panel class="tbl" ID="tblmain" runat="server">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Vehivle No * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtVehicleNo" required runat="server"></asp:TextBox>
...
<asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nVehicleID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nVehicleID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nVehicleID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
