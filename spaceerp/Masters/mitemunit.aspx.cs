...
public partial class Master_itemunit : System.Web.UI.Page
{
    mitemunit_Class objClass = new mitemunit_Class();
    ...
    {
        ViewState["mitemunit"] = Session["mitemunit"];
    }

    public void para()
    {
        objClass.sItemUnit = validation.stringToDBString(txtItemUnit.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtItemUnit.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nItemUnitId = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mitemunit"].ToString() == ViewState["mitemunit"].ToString())
            {
                para();
