...
public partial class Master_flight_class : System.Web.UI.Page
{
    mflight_class_Class objClass = new mflight_class_Class();
    ...
    {
        ViewState["mflight_class"] = Session["mflight_class"];
    }

    public void para()
    {
        objClass.sFlightClass = validation.stringToDBString(txtFlightClass.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtFlightClass.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nFlightClassID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mflight_class"].ToString() == ViewState["mflight_class"].ToString())
            {
                para();
