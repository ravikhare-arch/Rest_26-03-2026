<%@ Page Title="Branch" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mbranch.aspx.cs" Inherits="mbranch_Master" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">Branch</h4>
                    ...
                    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-2 col-sm-3">
                                <label class="col-form-label" for="email">Branch Code * :</label>
                            ...
                            <div class="col-md-2 col-sm-3">
                                ...
                                <asp:DropDownList ID="ddlCompany" runat="server" CssClass="form-control js-example-placeholder-single"></asp:DropDownList>
                            </div>
                            <div class="col-md-2 col-sm-3">
                        ...
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-3 col-sm-3">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" CssClass="form-control" runat="server" ControlToValidate="txtPincode"
                        ...
                        <div class="form-group row m-b-20">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="nBranchID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
                                    OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="nBranchID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nBranchID") %>'></asp:Label>
                                             <%--   <asp:Label ID="lblCAID" runat="server" Text='<%# Eval("nCAccountID") %>'></asp:Label>--%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="sBranchCode" HeaderText="BRANCH CODE" />
