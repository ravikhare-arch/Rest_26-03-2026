<%@ Page Title="company" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="mcompany_old.aspx.cs" Inherits="Master_company" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtComapny" required runat="server"></asp:TextBox>


                            </div>
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">Mark  :</label>
                                <asp:TextBox CssClass="form-control" ID="txtMark" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <label class="col-form-label" for="fullname">Contact Person :</label>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">Office Agent  :</label>
                                <asp:TextBox CssClass="form-control" ID="txtOffAgent" runat="server"></asp:TextBox>
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="sMark" HeaderText="Mark " />
                <asp:BoundField DataField="sCompanyName" HeaderText="Family Name" />
                <asp:BoundField DataField="sMark" HeaderText="Address" />
                <asp:BoundField DataField="sAddress" HeaderText="Address" />
                <asp:BoundField DataField="nCountryID" HeaderText="Country" />
                <asp:BoundField DataField="nCityID" HeaderText="Country" />
                <asp:BoundField DataField="sContactPerson" HeaderText="Contact Person" />
                ...
                <asp:BoundField DataField="sOfficeAgent" HeaderText="Office Agent" />
                <asp:BoundField DataField="sRefNo" HeaderText="Reference No. " />
