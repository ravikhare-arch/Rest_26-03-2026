...
public partial class Master_table : System.Web.UI.Page
{
    mtable_Class objClass = new mtable_Class();
    ...
    {
        ViewState["mtable"] = Session["mtable"];
    }

    public void para()
    {
        objClass.sTableNo = validation.stringToDBString(txtTableNo.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtTableNo.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nTableID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mtable"].ToString() == ViewState["mtable"].ToString())
            {
                para();
