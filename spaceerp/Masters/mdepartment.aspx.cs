...
{
    mdepartment_Class objClass = new mdepartment_Class();
    ...
    {
        ViewState["mdepartment"] = Session["mdepartment"];
    }

    public void para()
    {
        objClass.sDepartmentName = validation.stringToDBString(txtDepartmentName.Text.Trim());
    }
    ...
    {
        objClass.nDepartmentID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mdepartment"].ToString() == ViewState["mdepartment"].ToString())
            {
                para();
