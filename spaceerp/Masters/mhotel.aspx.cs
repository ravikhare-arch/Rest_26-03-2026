...
public partial class Master_hotel : System.Web.UI.Page
{
    mhotel_Class objClass = new mhotel_Class();
    ...
    {
        ViewState["mhotel"] = Session["mhotel"];
    }

    public void para()
    {
        objClass.sHotelName = validation.stringToDBString(txtHotelName.Text.Trim());
        ...
        objClass.sRating = validation.stringToDBString(txtRating.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtContactPerson.Text = dt.Rows[0][2].ToString();
            txtAddress.Text = dt.Rows[0][3].ToString();
            ddlCountry.SelectedValue = dt.Rows[0][4].ToString();
            EventArgs e = new EventArgs();
            ddlCountry_TextChanged(this, e);
            ddlCity.SelectedValue = dt.Rows[0][5].ToString();
            ...
            txtWebsite.Text = dt.Rows[0][10].ToString();
            txtRating.Text = dt.Rows[0][11].ToString();
    ...
    {
        objClass.nHotelID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mhotel"].ToString() == ViewState["mhotel"].ToString())
            {
                para();
