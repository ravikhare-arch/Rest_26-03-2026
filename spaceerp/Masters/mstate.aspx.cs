...
{
    mstate_Class objClass = new mstate_Class();
    ...
    {
        ViewState["mcity"] = Session["mcity"];
    }

    public void para()
    {
        objClass.nCountryID = ddlCountry.SelectedValue;
        objClass.sState = validation.stringToDBString(txtStateName.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtStateName.Text = dt.Rows[0][2].ToString();
    ...
    {
        objClass.nStateID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mcity"].ToString() == ViewState["mcity"].ToString())
            {
                para();
