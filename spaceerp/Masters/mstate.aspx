<%@ Page Title="State" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mstate.aspx.cs" Inherits="Master_city" %>
...
<asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton>
                            ...
                            <h4  class="panel-title text-center">Add State Details</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        <div class="col-md-2"></div>
                            ...
                            <div class="form-group row m-b-15">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <asp:TextBox CssClass="form-control" ID="txtStateName" runat="server"></asp:TextBox>
...
<asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False" EmptyDataText="No Records to display"
            DataKeyNames="nStateID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nStateID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nStateID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
