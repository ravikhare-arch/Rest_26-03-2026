...
public partial class Master_vehicle : System.Web.UI.Page
{
    mvehicle_Class objClass = new mvehicle_Class();
    ...
    {
        ViewState["mvehicle"] = Session["mvehicle"];
    }

    public void para()
    {
        objClass.sVehicleNo = validation.stringToDBString(txtVehicleNo.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtVehicleNo.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nVehicleID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mvehicle"].ToString() == ViewState["mvehicle"].ToString())
            {
                para();
