...
public partial class Master_user_type : System.Web.UI.Page
{
    muser_type_Class objClass = new muser_type_Class();
    ...
    {
        ViewState["muser_type"] = Session["muser_type"];
    }

    public void para()
    {
        objClass.sUserType = validation.stringToDBString(txtUserType.Text.Trim());
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtUserType.Text = dt.Rows[0][1].ToString();
        }
    }
    ...
    {
        objClass.nUserTypeID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["muser_type"].ToString() == ViewState["muser_type"].ToString())
            {
                para();
