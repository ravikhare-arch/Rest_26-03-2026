<%@ Page Title="AIRLINE COM" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mtickerplb.aspx.cs" Inherits="Master_tickerplb" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label ID="lblmsg" runat="server"></asp:Label>
        ...
        <asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton>
                        ...
                        <h4 class="panel-title text-center">AIRLINE COM</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-3 col-sm-4">
                                ...
                                <asp:DropDownList ID="ddlClassID" CssClass="form-control" runat="server" Width="100%">
                            ...
                            <div class="col-md-3 col-sm-4">
                                ...
                                <asp:DropDownList ID="ddlGrossNetID" CssClass="form-control" runat="server" Width="100%">
                        ...
                        <div class="form-group row m-b-15">
                            <div class="col-md-4 col-sm-4">
                                ...
                                <asp:DropDownList ID="ddlAutoManualID"  CssClass="form-control" Width="100%" runat="server">
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <asp:TextBox ID="txtIncValue" CssClass="form-control" Width="100%" runat="server">
                                </asp:TextBox>
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nticketplbId " Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nticketplbId" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nticketplbId") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="nIncValue" HeaderText="INC Value (%)" />
