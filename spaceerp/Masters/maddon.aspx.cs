...
public partial class Master_addon : System.Web.UI.Page
{
    maddon_Class objClass = new maddon_Class();
    ...
    {
        ViewState["maddon"] = Session["maddon"];
    }

    public void para()
    {
        objClass.sAddonName = validation.stringToDBString(txtAddonName.Text.Trim());
        objClass.sDescription = validation.stringToDBString(txtDescription.Text.Trim());
        objClass.nRate = txtRate.Text.Trim();
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtAddonName.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nAddonID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["maddon"].ToString() == ViewState["maddon"].ToString())
            {
                para();
