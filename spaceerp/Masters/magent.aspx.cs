...
public partial class Master_agent : System.Web.UI.Page
{
    magent_Class objClass = new magent_Class();
    ...
    {
        ViewState["magent"] = Session["magent"];
    }

    public void para()
    {
        objClass.sAgentName = validation.stringToDBString(txtAgentName.Text.Trim());
    ...
    {
        objClass.nAgentID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["magent"].ToString() == ViewState["magent"].ToString())
            {
                para();
