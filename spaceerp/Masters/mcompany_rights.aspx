<%@ Page Title="company_rights" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="mcompany_rights.aspx.cs" Inherits="Master_company_rights" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-8 col-sm-8">
                                ...
                                <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="ddlCompanyID" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">User Name * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:DropDownList ID="ddlUserID" runat="server" CssClass="form-control"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RFV2" runat="server" ControlToValidate="ddlUserID" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                            </div>
                        </div>
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nCompanyRightsID " Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nCompanyRightsID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nCompanyRightsID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sCompanyName" HeaderText="Company Name" />
                <asp:BoundField DataField="sLogin" HeaderText="User Name" />
