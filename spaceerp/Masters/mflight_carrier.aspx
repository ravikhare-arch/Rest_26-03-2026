<%@ Page Title="flight_carrier" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="mflight_carrier.aspx.cs" Inherits="Master_flight_carrier" %>
...
<p><asp:LinkButton ID="lnkAdd" runat="server" OnClick="lnkAdd_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">ADD</asp:LinkButton>
<asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton></p>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Flight Carrier Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Flight Carrier * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtFCarrier" required runat="server"></asp:TextBox>

                            </div>
                        </div>
                         <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Code * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtCode" required runat="server"></asp:TextBox>

                            </div>
                        </div>
                         <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Designator * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control"  ID="txtDesignator" required runat="server"></asp:TextBox>

                            </div>
                        </div>
                         <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Alliance :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control"  ID="txtAlliance" runat="server"></asp:TextBox>
...
<asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nFlightCarrierID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nFlightCarrierID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nFlightCarrierID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sFCarrier" HeaderText="Flight Carrier" />
                 <asp:BoundField DataField="sCode" HeaderText="Flight Code" />
                 <asp:BoundField DataField="sDesignator" HeaderText="Designator" />
                 <asp:BoundField DataField="Alliance" HeaderText="Alliance" />
