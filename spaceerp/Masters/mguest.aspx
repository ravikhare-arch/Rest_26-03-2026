<%@ Page Title="guest" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="mguest.aspx.cs" Inherits="Master_guest" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Guest Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-3 col-sm-3">
                                ...
                                <asp:DropDownList CssClass="form-control js-example-placeholder-single"  ID="ddlCompany" required runat="server"></asp:DropDownList>


                            </div>
                            
                            <div class="col-md-6 col-sm-6">
                                <label class="col-form-label" for="fullname">Guest Name :</label>
                                <asp:TextBox CssClass="form-control" ID="txtGuestName" runat="server"></asp:TextBox>


                            </div>
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">Serial No  :</label>
                                <asp:TextBox CssClass="form-control" ID="txtSerialNo" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">Country  :</label>
                                <asp:DropDownList CssClass="form-control js-example-placeholder-single"  ID="ddlCountry" runat="server" AutoPostBack="True"
                                 OnTextChanged="ddlCountry_TextChanged"  ></asp:DropDownList>



                            </div>
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">City :</label>
                                <asp:DropDownList CssClass="form-control js-example-placeholder-single"  ID="ddlCity" runat="server"></asp:DropDownList>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">Telephone :</label>
                                <asp:TextBox CssClass="form-control" ID="txtTelephone" runat="server"></asp:TextBox>


                            </div>
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">Mobile  :</label>
                                <asp:TextBox CssClass="form-control" ID="txtMobile" runat="server"></asp:TextBox>


                            </div>
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">Fax  :</label>
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nGuestID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nGuestID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nGuestID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="nCompanyID" HeaderText="Company Name " />
                <asp:BoundField DataField="sGuestName" HeaderText="Guest Name " />
                <asp:BoundField DataField="sSerialNo" HeaderText="Serrial No." />
               
                <asp:BoundField DataField="sAddress" HeaderText="Address" />
                <asp:BoundField DataField="nCountryID" HeaderText="Country" />
                <asp:BoundField DataField="nCityID" HeaderText="City" />
