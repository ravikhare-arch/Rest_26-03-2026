...
public partial class Master_itemsize : System.Web.UI.Page
{
    mitemsize_Class objClass = new mitemsize_Class();
    ...
    {
        ViewState["mitemsize"] = Session["mitemsize"];
    }

    public void para()
    {
        objClass.sItemSize = validation.stringToDBString(txtItemSize.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtItemSize.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nItemSizeID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mitemsize"].ToString() == ViewState["mitemsize"].ToString())
            {
                para();
