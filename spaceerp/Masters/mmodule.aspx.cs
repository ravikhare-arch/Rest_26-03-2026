...
public partial class Master_module : System.Web.UI.Page
{
    mmodule_Class objClass = new mmodule_Class();
    ...
    {
        ViewState["mmodule"] = Session["mmodule"];
    }

    public void para()
    {
        objClass.sModuleName = validation.stringToDBString(txtModuleName.Text.Trim());
        objClass.sModuleDescription = validation.stringToDBString(txtModuleDescription.Text.Trim());
        objClass.bActive = rdbactive.SelectedValue;
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtModuleName.Text = dt.Rows[0][1].ToString();
            txtModuleDescription.Text = dt.Rows[0][2].ToString();
            rdbactive.SelectedValue = dt.Rows[0][4].ToString();
        }
    }
    ...
    {
        objClass.nModuleID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mmodule"].ToString() == ViewState["mmodule"].ToString())
            {
                para();
