...
public partial class Master_visa_company : System.Web.UI.Page
{
    mvisa_company_Class objClass = new mvisa_company_Class();
    ...
    {
        ViewState["mvisa_company"] = Session["mvisa_company"];
    }

    public void para()
    {
        objClass.sComapanyName = validation.stringToDBString(txtComapanyName.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtComapanyName.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nVisaCompanyID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mvisa_company"].ToString() == ViewState["mvisa_company"].ToString())
            {
                para();
