...
public partial class Master_sales_person : System.Web.UI.Page
{
    msales_person_Class objClass = new msales_person_Class();
    ...
    {
        ViewState["msalesperson"] = Session["msalesperson"];
    }

    public void para()
    {
        objClass.sSalesPersonName = validation.stringToDBString(txtSalesPersonName.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtSalesPersonName.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nSalesPersonID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["msalesperson"].ToString() == ViewState["msalesperson"].ToString())
            {
                para();
