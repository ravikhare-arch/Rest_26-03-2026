...
public partial class Master_expense_category : System.Web.UI.Page
{
    mexpense_category_Class objClass = new mexpense_category_Class();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                //Fllddl.FillPageddl(ddlPageSize);
                string aa = Server.UrlEncode(System.DateTime.Now.ToString());
                Session["mexpense_category"] = aa;
    ...
    {
        ViewState["mexpense_category"] = Session["mexpense_category"];
    }

    public void para()
    {
        objClass.sExpenseCat = validation.stringToDBString(txtExpenseCat.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtExpenseCat.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nExpenseCategoryID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mexpense_category"].ToString() == ViewState["mexpense_category"].ToString())
            {
                para();
