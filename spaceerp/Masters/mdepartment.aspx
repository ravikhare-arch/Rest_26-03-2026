<%@ Page Title="department" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true"
    CodeFile="mdepartment.aspx.cs" Inherits="Master_department" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">    
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-8 col-sm-8">
                               ...
                               <%-- <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="txtDepartmentName"
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
            AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nDepartmentID "
            Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nDepartmentID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nDepartmentID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sDepartmentName" HeaderText="Department Name" />
