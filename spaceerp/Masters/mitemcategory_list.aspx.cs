...
public partial class tbankreco_list : System.Web.UI.Page
{
    static mitem_category_Class objClass = new mitem_category_Class();
    ...
    public static mpagemasterlist loaddata()
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.CategoryName = dt.Rows[i]["sItemCategory"].ToString();
                magentobj.CategoryID = dt.Rows[i]["nItemCategoryID"].ToString();
    ...
    public static string DeleteVoucher(string AccountLedgerID)
    {
        ...
        try
        {
            objClass.nItemCategoryID = AccountLedgerID;
