<%@ Page Title="hotel" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mhotel.aspx.cs" Inherits="Master_hotel" %>
 ...
 <asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="lblmsg" runat="server"></asp:Label>
        ...
        <asp:LinkButton ID="lnkList" runat="server" OnClick="lnkList_Click" CssClass="btn-xs btn-info m-r-5 m-b-5">LIST</asp:LinkButton>
                        ...
                        <h4 class="panel-title text-center">Hotels Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
    ...
    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <label class="col-form-label" for="fullname">Hotel Name * :</label>
                                <asp:TextBox CssClass="form-control" ID="txtHotelName" required runat="server"></asp:TextBox>
                         ...
                         <div class="col-md-3 col-sm-3">
                            ...
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label" for="fullname">Rating  :</label>
                                <asp:TextBox CssClass="form-control" ID="txtRating" runat="server"></asp:TextBox>
 ...
 <br />
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nHotelID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nHotelID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nHotelID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="sCityName" HeaderText="City" />
