<%@ Page Title="Country" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mcountry.aspx.cs" Inherits="Master_Country" %>
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="col-md-8">                                             
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Country Name * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtCountryName" required runat="server"></asp:TextBox>

                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Language :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtLanguage" runat="server"></asp:TextBox>

                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Capital :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtCapital" runat="server"></asp:TextBox>

                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">Continent :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox CssClass="form-control" ID="txtContinent" runat="server"></asp:TextBox>
...
<asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
            DataKeyNames="nCountryID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
            OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nCountryID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nCountryID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sCountryName" HeaderText="Country Name" />
                <asp:BoundField DataField="sLanguage" HeaderText="Language" />
                <asp:BoundField DataField="sCapital" HeaderText="Capital" />
                <asp:BoundField DataField="sContinent" HeaderText="Continent" />
