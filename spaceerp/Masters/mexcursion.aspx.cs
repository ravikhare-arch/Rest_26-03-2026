...
public partial class Master_excursion : System.Web.UI.Page
{
    mexcursion_Class objClass = new mexcursion_Class();
    ...
    {
        ViewState["mexcursion"] = Session["mexcursion"];
    }

    public void para()
    {
        objClass.sExcursionType = validation.stringToDBString(txtExcursionType.Text.Trim());

    }

    public void clrfield()
    {
        txtExcursionType.Text = "";
        txtExcursionType.Focus();
        Session["eid"] = "";
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtExcursionType.Text = dt.Rows[0][1].ToString();
    ...
    {
        objClass.nExcursionID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mexcursion"].ToString() == ViewState["mexcursion"].ToString())
            {
                para();
