<%@ Page Title="User" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="muser_list.aspx.cs" Inherits="muser" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Create User</h4>
                                        ...
                                        <div class="col-md-9 ml-auto mr-auto">
                                            <div class="form-horizontal mrg-top-40 pdd-right-30 ng-pristine ng-valid">
                                                <div class="form-group row">
                                                    <label for="form-1-3" class="col-md-4 control-label text-left">Full Name</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row">
                                                    <label for="form-1-3" class="col-md-4 control-label text-left">
                                                        User Type</label>
                                                ...
                                                <div class="form-group row">
                                                    <label for="form-1-3" class="col-md-4 control-label text-left">Department</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row">
                                                    <label for="form-1-3" class="col-md-4 control-label text-left">Login ID</label>
                                                    <div class="col-md-8">
                                                        <asp:TextBox ID="txtloginid" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="form-group row" id="divpassword">
                                                    <label for="form-1-3" class="col-md-4 control-label text-left">Password</label>
                                                    <div class="col-md-8">
                                                        <asp:TextBox ID="txtpassword" CssClass="form-control" TextMode="Password" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="form-group row" id="divconfirmpassword">
                                                    <label for="form-1-3" class="col-md-4 control-label text-left">Confirm Password</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group row">
                                                    <label for="form-1-3" class="col-md-4 control-label text-left">Location</label>
                                                    <div class="col-md-8">
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $("#btnadd").on("click", function () {
                ...
                if (validatedata()) {
                    var obj = {
                        UserFullName: $("#ctl00_ContentPlaceHolder1_txtUserFullName").val(),
                        UserTypeID: $("#ctl00_ContentPlaceHolder1_ddlusertype").val(),
                        DepartmentID: $("#ctl00_ContentPlaceHolder1_ddldepartment").val(),
                        Password: $("#ctl00_ContentPlaceHolder1_txtpassword").val(),
                        LocationID: $("#ctl00_ContentPlaceHolder1_ddllocation").val(),
                        UserName: $("#ctl00_ContentPlaceHolder1_txtloginid").val(),
                    }

                    $.ajax({
                        url: '<%=ResolveUrl("muser_list.aspx/AddUser") %>',
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("muser_list.aspx/DeleteUser") %>',
            ...
            $(document.body).on("click", "#inactivebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("muser_list.aspx/MarkInactive") %>',
            ...
            $(document.body).on("click", ".editbtn", function () {
                ...
                $("#ctl00_ContentPlaceHolder1_ddllocation").val($(this).closest('tr').find('td:eq(10)').text());
                $("#ctl00_ContentPlaceHolder1_ddlusertype").val($(this).closest('tr').find('td:eq(8)').text());
                $("#ctl00_ContentPlaceHolder1_ddldepartment").val($(this).closest('tr').find('td:eq(9)').text());
                $("#ctl00_ContentPlaceHolder1_txtpassword").val($(this).closest('tr').find('td:eq(11)').text());
                $("#ctl00_ContentPlaceHolder1_txtloginid").val($(this).closest('tr').find('td:eq(2)').text());
                $("div#divpassword").hide();
                $("div#divconfirmpassword").hide();
                $('#btnupdate').show();
            ...
            $(document.body).on("click", "#btnupdate", function () {
                var obj = {
                    ...
                    LocationID: $("#ctl00_ContentPlaceHolder1_ddllocation").val(),
                    UserName: $("#ctl00_ContentPlaceHolder1_txtloginid").val(),
                    UserID: $("#accountledgerid").val(),

                }

                $.ajax({
                    url: '<%=ResolveUrl("muser_list.aspx/UpdateUser") %>',
                    data: JSON.stringify({ list: obj }),
                    type: "post",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
        ...
        function cleardata() {
            ...
            $("#ctl00_ContentPlaceHolder1_ddlusertype").val(''),
            $("#ctl00_ContentPlaceHolder1_ddldepartment").val(''),
            $("#ctl00_ContentPlaceHolder1_txtpassword").val(''),
            $("#ctl00_ContentPlaceHolder1_txtconfirmpassword").val(''),
        ...
        function validatedata() {
            ...
            var ledgercode = document.getElementById("<%=ddlusertype.ClientID %>").value;
            var undergroup = document.getElementById("<%=ddldepartment.ClientID %>").value;
            var valtype = document.getElementById("<%=txtpassword.ClientID %>").value;
            var valnature = document.getElementById("<%=txtconfirmpassword.ClientID %>").value;
            var vallocation = document.getElementById("<%=ddllocation.ClientID %>").value;
            var vloginid = document.getElementById("<%=txtloginid.ClientID %>").value;
            var validation = true;
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("muser_list.aspx/loaddata") %>',
                type: "post",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (mainlist) {
                    var html = "<table id='tblagentlist' class='table table-striped table-bordered' style='width:100%'><thead><tr> <td style='width:2%'>Sr No.</td><td>Name</td><td>Login</td><td>User Type</td><td>Department</td><td>Location</td><td style='width:3%'>Edit/Delete</td><td style='display:none'>UserID</td><td style='display:none'>UserTypeID</td><td style='display:none'>DepartmentID</td><td style='display:none'>LocationID</td><td style='display:none'>LocationID</td></tr></thead><tbody>";
                    var vcount = 0;
                    for (i = 0; i < mainlist.d.muserobjlist.length; i++) {
                        ...
                        html += '<tr>';
                        html += '<td >' + vcount + '</td>';
                        html += '<td >' + mainlist.d.muserobjlist[i].UserFullName + '</td>';
                        html += '<td >' + mainlist.d.muserobjlist[i].UserName + '</td>';
                        html += '<td >' + mainlist.d.muserobjlist[i].UserType + '</td>';
                        html += '<td >' + mainlist.d.muserobjlist[i].Department + '</td>';
                        html += '<td >' + mainlist.d.muserobjlist[i].Location + '</td>';
                        html += '<td >' + '<a href="#" class="editbtn" title="Edit"><i class="glyphicon glyphicon-edit" style="color: green" data-toggle="modal" data-target="#exampleModalCenter"></i></a>&nbsp;&nbsp;&nbsp;<a href="#" class="deletebtn" title="Delete" data-toggle="modal" data-target="#deleteModalCenter"><i class="glyphicon glyphicon-trash" style="color: red"></i></a>&nbsp;&nbsp;&nbsp;<a href="#" class="Inactivebtn" title="In Active" data-toggle="modal" data-target="#deleteModalCenter"><i class="glyphicon glyphicon-remove" style="color: red"></i></a>' + '</td>';
                        html += '<td style="display:none;" >' + mainlist.d.muserobjlist[i].UserID + '</td>';
                        html += '<td style="display:none;" >' + mainlist.d.muserobjlist[i].UserTypeID + '</td>';
                        html += '<td style="display:none" >' + mainlist.d.muserobjlist[i].DepartmentID + '</td>';
                        html += '<td style="display:none" >' + mainlist.d.muserobjlist[i].LocationID + '</td>';
                        html += '<td style="display:none" >' + mainlist.d.muserobjlist[i].Password + '</td>';
                        html += '</tr>';
