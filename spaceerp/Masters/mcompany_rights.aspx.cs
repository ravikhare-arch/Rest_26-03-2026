...
public partial class Master_company_rights : System.Web.UI.Page
{
    mcompany_rights_Class objClass = new mcompany_rights_Class();
    company_main_Class objCompany = new company_main_Class();
    ...
    {
        ViewState["mcompany_rights"] = Session["mcompany_rights"];
    }

    public void para()
    {
        objClass.nCompanyID = ddlCompanyID.SelectedValue;
        objClass.nUserID = ddlUserID.SelectedValue;
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ddlCompanyID.SelectedValue = dt.Rows[0][1].ToString();
            ddlUserID.SelectedValue = dt.Rows[0][2].ToString();
        }
    }
    ...
    {
        objClass.nCompanyRightsID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mcompany_rights"].ToString() == ViewState["mcompany_rights"].ToString())
            {
                para();
