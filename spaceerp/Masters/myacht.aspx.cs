...
public partial class Master_yacht : System.Web.UI.Page
{
    myacht_Class objClass = new myacht_Class();
    ...
    {
        ViewState["myacht"] = Session["myacht"];
    }

    public void para()
    {
        objClass.sYachtName = validation.stringToDBString(txtYachtName.Text.Trim());
        objClass.sDimension = validation.stringToDBString(txtDimension.Text.Trim());
        objClass.sMaxLoad = validation.stringToDBString(txtMaxLoad.Text.Trim());
        objClass.sMaxPeople = validation.stringToDBString(txtMaxPeople.Text.Trim());
    }
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtYachtName.Text = dt.Rows[0][1].ToString();
            txtDimension.Text = dt.Rows[0][2].ToString();
            txtMaxLoad.Text = dt.Rows[0][3].ToString();
            txtMaxPeople.Text = dt.Rows[0][4].ToString();
        }
    }
    ...
    {
        objClass.nYachtID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["myacht"].ToString() == ViewState["myacht"].ToString())
            {
                para();
