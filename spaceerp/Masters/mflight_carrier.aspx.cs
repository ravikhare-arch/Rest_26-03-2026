...
public partial class Master_flight_carrier : System.Web.UI.Page
{
    mflight_carrier_Class objClass = new mflight_carrier_Class();
    ...
    {
        ViewState["mflight_carrier"] = Session["mflight_carrier"];
    }

    public void para()
    {
        objClass.sFCarrier = validation.stringToDBString(txtFCarrier.Text.Trim());
        objClass.sCode = validation.stringToDBString(txtCode.Text.Trim());
        objClass.sDesignator = validation.stringToDBString(txtDesignator.Text.Trim());
        objClass.Alliance = validation.stringToDBString(txtAlliance.Text.Trim());
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtFCarrier.Text = dt.Rows[0][1].ToString();
            txtCode.Text = dt.Rows[0][2].ToString();
            txtDesignator.Text = dt.Rows[0][3].ToString();
            txtAlliance.Text = dt.Rows[0][4].ToString();
    ...
    {
        objClass.nFlightCarrierID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mflight_carrier"].ToString() == ViewState["mflight_carrier"].ToString())
            {
                para();
