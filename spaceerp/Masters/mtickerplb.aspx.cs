...
public partial class Master_tickerplb : System.Web.UI.Page
{
    mtickerplb_Class objClass = new mtickerplb_Class();
    ...
    {
        ViewState["mtickerplb"] = Session["mtickerplb"];
    }
    ...
    public void clrfield()
    {
       ...
       // ddlAutoManualID.SelectedValue = "0";
        txtIncValue.Text = "";
        Session["eid"] = "";
    }
    ...
    {
        objClass.nticketplbId = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["mtickerplb"].ToString() == ViewState["mtickerplb"].ToString())
            {
                para();
