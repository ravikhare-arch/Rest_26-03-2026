<%@ Page Title="page_master" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true"
    CodeFile="mpage_master.aspx.cs" Inherits="Master_page_master" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Add Page Master Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <asp:TextBox ID="txtPageMasterName" runat="server" CssClass="form-control" ></asp:TextBox>
                                <%-- <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="txtPageMasterName"
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">
                                Module Name * :</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:DropDownList ID="ddlModule" runat="Server"  CssClass="form-control js-example-placeholder-single"></asp:DropDownList>
                         ...
                         <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="email">
                                Group Head</label>
                            <div class="col-md-8 col-sm-8">
                                <asp:DropDownList ID="ddlgrouphead" runat="Server"  CssClass="form-control js-example-placeholder-single"></asp:DropDownList>
                                <%-- <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="ddlModule"
                                    ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>--%>
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-8 col-sm-8">
                                ...
                                <%-- <asp:RequiredFieldValidator ID="RFV1" runat="server" ControlToValidate="txtPageMasterDescription"
                                    ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>--%>
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
    ...
    <asp:Panel class="tbl table-responsive" ID="tblGrd" runat="server">
        ...
        <asp:GridView ID="GridView1" CssClass="table table-striped table-bordered" runat="server"
            AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nPageMasterID "
            Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" OnPageIndexChanging="GridView1_PageIndexChanging">
            <Columns>
                <asp:TemplateField HeaderText="nPageMasterID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# Eval("nPageMasterID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="sPageMasterName" HeaderText="Page Name" />
                <asp:BoundField DataField="sModuleName" HeaderText="Module Name" />
                <asp:BoundField DataField="sPageMasterDescription" HeaderText="Page Description" />
