<%@ Page Title="Add Airlines" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="mairline_master.aspx.cs" Inherits="Transcation_chartof_account" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">Add Airlines </h4>
                    ...
                    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-2 col-sm-2">
                                ...
                                <asp:TextBox ID="txtCode" runat="server" Width="100%" Enabled="true"></asp:TextBox>
                            ...
                            <div class="col-md-2 col-sm-2">
                                <label class="col-form-label" for="email">Airline Name * :</label>
                                <asp:TextBox ID="txtAirlineName" runat="server" Width="100%"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RFV3" runat="server" ControlToValidate="txtAirlineName" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                            </div>
                            <div class="col-md-2 col-sm-2">
                                <label class="col-form-label" for="email">Designator</label>
                                <asp:TextBox ID="txtDesignator" runat="server" Width="100%"></asp:TextBox>
                            </div>
                            <div class="col-md-2 col-sm-2">
                                <label class="col-form-label" for="email">Alliance</label>
                                <asp:TextBox ID="txtAlliance" runat="server" Width="100%"></asp:TextBox>
                            </div>
                            <div class="col-md-2 col-sm-2">
                        ...
                        <div class="form-group row m-b-20">
                            <div class="col-md-12 col-sm-12">
                                <asp:GridView ID="GridView1" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="nAirlineID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
                                    OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="nAirlineID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nAirlineID") %>'></asp:Label>
                                                <asp:Label ID="lblCAID" runat="server" Text='<%# Eval("nCAccountID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="sCode" HeaderText="AIRLINE CODE" />

                                        <asp:BoundField DataField="sAirlineName" HeaderText="AIRLINE NAME" />
