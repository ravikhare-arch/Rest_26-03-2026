<%@ Page Title="Profit & Loss" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptProfitLoss_Yearly.aspx.cs" Inherits="Accounting_rptProfitLoss_Details" %>
         ...
         <div class="widget-box">
                    <div class="widget-header widget-header-large">
                        ...
                        <div class="widget-toolbar no-border invoice-info center-block">
                            ...
                            <span class="red h3">Profit And Loss(Yearly)</span> <span class="invoice-info-label"></span>                           
