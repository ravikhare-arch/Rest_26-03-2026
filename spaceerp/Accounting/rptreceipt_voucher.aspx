<%@ Page Title="Receipt Voucher" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptreceipt_voucher.aspx.cs" Inherits="Accounting_rptreceipt_voucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <div class="col-md-3">
            <h1 class="page-header hidden-print">Receipt Voucher </h1>
        </div>
        <div class="col-md-4">
            <ol class="breadcrumb hidden-print pull-right" id="tplink">
                <li class="breadcrumb-item"><a href="treceipt_voucher.aspx">Home</a></li>
        ...
        <div class="invoice-content">
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridView1" HeaderStyle-BackColor="#1c3967" BorderColor="Black" BorderStyle="Solid" BorderWidth="1" HeaderStyle-CssClass="text-white" HeaderStyle-Height="40px" RowStyle-Height="40px" runat="server"
                    AutoGenerateColumns="False" EmptyDataText="No Records to display" DataKeyNames="nReceiptVoucherDetID"
                    Width="100%" AllowPaging="false" AllowSorting="True">
                    <Columns>
                        <asp:TemplateField HeaderText="nReceiptVoucherDetID" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nReceiptVoucherDetID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <table style="width: 100%">
                ...
                <tr style="background-color: #f2f2f2; height: 80px">
                    <td class="text-left; float-left" style="margin-bottom: 25px;width:100%" colspan="5" >
                        <%-- <asp:Label ID="lblCompanyName" runat="server"></asp:Label>--%>
                        <small>SUBTOTAL</small><br /
                        <span class="text-inverse">
                            <asp:Label ID="lblSubTot" runat="server"></asp:Label></span>
                    </td>
                   <td style="background-color: #293036; color: white; text-align: center" colspan="2">
                       <b>GRAND TOTAL</b>
                            <br /><span class="f-w-600"><br /
