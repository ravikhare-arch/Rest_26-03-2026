<%@ Page Title="Add Bank" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="mbank_master.aspx.cs" Inherits="Transcation_chartof_account" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">Add Bank </h4>
                    ...
                    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-2 col-sm-3">
                                <label class="col-form-label" for="email">Bank Code * :</label>
                            ...
                            <div class="col-md-2 col-sm-3">
                                ...
                                <asp:RequiredFieldValidator ID="RFV3" runat="server" ControlToValidate="txtBankName" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" ValidationGroup="A"></asp:RequiredFieldValidator>
                            </div>
                            <div class="col-md-2 col-sm-3">
                                <label class="col-form-label" for="email">Account No :</label>
                                <asp:TextBox ID="txtAccountNo" CssClass="form-control" runat="server" Width="100%"></asp:TextBox>
                            </div>
                            <div class="col-md-2 col-sm-3">
                                <label class="col-form-label" for="email">IFSC CODE :</label>
                                <asp:TextBox ID="txtIFSCNo" CssClass="form-control" runat="server" Width="100%"></asp:TextBox>
                            </div>
                            <div class="col-md-2 col-sm-3">
                                <label class="col-form-label" for="email">Branch Name :</label>
                                <asp:TextBox ID="txtBranch" CssClass="form-control" runat="server" Width="100%"></asp:TextBox>
                            </div>
                            <%--<div class="col-md-3 col-sm-3">
                        ...
                        <div class="form-group row m-b-20">
                            ...
                            <div class="col-md-2 col-sm-3">
                                ...
                                <asp:TextBox ID="txtCreditLimit" CssClass="form-control" runat="server" Width="100%"></asp:TextBox><asp:RegularExpressionValidator ID="REV18" runat="server" ControlToValidate="txtCreditLimit"
                                    SetFocusOnError="True" Display="Dynamic" ErrorMessage="Invalid Numbers" ValidationExpression="^(-)?\d+(\.\d+$)?$"
                                    ValidationGroup="A"></asp:RegularExpressionValidator>
                                    ...
                                    <asp:TextBox ID="txtAName" placeHolder="Agency Name" AutoComplete="off" CssClass="form-control" runat="server" ></asp:TextBox>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <AjaxToolKit:MaskedEditExtender ID="MEE18" runat="server" TargetControlID="txttLastPurchase"
                                                    Mask="99/99/9999" MaskType="Date" AcceptNegative="None" />
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txttLastPurchase" ValidationGroup="A"
                                                    Display="Dynamic" SetFocusOnError="true" runat="server" ErrorMessage="Invalid Date"
                                                    ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d"> 
                                                </asp:RegularExpressionValidator>
                                                </div>
                   ...
                   <asp:Button ID="Button4" CssClass="btn btn-primary" runat="server" Text="Send Mail" />            
                        ...
                        <div class="form-group row m-b-20" style="display:none">
                            ...
                            <div class="col-md-4 col-sm-3">
                                <label class="col-form-label" for="email">Supplier Name   :</label><br />
                                <asp:DropDownList ID="ddlSSupplier" runat="server" CssClass="form-control js-example-placeholder-single">
                                </asp:DropDownList>
                            </div>
                        ...
                        <div class="form-group row m-b-20">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <asp:GridView ID="GridView1" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="nBankID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="sBankCode" HeaderText="CODE" />

                                        <asp:BoundField DataField="sBankName" HeaderText="BANK NAME" />
                                        <asp:BoundField DataField="sAccountNo" HeaderText="ACCOUNT NO" />
                                        <asp:BoundField DataField="sIFSC" HeaderText="IFSC CODE" />
                                        <asp:BoundField DataField="sBranch" HeaderText="BRANCH NAME" />
