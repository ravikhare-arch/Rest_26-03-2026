<%@ Page Title="" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="ttrailbalance.aspx.cs" Inherits="Accounting_ttrailbalance" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Trial Balance Details</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                        ...
                        <div class="form-group row m-b-15">
                            <div class="col-md-4 col-sm-4">
                                ...
                                <asp:DropDownList ID="ddlReportType" runat="server" CssClass="form-control js-example-placeholder-single">
                                    ...
                                    <asp:ListItem Text="Trial Balance Detail " Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Trial Balance Account Detail " Value="2"></asp:ListItem>
                                    <asp:ListItem Text="Trial Balance Sub Account " Value="3"></asp:ListItem>
                                    <asp:ListItem Text="Trial Balance Sub Account Detail" Value="4"></asp:ListItem>
                                </asp:DropDownList>
