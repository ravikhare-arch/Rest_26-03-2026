<%@ Page Title="Trail Balance" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="rpttrialbalance_subaccount.aspx.cs" Inherits="Accounting_rpttrialbalance_detailaccount" %>
...
.invoice main .notices {
    padding-left: 6px;
    border-left: 3px solid #3989c6 !important;
}
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table>       
           ...
           <tr style="height: 40px; text-align: left; padding-left: 10px; border: 1px solid Gray; color: black; background-color: yellow; font-weight: bold">
                <td data-column="name" class="notices">Total</td>
                <td class="qty">
                    <asp:Label ID="lbltotDebit" runat="server"> </asp:Label></td>
                <td class="unit">
                    <asp:Label ID="lbltotCredit" runat="server"> </asp:Label></td>
                <td class="total">
