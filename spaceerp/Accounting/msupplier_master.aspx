<%@ Page Title="Add Supplier" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="msupplier_master.aspx.cs" Inherits="Transcation_chartof_account" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">Add Supplier </h4>
                    ...
                    <asp:Panel class="tbl" ID="tblmain" runat="server">
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <label class="col-form-label" for="email">Supplier Code * :</label>
                        ...
                        <div class="form-group row m-b-20">
                            <div class="col-md-12 col-sm-12">
                                <asp:GridView ID="GridView1" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="nSupplierID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
                                    OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="nSupplierID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nSupplierID") %>'></asp:Label>
                                                <asp:Label ID="lblCAID" runat="server" Text='<%# Eval("nCAccountID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="sSupplierCode" HeaderText="SUPPLIER CODE" />
