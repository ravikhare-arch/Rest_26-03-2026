<%@ Page Title="Trail Balance" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rpttrialbalance_subaccountdet.aspx.cs" Inherits="Accounting_rpttrialbalance_subaccount  " %>
            ...
            <asp:Repeater ID="treetableSub" OnItemDataBound="treetable_ItemDataBound" runat="server">
                <ItemTemplate>
                    ...
                    <asp:Repeater ID="treetableAcc" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td data-column="name" class="p-l-30">
                                    
                                    <%-- <asp:HiddenField ID="hdnSub" runat="server" Value='<%#Eval("[Account Title]") %>' />--%>
