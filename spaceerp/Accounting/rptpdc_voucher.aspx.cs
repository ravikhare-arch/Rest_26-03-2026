...
public partial class Accounting_rptpdc_voucher : System.Web.UI.Page
{
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblBank.Text = dt.Rows[0][8].ToString();
            //   lblCompanyName.Text = dt.Rows[0][10].ToString();
            lblCompanyName1.Text = dt.Rows[0][10].ToString();
            //lblcompanyname2.text = dt.rows[0][4].tostring();
            //  lblcperson.Text = dt.Rows[0][6].ToString();


            lblcompanyAdd.Text = dt.Rows[0][11].ToString();
            lblPhone.Text = dt.Rows[0][12].ToString();
            lblEmail.Text = dt.Rows[0][13].ToString();
            lblFax.Text = dt.Rows[0][14].ToString();

            lblWebsite.Text = dt.Rows[0][15].ToString();
            //lblCity.Text = dt.Rows[0][14].ToString();
            lblGrandtotal.Text = dt.Rows[0][16].ToString();
            lblSubTot.Text = dt.Rows[0][16].ToString();
   ...
   VerifyRenderingInServerForm(Control control)
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        string FileName = "PDC" + "_" + sDate + "_" + sTime;
    ...
    public void Send()
    {
        ...
        sFileName = "PDC" + "_" + sDate + "_" + Stime3 + ".xls";
