<%@ Page Title="General Ledger" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tgeneral_CashBook_list.aspx.cs" Inherits="tgeneral_ledger_list" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function validatedata() {
            var Acctitle = document.getElementById("<%=ddlAccountCashBook.ClientID %>").value;
        ...
        function loaddata() {
            ...
            var AccountTitle = $("#ctl00_ContentPlaceHolder1_ddlAccountCashBook option:selected").val();
            var AccountType = "0";
            $.ajax({
                url: '<%=ResolveUrl("tgeneral_CashBook_list.aspx/loaddata") %>',
                type: "post",
