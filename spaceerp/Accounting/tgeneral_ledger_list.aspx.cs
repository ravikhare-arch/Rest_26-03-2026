...
public partial class tgeneral_ledger_list : System.Web.UI.Page
{
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        getdtdata = displaySearchGrid(txtdtFrom.Text, txtdtToDate.Text, ddlAccountTitle.SelectedValue,ddlAccType.SelectedValue);
        ...
        try
        {
            ...
            #region start code
            var fileName = "GeneralLedger-list-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/GeneralLedger-list.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("General Ledger - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name :General Ledger "; // Heading Name               
                worksheet.Cells[4, 1, 4, 8].Merge = true; //Merge columns start and end range
                ...
                Response.AddHeader("content-disposition", "attachment;filename=General ledger.xlsx");
    ...
    protected void ddlReportFor_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            if (ddlReportFor.SelectedValue == "7" || ddlReportFor.SelectedValue == "3" || ddlReportFor.SelectedValue == "12")
            {
