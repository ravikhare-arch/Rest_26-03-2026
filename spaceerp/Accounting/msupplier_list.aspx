<%@ Page Title="Supplier" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="msupplier_list.aspx.cs" Inherits="mclient_list" %>
   ...
   max-width:1200px;
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title text-center">Supplier</h4>
        </div>
                                ...
                                <div class="col-md-9">
                                    <div class="form-horizontal mrg-top-40 pdd-right-30 ng-pristine ng-valid">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="form-1-3" class="col-md-2 control-label">Supplier Name </label>
                                            <div class="col-md-2">
                                                <asp:TextBox ID="txtAgencyName" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>
                                            <label for="form-1-3" class="col-md-2 control-label">Tax No </label>
                                            <div class="col-md-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="form-1-3" class="col-md-2 control-label">National Id No </label>
                                            <div class="col-md-2">
    ...
    <script type="text/javascript">
        ...
        $(document.body).ready(function () {
            ...
            $("#btnadd").on("click", function () {
                ...
                if (validatedata()) {
                    ...
                    $.ajax({
                        url: '<%=ResolveUrl("msupplier_list.aspx/AddClient") %>',
            ...
            $(document.body).on("click", "#deletebutton", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("msupplier_list.aspx/DeleteClient") %>',
            ...
            $(document.body).on("click", "#btnupdate", function () {
                ...
                $.ajax({
                    url: '<%=ResolveUrl("msupplier_list.aspx/UpdateClient") %>',
                    data: JSON.stringify({ list: obj }),
                    type: "post",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
        ...
        function loaddata() {
            ...
            $.ajax({
                url: '<%=ResolveUrl("msupplier_list.aspx/loaddata") %>',
                type: "post",
