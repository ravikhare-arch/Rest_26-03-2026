...
public partial class Transcation_acc_journal_voucher : System.Web.UI.Page
{
  ...
  //  tposted_voucher_Class objPostedClass = new tposted_voucher_Class();
   // tposted_voucherdet_Class objPostedClassDet = new tposted_voucherdet_Class();
  ...
  //  tchartof_account_Class objAccount = new tchartof_account_Class();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                Session["tacc_journal_voucher"] = aa;
    ...
    {
        ViewState["tacc_journal_voucher"] = Session["tacc_journal_voucher"];
    }
    ...
    public void para()
    {
        objClass.sJournalVoucherNo = validation.stringToDBString(txtJournalVoucherNo.Text.Trim());
        objClass.nVoucherTypeID = ddlVoucherTypeID.SelectedValue;
        objClass.dtJournalVoucher = validation.dateToText(txttJournalVoucher.Text.Trim());
        objClass.nAccountTypeID = ddlAccountType.SelectedValue;
    ...
    {
        txtJournalVoucherNo.Text = "";
        ddlVoucherTypeID.SelectedValue = "0";
        txttJournalVoucher.Text = "";
   ...
   //     txtAmendedby.Text = "";
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtJournalVoucherNo.Text = dt.Rows[0][1].ToString();
            ddlVoucherTypeID.SelectedValue = dt.Rows[0][2].ToString();
            txttJournalVoucher.Text = validation.TextToDate(dt.Rows[0][3].ToString());
            ddlAccountType.SelectedValue = dt.Rows[0][4].ToString();
         //   ddlStatusID.SelectedValue = dt.Rows[0][5].ToString();
            txtPostedby.Text = dt.Rows[0][6].ToString();
       //     txtAmendedby.Text = dt.Rows[0][7].ToString();
    ...
    {
        objClass.nJournalVoucerID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["tacc_journal_voucher"].ToString() == ViewState["tacc_journal_voucher"].ToString())
            {
                //Journal Voucher 
                para();
    ...
    protected void btngdPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Label ID = (Label)GridView1.Rows[row].Cells[0].FindControl("lblID");
            Session["eid"] = ID.Text;
            Response.Redirect("rptJournalVoucher.aspx");
    ...
    protected void btnUpdateDet_Click(object sender, EventArgs e)
    {
        ...
        {
            paraDet();
            objClassDet.nJournalVoucherDetID = Session["Detid"].ToString();
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            objClass.nJournalVoucerID = ddlVoucherNoS.SelectedValue;
            objClass.dtJournalVoucher = validation.dateToText(txtdtFrom.Text.Trim());
            objClass.sAmendedby = validation.dateToText(txtdtTo.Text.Trim());
           // objClass.nStatusID = ddlStatusID.SelectedValue;
            if (ddlVoucherNoS.SelectedValue != "0" ||  (txtdtFrom.Text != "" && txtdtTo.Text != ""))
            {
