<%@ Page Title="" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tpostedvoucher.aspx.cs" Inherits="Accounting_tpostedvoucher" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Posted Voucher Search</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body">
                        ...
                        <div class="form-group row m-b-15">
                            <div class="col-md-4 col-sm-4">
                                ...
                                <asp:DropDownList ID="ddlVoucherType" runat="server" CssClass="form-control js-example-placeholder-single">
                                    <asp:ListItem Text="All" Value="All"></asp:ListItem>
                                    <asp:ListItem Text="CP" Value="CP"></asp:ListItem>
                                    <asp:ListItem Text="CR" Value="CR"></asp:ListItem>
                                    <asp:ListItem Text="PDCP" Value="PDCP"></asp:ListItem>
                                    <asp:ListItem Text="PDCR" Value="PDCR"></asp:ListItem>
                                    <asp:ListItem Text="JV" Value="JV"></asp:ListItem>
                                    <asp:ListItem Text="POI" Value="POI"></asp:ListItem>
                                    <asp:ListItem Text="SOI" Value="SOI"></asp:ListItem>
                                    <asp:ListItem Text="VS" Value="VS"></asp:ListItem>
                                ...
                                <asp:RequiredFieldValidator ID="RFV2" runat="server" ControlToValidate="ddlVoucherType" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                            </div>
