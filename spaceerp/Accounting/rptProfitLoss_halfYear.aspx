<%@ Page Title="Profit & Loss" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptProfitLoss_halfYear.aspx.cs" Inherits="Accounting_rptProfitLoss_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
         ...
         <div class="widget-box">
                    <div class="widget-header widget-header-large">
                        ...
                        <div class="widget-toolbar no-border invoice-info center-block">
                            ...
                            <span class="red h3">Profit And Loss (Half Year)</span> <span class="invoice-info-label"></span>                           
    ...
    <div class="invoice bg-grey-lighter" id="invoice" runat="server">
        <div class="container-fluid bg-white">
            ...
            <asp:GridView ID="GridView1" runat="server" BorderStyle="Solid" BorderWidth="1" RowStyle-ForeColor="Black" HeaderStyle-Height="40px" RowStyle-Height="40px" HeaderStyle-BackColor="#0f2540" HeaderStyle-ForeColor="White">
            </asp:GridView>
            <br />
            <br />
