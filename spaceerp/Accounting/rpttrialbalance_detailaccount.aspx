<%@ Page Title="Trail Balance" Language="C#" MasterPageFile="~/PrintMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpttrialbalance_detailaccount.aspx.cs" Inherits="Accounting_rpttrialbalance_detailaccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="invoice" id="invoice" runat="server">
        <table>
             <tr>
                <th style="padding-left:20px">Account Title</th>
                <th>Current Debit</th>
                ...
                <ItemTemplate>
                   <tr>
                        <td data-column="name" class="no">
                            ...
                            <asp:HiddenField ID="hdnMain" runat="server" Value='<%#Eval("[Account Title]") %>' />
