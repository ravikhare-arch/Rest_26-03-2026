<%@ Page Title="Payment Voucher" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="tpayment_voucher.aspx.cs" Inherits="Transcation_payment_voucher" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title text-center">PAYMENT VOUCHER </h4>
                </div>
                <!-- end panel-heading -->
                <!-- begin panel-body -->
                <div class="panel-body">
                    <asp:Panel CssClass="tbl" ID="tblmain" runat="server">
                        <asp:UpdatePanel ID="up1" runat="server">
                            <ContentTemplate>
                                <div style="border: 1px solid #e0e0d9; padding: 5px; margin-top: 5px;">
                                    ...
                                    <div class="form-group row m-b-0">
                                        ...
                                        <div class="col-md-2 col-sm-3 ">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlAccountType" ErrorMessage="*" Display="Dynamic" SetFocusOnError="True" InitialValue="0" ValidationGroup="A"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-2 col-sm-2" style="z-index:99;">
                                            <label class="col-form-label" for="email">Voucher Date * :</label>
                                            <asp:TextBox ID="txtdtPaymentVoucher" runat="server" Width="100%" OnTextChanged="txtdtPaymentVoucher_TextChanged" AutoPostBack="true" placeholder="DD/MM/YYYY"></asp:TextBox>
                                        ...
                                        <%--<div class="col-md-3 col-sm-3">
                                            ...
                                            <asp:TextBox ID="txtAmendedby" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>--%>
                                        <div class="col-md-2 col-sm-3">
                                    ...
                                    <div class="form-group row m-b-5">
                                     ...
                                     <div class="form-group row m-b-15">
                                         <div class="col-md-2 col-sm-2">
                                            ...
                                            <asp:TextBox ID="txtAmount" runat="server" Width="100%" AutoPostBack="true" OnTextChanged="txtAmount_TextChanged"></asp:TextBox>
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            ...
                                            <asp:TextBox ID="txtLocalAmount" runat="server" Width="100%" Enabled="false"></asp:TextBox>
                                        </div>
                                        <div class="col-md-2 col-sm-2">
                                            <label class="col-form-label">Cheque No. </label>
                                            <asp:TextBox ID="txtcheque" runat="server" Width="100%"></asp:TextBox>
                                        </div>
                                        <div class="col-md-2 col-sm-2">
                                            <label class="col-form-label">Cheque Date </label>
                                            <asp:TextBox ID="txtdtCheque" runat="server" Width="100%" placeholder="DD/MM/YYYY"></asp:TextBox>
                        ...
                        <asp:Panel class="tbl table-responsive" ID="tblGridDet" runat="server" Style="margin-top: 20px;">
                            ...
                            <asp:GridView ID="GridView2" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                DataKeyNames="nPaymentVoucherDetID" Width="100%" AllowPaging="false" AllowSorting="True" EmptyDataText="No Records to display"
                                OnPageIndexChanging="GridView2_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField HeaderText="nPaymentVoucherDetID" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDetID" runat="server" Text='<%# Eval("nPaymentVoucherDetID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-hover m-b-0 text-inverse" runat="server" AutoGenerateColumns="False"
                                    DataKeyNames="nPaymentVoucerID" Width="100%" AllowPaging="true" AllowSorting="True" PageSize="25" EmptyDataText="No Records to display"
                                    OnPageIndexChanging="GridView1_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderText="nPaymentVoucerID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblID" runat="server" Text='<%# Eval("nPaymentVoucerID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Voucher Date">
                                            <ItemTemplate>
                                                <%#validation.TextToDate(Eval("dtPaymentVoucher").ToString())%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="sPaymentVoucherNo" HeaderText="Voucher No" />
