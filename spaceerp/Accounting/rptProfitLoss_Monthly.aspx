<%@ Page Title="" Language="C#" MasterPageFile="~/PrintMaster.master" AutoEventWireup="true" CodeFile="rptProfitLoss_Monthly.aspx.cs" Inherits="Accounting_rptProfitLoss_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
         ...
         <div class="widget-box">
                    <div class="widget-header widget-header-large">
                        ...
                        <div class="widget-toolbar no-border invoice-info center-block">
                            ...
                            <span class="red h3">Profit And Loss (Monthly)</span> <span class="invoice-info-label"></span>                           
    ...
    <div class="invoice bg-grey-lighter" id="invoice" runat="server">
        ...
        <div class="container-fluid bg-white">
            ...
            <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="table table-hover text-black" HeaderStyle-BackColor="#0f2540" HeaderStyle-ForeColor="White">
            </asp:GridView>
            ...
            <table class="table table-hover text-black">
                <thead>
                    ...
                    <th class="text-center"> Income / Revenue
                    </th>
                    <th class="text-center">Expenses
                    </th>
                     <th class="text-center">Gross  Profit / Loss
                    </th>
                     <th class="text-center">Tax
                    </th>
                    <th class="text-center">Net Profit / Loss
                    </th>
                </thead>
                <tbody>
                    <asp:Repeater ID="rptPl" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td class="text-center"><%#Eval("sMonthName") %> -<%#Eval("sYear") %></td>
                                <td class="text-center"><%#Eval("sIncome") %></td>
                                <td class="text-center"><%#Eval("sExpense") %></td>
                                
                                <td class="text-center"><%#Eval("nTotal") %></td>
                                <td class="text-center"><%#Eval("nTax") %></td>
                                <td class="font-weight-bold text-center"><%#Eval("nPl") %></td>
                               
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                    <tr class="text-black bg-grey font-weight-bold text-center">
                        <td >Grand Total</td>
                        <td>
                        ...
                        <td>
                             ...
                             <asp:Label ID="lblFinalPL" runat="server" ></asp:Label>
                        </td>
