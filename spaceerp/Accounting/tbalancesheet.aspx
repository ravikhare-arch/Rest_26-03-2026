<%@ Page Title="" Language="C#" MasterPageFile="~/Pagecontent.master" AutoEventWireup="true" CodeFile="tbalancesheet.aspx.cs" Inherits="Accounting_tprofit_loss" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Balancesheet</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <asp:DropDownList ID="ddlAccountTitle" runat="server" CssClass="form-control js-example-placeholder-single">
                                   <asp:ListItem Text="Select Reports" Value="0"></asp:ListItem>
                                     <asp:ListItem Text="Balancesheet" Value="1"></asp:ListItem>
                                </asp:DropDownList>
