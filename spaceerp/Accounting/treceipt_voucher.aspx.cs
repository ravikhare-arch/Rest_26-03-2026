...
public partial class Transcation_receipt_voucher : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                txttReceiptVoucher.Text = validation.fillDate();
                Voucher_Generate();
                fillUser();
    ...
    {
        ViewState["treceipt_voucher"] = Session["treceipt_voucher"];
    }
    public void Voucher_Generate()
    {
        DataTable dt = objClass.viewData(objClass, "RVN", validation.dateToText(txttReceiptVoucher.Text));
        if (dt.Rows.Count > 0)
        {
            txtReceiptVoucherNo.Text = dt.Rows[0][0].ToString();
        }
    }
    ...
    public void para()
    {
        objClass.sReceiptVoucherNo = validation.stringToDBString(txtReceiptVoucherNo.Text.Trim());
        objClass.nVoucherTypeID = ddlVoucherTypeID.SelectedValue;
        objClass.dtReceiptVoucher = validation.dateToText(txttReceiptVoucher.Text.Trim());
      //  objClass.nStatusID = ddlStatusID.SelectedValue;
        ...
        objClass.nCashAccountID = ddlAccountTypeID.SelectedValue;
    }

    public void clrfield()
    {
        txtReceiptVoucherNo.Text = "";
        ddlVoucherTypeID.SelectedValue = "0";
        txttReceiptVoucher.Text = "";
    ...
    public void GetFormData()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            txtReceiptVoucherNo.Text = dt.Rows[0][1].ToString();
            ddlVoucherTypeID.SelectedValue = dt.Rows[0][2].ToString();
            txttReceiptVoucher.Text = validation.TextToDate(dt.Rows[0][3].ToString());
        ...
        //    txtAmendedby.Text = dt.Rows[0][6].ToString();
            ...
            ddlAccountTypeID.SelectedValue = dt.Rows[0][7].ToString();
    ...
    {
        objClass.nReceiptVoucerID = Session["eid"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            lblmsg.Text = "";
            if (Session["treceipt_voucher"].ToString() == ViewState["treceipt_voucher"].ToString())
            {
                para();
                ...
                if (strArr[0] == "1")
                {
                    ...
                    paraDet();
                    objClassDet.nReceiptVoucherID = Session["eid"].ToString();
    ...
    protected void btngdPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Label ID = (Label)GridView1.Rows[row].Cells[0].FindControl("lblID");
            Session["eid"] = ID.Text;
            Response.Redirect("rptreceipt_voucher.aspx");
    ...
    //    ddlAccountTypeID.Enabled = false;
    ...
    protected void btnUpdateDet_Click(object sender, EventArgs e)
    {
        ...
        {
            paraDet();
            objClassDet.nReceiptVoucherDetID = Session["Detid"].ToString();
    ...
    protected void txttReceiptVoucher_TextChanged(object sender, EventArgs e)
    {
        Voucher_Generate();
    }
    protected void ddlVoucherTypeID_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            objAccountCode.ddlOperation(objAccountCode, "ddlAccType", ddlVoucherTypeID.SelectedValue, ddlAccountTypeID);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            objClass.nReceiptVoucerID = ddlVoucherNoS.SelectedValue;
            objClass.nVoucherTypeID = ddlVTypeS.SelectedValue;
            objClass.dtReceiptVoucher = validation.dateToText(txtdtFrom.Text.Trim());
