...
public partial class mclient_list : System.Web.UI.Page
{
    ...
    static mclient_Class objClient = new mclient_Class();
    static mclientgst_Class objclntGst = new mclientgst_Class();
    ...
    {
        objClient.sClientCode = validation.stringToDBString(list.Code);
    ...
    {
        //Clint GST
        objclntGst.nClntCGST = list.CGST;
        objclntGst.nClntSGST = list.SGST;
        objclntGst.nClntIGST = list.IGST;
        return list.ToString();
    }
    ...
    public static string DeleteClient(string AccountLedgerID)
    {
        ...
        try
        {
            objClient.nClientID = AccountLedgerID;
    ...
    public static muserlist loaddata(string fromdate, string todate)
    {
        ...
        try
        {
            ...
            {
                magentobj = new list();
                magentobj.ClientID = dt.Rows[i]["nClientID"].ToString();
                magentobj.Code = dt.Rows[i]["sClientCode"].ToString();
                ...
                DataTable dtclntGst = objclntGst.viewData(objclntGst, "show", magentobj.ClientID);
    ...
    protected void btnexcel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            #region start code
            var fileName = "Client-" + DateTime.Now.ToString("yyyy-MM-dd--hh-mm-ss") + ".xlsx";
            var outputDir = Server.MapPath("../Temp/Client.xlsx");
            ...
            using (var package = new ExcelPackage(file))
            {
                ...
                ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("Client - " + DateTime.Now.ToShortDateString());
                ...
                ///////  //Merging cells and create a center heading for out table
                worksheet.Cells[4, 1].Value = "	Statement Name : Client "; // Heading Name               
                worksheet.Cells[4, 1, 4, 7].Merge = true; //Merge columns start and end range
                ...
                for (int i = 0; i < getdtdata.Rows.Count; i++)
                {
                    ...
                    worksheet.Cells["B" + (i + 7)].Value = getdtdata.Rows[i]["sClientCode"].ToString();
