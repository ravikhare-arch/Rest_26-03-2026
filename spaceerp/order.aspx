...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <script type="text/javascript">
     ...
     // 🔥 FIXED REUSABLE LOCK ENGINE: Room Service aur Room Number ka coordination maintain rakhega
     function checkNcAndLockRoom() {
         ...
         if (isNcChecked) {
             // NC Checked: Room Number mitao aur freeze karo
             ...
             if (hasRoom) {
                 ...
                 // 🔥 CRITICAL PROTECTION LAYER: Agar room h, toh baki radios block honge par Room Service checked aur active rahega
                 if ($paymentContainer.length) {
                     $paymentContainer.find("input[type='radio']").not("#Room_Serv").prop("disabled", true);
                     $("#Room_Serv").prop("disabled", false).prop("checked", true); // Room Service always active and accessible
     ...
     $(document).ready(function () {
         ...
         console.log("URL Data Received Execution Check:", { id, roomFromUrl, mode });
         ...
         // --- 4. Autofill Logic & State Verification ---
