...
namespace RestaurantApi.Models
{
    public class SalesOrder
    {
        ...
        public double AfterDisc { get; set;  }
        ...
        public string Total_aft_Dis { get; set; }
        public string SavedGrandTotal { get; set; }     
